...
public class CheckPointSet800153 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(CheckPointSet800153.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|CheckPointSet800153.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|CheckPointSet800153.view", "EDIT");

        printPageEdit(response, request, vars, false, strMA_Measure_Group_ID, strPMA_Measure_Shift_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|CheckPointSet800153.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamMA_Measure_Shift_ID", tabId + "|paramMA_Measure_Shift_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strMA_Measure_Group_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|CheckPointSet800153.view", strView);
        }
      }
...
vars.getGlobalVariable("inpmaMeasureShiftId", windowId + "|MA_Measure_Shift_ID");
      ...
      vars.setSessionValue(tabId + "|CheckPointSet800153.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPMA_Measure_Shift_ID = vars.getGlobalVariable("inpmaMeasureShiftId", windowId + "|MA_Measure_Shift_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|CheckPointSet800153.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|CheckPointSet800153.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|MA_Measure_Group_ID");
      vars.setSessionValue(windowId + "|MA_Measure_Shift_ID", strPMA_Measure_Shift_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strMA_Measure_Group_ID = vars.getRequiredStringParameter("inpmaMeasureGroupId");
      //CheckPointSet800153Data data = getEditVariables(vars, strPMA_Measure_Shift_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = CheckPointSet800153Data.delete(this, strMA_Measure_Group_ID, strPMA_Measure_Shift_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
/*
  String deleteRelation(VariablesSecureApp vars, String strMA_Measure_Group_ID, String strPMA_Measure_Shift_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strMA_Measure_Group_ID.startsWith("(")) strMA_Measure_Group_ID = strMA_Measure_Group_ID.substring(1, strMA_Measure_Group_ID.length()-1);
      if (!strMA_Measure_Group_ID.equals("")) {
        strMA_Measure_Group_ID = Replace.replace(strMA_Measure_Group_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strMA_Measure_Group_ID, ",", false);
        while (st.hasMoreTokens()) {
          String strKey = st.nextToken();
          if (CheckPointSet800153Data.deleteTransactional(conn, this, strKey, strPMA_Measure_Shift_ID)==0) {
...
*/
  private CheckPointSet800153Data getEditVariables(Connection con, VariablesSecureApp vars, String strPMA_Measure_Shift_ID) throws IOException,ServletException {
    CheckPointSet800153Data data = new CheckPointSet800153Data();
    ServletException ex = null;
    try {
    data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adClientIdr = vars.getStringParameter("inpadClientId_R");     data.maMeasureGroupId = vars.getRequestGlobalVariable("inpmaMeasureGroupId", windowId + "|MA_Measure_Group_ID");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.maMeasureShiftId = vars.getStringParameter("inpmaMeasureShiftId");     data.maMeasureShiftIdr = vars.getStringParameter("inpmaMeasureShiftId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.maCcpGroupId = vars.getStringParameter("inpmaCcpGroupId");     data.maCcpGroupIdr = vars.getStringParameter("inpmaCcpGroupId_R");    try {   data.seqno = vars.getNumericParameter("inpseqno");  } catch (ServletException paramEx) { ex = paramEx; } 
   ...
   private CheckPointSet800153Data[] getRelationData(CheckPointSet800153Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].maMeasureGroupId = FormatUtilities.truncate(data[i].maMeasureGroupId, 10);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].maMeasureShiftId = FormatUtilities.truncate(data[i].maMeasureShiftId, 44);        data[i].maCcpGroupId = FormatUtilities.truncate(data[i].maCcpGroupId, 44);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPMA_Measure_Shift_ID) throws IOException,ServletException {
      DateandShift800158Data[] data = DateandShift800158Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPMA_Measure_Shift_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|MA_Measure_Shift_ID", data[0].maMeasureShiftId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);
  ...
  private String getParentID(VariablesSecureApp vars, String strMA_Measure_Group_ID) throws ServletException {
    String strPMA_Measure_Shift_ID = CheckPointSet800153Data.selectParentID(this, strMA_Measure_Group_ID);
    if (strPMA_Measure_Shift_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPMA_Measure_Shift_ID) throws IOException,ServletException {
      CheckPointSet800153Data[] data = CheckPointSet800153Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPMA_Measure_Shift_ID, vars.getStringParameter("inpmaMeasureGroupId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamMA_Measure_Shift_ID = vars.getSessionValue(tabId + "|paramMA_Measure_Shift_ID");
    ...
    if (!(strParamMA_CCP_Group_ID.equals("") && strParamMA_Measure_Shift_ID.equals(""))) hasSearchCondition=true;
    String strOffset = "0";
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/openbravo/zsoft/qms/QualityControlReport/CheckPointSet800153_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "CheckPointSet800153", false, "document.frmMain.inpmaMeasureGroupId", "grid", "..", "".equals("Y"), "QualityControlReport", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "CheckPointSet800153_Relation.html", "QualityControlReport", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "CheckPointSet800153_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", CheckPointSet800153Data.selectParent(this, strPMA_Measure_Shift_ID));
    else xmlDocument.setParameter("parent", CheckPointSet800153Data.selectParentTrl(this, strPMA_Measure_Shift_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strMA_Measure_Group_ID, String strPMA_Measure_Shift_ID, TableSQLData tableSQL)
    ...
    CheckPointSet800153Data[] data=null;
...
String strParamMA_Measure_Shift_ID = vars.getSessionValue(tabId + "|paramMA_Measure_Shift_ID");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = CheckPointSet800153Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPMA_Measure_Shift_ID, strMA_Measure_Group_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new CheckPointSet800153Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = CheckPointSet800153Data.set(strPMA_Measure_Shift_ID, Utility.getDefault(this, vars, "Updatedby", "", "800064", "800153", "", dataField), CheckPointSet800153Data.selectDef802239_0(this, Utility.getDefault(this, vars, "Updatedby", "", "800064", "800153", "", dataField)), "", Utility.getDefault(this, vars, "MA_CCP_Group_ID", "", "800064", "800153", "", dataField), CheckPointSet800153Data.selectDef802375(this, strPMA_Measure_Shift_ID), Utility.getDefault(this, vars, "Createdby", "", "800064", "800153", "", dataField), CheckPointSet800153Data.selectDef802237_1(this, Utility.getDefault(this, vars, "Createdby", "", "800064", "800153", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800064", "800153", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800064", "800153", "", dataField), "Y");
        
      }
    } else {
      data = new CheckPointSet800153Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(CheckPointSet800153Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
      
    String currentPOrg=DateandShift800158Data.selectOrg(this, strPMA_Measure_Shift_ID);
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "CheckPointSet800153", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmaMeasureGroupId", "", "..", "".equals("Y"), "QualityControlReport", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strMA_Measure_Group_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (CheckPointSet800153Data.getCurrentDBTimestamp(this, data.maMeasureGroupId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.maMeasureGroupId, vars, this);
        } catch(Exception ex) {
  ...
  public String getServletInfo() {
    return "Servlet CheckPointSet800153. This Servlet was made by Wad constructor";

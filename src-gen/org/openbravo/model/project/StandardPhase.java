 ...
 */
public class StandardPhase extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_STANDARDQTY = "standardQty";
    public static final String PROPERTY_ID = "id";
    public static final String PROPERTY_PRODUCT = "product";
    public static final String PROPERTY_STDDURATION = "stdduration";
    public static final String PROPERTY_PROJECTSTANDARDTASKLIST =
        "projectStandardTaskList";

    public StandardPhase() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_STANDARDQTY, new BigDecimal(1));
        setDefaultValue(PROPERTY_PROJECTSTANDARDTASKLIST,
    ...
    public BigDecimal getStandardQty() {
        return (BigDecimal) get(PROPERTY_STANDARDQTY);
    }

    public void setStandardQty(BigDecimal standardQty) {
        set(PROPERTY_STANDARDQTY, standardQty);
    }
    ...
    public Long getStdduration() {
        return (Long) get(PROPERTY_STDDURATION);
    }

    public void setStdduration(Long stdduration) {
        set(PROPERTY_STDDURATION, stdduration);
    }
    ...
    public void setProjectStandardTaskList(
        List<StandardTask> projectStandardTaskList) {

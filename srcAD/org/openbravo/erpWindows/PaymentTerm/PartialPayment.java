...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strC_Paymenttermline_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|C_Paymenttermline_ID", data[0].getField("cPaymenttermlineId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PartialPaymentData.set(strPC_PaymentTerm_ID, "", "Y", Utility.getDefault(this, vars, "FixMonthOffset", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "PaymentRule", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "FixMonthCutoff", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "Fixmonthday3", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "NetDay", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "Excludetax", "N", "141", "800074", "N", dataField), Utility.getDefault(this, vars, "FixMonthDay2", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "141", "800074", "", dataField), PartialPaymentData.selectDef801024_0(this, Utility.getDefault(this, vars, "Createdby", "", "141", "800074", "", dataField)), Utility.getDefault(this, vars, "IsNextBusinessDay", "Y", "141", "800074", "N", dataField), Utility.getDefault(this, vars, "IsDueFixed", "N", "141", "800074", "N", dataField), PartialPaymentData.selectDef801028(this, strPC_PaymentTerm_ID), Utility.getDefault(this, vars, "Onremainder", "Y", "141", "800074", "N", dataField), Utility.getDefault(this, vars, "NetDays", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "141", "800074", "", dataField), PartialPaymentData.selectDef801026_1(this, Utility.getDefault(this, vars, "Updatedby", "", "141", "800074", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "141", "800074", "", dataField), Utility.getDefault(this, vars, "Percentage", "100", "141", "800074", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "141", "800074", "", dataField), Utility.getDefault(this, vars, "FixMonthDay", "", "141", "800074", "", dataField));

...
Create a registry
 */
  public static MaterialMovements081810AFCDFA4E8CAAB84969C64EBBA1Data[] set(String zssmWorkstepVId, String createdby, String createdbyr, String adClientId, String mLocatorId, String mLocatorIdr, String adOrgId, String movementdate, String movementqty, String mInternalConsumptionId, String mProductId, String mProductIdr, String updatedby, String updatedbyr, String isactive, String description, String quantity, String zspmMaterialmovementsViewId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Zssm_Workstep_V_ID = (?) , M_Product_ID = (?) , Movementqty = TO_NUMBER(?) , Movementdate = TO_DATE(?) , Quantity = TO_NUMBER(?) , Description = (?) , M_Locator_ID = (?) , M_Internal_Consumption_ID = (?) , Zspm_Materialmovements_View_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , Isactive = (?) , updated = now(), updatedby = ? " +
      "        WHERE zspm_materialmovements_view.Zspm_Materialmovements_View_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zssm_Workstep_V_ID, M_Product_ID, Movementqty, Movementdate, Quantity, Description, M_Locator_ID, M_Internal_Consumption_ID, Zspm_Materialmovements_View_ID, AD_Client_ID, AD_Org_ID, Isactive, created, createdby, updated, updatedBy)" +

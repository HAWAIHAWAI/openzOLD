...
public class PriceAdjustments extends HttpSecureAppServlet {
  ...
  private static final String tabId = "167D259CFCA2456E9F3D22AADE10D1BE";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|C_OrderLine_ID", strPC_OrderLine_ID);
      vars.setSessionValue("78FE3C5FDBAF462FB043C508E295E011|Lines.view", "EDIT");
      vars.removeSessionValue(windowId + "|C_Order_ID");
      refreshParentSession(vars, strPC_OrderLine_ID);
...
*/
  private PriceAdjustmentsData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_OrderLine_ID) throws IOException,ServletException {
   ...
   private PriceAdjustmentsData[] getRelationData(PriceAdjustmentsData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].mOfferId = FormatUtilities.truncate(data[i].mOfferId, 44);        data[i].cOrderlineId = FormatUtilities.truncate(data[i].cOrderlineId, 44);        data[i].cOrderlineOfferId = FormatUtilities.truncate(data[i].cOrderlineOfferId, 10);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_OrderLine_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|C_Order_ID", data[0].cOrderId);    vars.setSessionValue(windowId + "|C_BPartner_Location_ID", data[0].cBpartnerLocationId);    vars.setSessionValue(windowId + "|DateOrdered", data[0].dateordered);    vars.setSessionValue(windowId + "|DatePromised", data[0].datepromised);    vars.setSessionValue(windowId + "|M_Warehouse_ID", data[0].mWarehouseId);    vars.setSessionValue(windowId + "|M_Product_ID", data[0].mProductId);    vars.setSessionValue(windowId + "|QtyOrdered", data[0].qtyordered);    vars.setSessionValue(windowId + "|M_Shipper_ID", data[0].mShipperId);    vars.setSessionValue(windowId + "|C_Currency_ID", data[0].cCurrencyId);    vars.setSessionValue(windowId + "|C_OrderLine_ID", data[0].cOrderlineId);
...
String strParamM_Offer_ID = vars.getSessionValue(tabId + "|paramM_Offer_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/OrderTemplates/PriceAdjustments_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "PriceAdjustments", false, "document.frmMain.inpcOrderlineOfferId", "grid", "..", "".equals("Y"), "OrderTemplates", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "PriceAdjustments_Relation.html", "OrderTemplates", "W", strReplaceWith, tabs.breadcrumb());
...
String strParamM_Offer_ID = vars.getSessionValue(tabId + "|paramM_Offer_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PriceAdjustmentsData.set(strPC_OrderLine_ID, Utility.getDefault(this, vars, "M_Offer_ID", "", "93C7676AA2A94769B48A4B6E102FDD67", "167D259CFCA2456E9F3D22AADE10D1BE", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "93C7676AA2A94769B48A4B6E102FDD67", "167D259CFCA2456E9F3D22AADE10D1BE", "", dataField), PriceAdjustmentsData.selectDef803115_0(this, Utility.getDefault(this, vars, "Updatedby", "", "93C7676AA2A94769B48A4B6E102FDD67", "167D259CFCA2456E9F3D22AADE10D1BE", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "93C7676AA2A94769B48A4B6E102FDD67", "167D259CFCA2456E9F3D22AADE10D1BE", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "93C7676AA2A94769B48A4B6E102FDD67", "167D259CFCA2456E9F3D22AADE10D1BE", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "93C7676AA2A94769B48A4B6E102FDD67", "167D259CFCA2456E9F3D22AADE10D1BE", "", dataField), PriceAdjustmentsData.selectDef803113_1(this, Utility.getDefault(this, vars, "Createdby", "", "93C7676AA2A94769B48A4B6E102FDD67", "167D259CFCA2456E9F3D22AADE10D1BE", "", dataField)), "", "Y", Utility.getDefault(this, vars, "PriceOffer", "0", "93C7676AA2A94769B48A4B6E102FDD67", "167D259CFCA2456E9F3D22AADE10D1BE", "", dataField), PriceAdjustmentsData.selectDef803117(this, strPC_OrderLine_ID), Utility.getDefault(this, vars, "AmtOffer", "0", "93C7676AA2A94769B48A4B6E102FDD67", "167D259CFCA2456E9F3D22AADE10D1BE", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "PriceAdjustments", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcOrderlineOfferId", "", "..", "".equals("Y"), "OrderTemplates", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Orderline_Offer_ID));

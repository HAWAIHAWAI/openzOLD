...
/**
 * Entity class for entity c_machinecalendar_v (stored in table c_machinecalendar_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class c_machinecalendar_v extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "c_machinecalendar_v";
    public static final String ENTITY_NAME = "c_machinecalendar_v";
    ...
    public BigDecimal getWorktimeplan() {
        return (BigDecimal) get(PROPERTY_WORKTIMEPLAN);
    }

    public void setWorktimeplan(BigDecimal worktimeplan) {

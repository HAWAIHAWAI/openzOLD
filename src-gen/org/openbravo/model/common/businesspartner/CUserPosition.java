...
/**
 * Entity class for entity c_user_position (stored in table c_user_position).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class CUserPosition extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "c_user_position";
    public static final String ENTITY_NAME = "c_user_position";

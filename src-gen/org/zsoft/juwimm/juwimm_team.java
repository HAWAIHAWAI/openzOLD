...
/**
 * Entity class for entity juwimm_team (stored in table juwimm_team).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class juwimm_team extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "juwimm_team";
    public static final String ENTITY_NAME = "juwimm_team";
    ...
    public static final String PROPERTY_JUWIMMTEAMTRLLIST = "juwimmTeamTrlList";
    ...
    public juwimm_team() {
        ...
        setDefaultValue(PROPERTY_JUWIMMTEAMTRLLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<org.zsoft.juwimm.juwimm_team_trl> getJuwimmTeamTrlList() {
        return (List<org.zsoft.juwimm.juwimm_team_trl>) get(PROPERTY_JUWIMMTEAMTRLLIST);
    }

    public void setJuwimmTeamTrlList(
        List<org.zsoft.juwimm.juwimm_team_trl> juwimmTeamTrlList) {
        set(PROPERTY_JUWIMMTEAMTRLLIST, juwimmTeamTrlList);
    }
}

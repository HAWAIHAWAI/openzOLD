...
*/
  private OrdersE157BADD4E594D8487B150B5F79C6B54Data getEditVariables(Connection con, VariablesSecureApp vars, String strPC_BPartner_ID) throws IOException,ServletException {
   ...
   private OrdersE157BADD4E594D8487B150B5F79C6B54Data[] getRelationData(OrdersE157BADD4E594D8487B150B5F79C6B54Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adOrgtrxId = FormatUtilities.truncate(data[i].adOrgtrxId, 22);        data[i].user1Id = FormatUtilities.truncate(data[i].user1Id, 22);        data[i].user2Id = FormatUtilities.truncate(data[i].user2Id, 22);        data[i].dropshipLocationId = FormatUtilities.truncate(data[i].dropshipLocationId, 22);        data[i].dropshipBpartnerId = FormatUtilities.truncate(data[i].dropshipBpartnerId, 22);        data[i].dropshipUserId = FormatUtilities.truncate(data[i].dropshipUserId, 22);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 22);        data[i].cOrderId = FormatUtilities.truncate(data[i].cOrderId, 32);        data[i].documentno = FormatUtilities.truncate(data[i].documentno, 30);        data[i].cIncotermsId = FormatUtilities.truncate(data[i].cIncotermsId, 12);        data[i].incotermsdescription = FormatUtilities.truncate(data[i].incotermsdescription, 50);        data[i].cDoctypeId = FormatUtilities.truncate(data[i].cDoctypeId, 22);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 50);        data[i].docstatus = FormatUtilities.truncate(data[i].docstatus, 50);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, 50);        data[i].paymentrule = FormatUtilities.truncate(data[i].paymentrule, 50);        data[i].deliveryrule = FormatUtilities.truncate(data[i].deliveryrule, 50);        data[i].cBpartnerLocationId = FormatUtilities.truncate(data[i].cBpartnerLocationId, 22);        data[i].cCampaignId = FormatUtilities.truncate(data[i].cCampaignId, 22);        data[i].invoicerule = FormatUtilities.truncate(data[i].invoicerule, 50);        data[i].deliveryLocationId = FormatUtilities.truncate(data[i].deliveryLocationId, 22);        data[i].deliverynotes = FormatUtilities.truncate(data[i].deliverynotes, 50);        data[i].freightcostrule = FormatUtilities.truncate(data[i].freightcostrule, 50);        data[i].cActivityId = FormatUtilities.truncate(data[i].cActivityId, 22);        data[i].poreference = FormatUtilities.truncate(data[i].poreference, 20);        data[i].cChargeId = FormatUtilities.truncate(data[i].cChargeId, 22);        data[i].adUserId = FormatUtilities.truncate(data[i].adUserId, 22);        data[i].mPricelistId = FormatUtilities.truncate(data[i].mPricelistId, 22);        data[i].mWarehouseId = FormatUtilities.truncate(data[i].mWarehouseId, 22);        data[i].priorityrule = FormatUtilities.truncate(data[i].priorityrule, 50);        data[i].cDoctypetargetId = FormatUtilities.truncate(data[i].cDoctypetargetId, 22);        data[i].deliveryviarule = FormatUtilities.truncate(data[i].deliveryviarule, 50);        data[i].mShipperId = FormatUtilities.truncate(data[i].mShipperId, 22);        data[i].billtoId = FormatUtilities.truncate(data[i].billtoId, 22);        data[i].cPaymenttermId = FormatUtilities.truncate(data[i].cPaymenttermId, 22);        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 22);        data[i].salesrepId = FormatUtilities.truncate(data[i].salesrepId, 22);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 22);}
    }
    return data;
  }
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Order_ID, String strPC_BPartner_ID, TableSQLData tableSQL)
    ...
    String orderClause = " dateordered desc";
...
String strParamDatePromised_f = vars.getSessionValue(tabId + "|paramDatePromised_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = OrdersE157BADD4E594D8487B150B5F79C6B54Data.set(strPC_BPartner_ID, Utility.getDefault(this, vars, "PriorityRule", "5", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "DeliveryRule", "A", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "DropShip_Location_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), OrdersE157BADD4E594D8487B150B5F79C6B54Data.selectDef2166_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField)), Utility.getDefault(this, vars, "BillTo_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "DateOrdered", "@#Date@", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "IsSelected", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "Generatetemplate", "N", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "FreightAmt", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "DropShip_User_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "IsTaxIncluded", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "InvoiceRule", "D", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "Deliverynotes", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "Incotermsdescription", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "TotalLines", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "Posted", "N", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "Processed", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), "Y", Utility.getDefault(this, vars, "IsDiscountPrinted", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "P", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "Description", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "GrandTotal", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "IsInvoiced", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "C_DocTypeTarget_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "DropShip_BPartner_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "FreightCostRule", "I", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "DatePromised", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "C_DocType_ID", "0", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "IsSelfService", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "C_Incoterms_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "PaymentRule", "B", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), OrdersE157BADD4E594D8487B150B5F79C6B54Data.selectDef3402_1(this, Utility.getDefault(this, vars, "C_Project_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField)), Utility.getDefault(this, vars, "C_Activity_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), "", Utility.getDefault(this, vars, "CopyFrom", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), OrdersE157BADD4E594D8487B150B5F79C6B54Data.selectDef2168_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField)), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "IsDelivered", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "Delivery_Location_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "Processing", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "POReference", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField), Utility.getDefault(this, vars, "CopyFromPO", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "N", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "123", "E157BADD4E594D8487B150B5F79C6B54", "", dataField));

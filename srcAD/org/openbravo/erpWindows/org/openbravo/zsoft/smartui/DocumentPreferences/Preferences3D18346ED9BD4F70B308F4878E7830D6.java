...
*/
  private Preferences3D18346ED9BD4F70B308F4878E7830D6Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private Preferences3D18346ED9BD4F70B308F4878E7830D6Data[] getRelationData(Preferences3D18346ED9BD4F70B308F4878E7830D6Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].zssiSmartinvoiceprefsId = FormatUtilities.truncate(data[i].zssiSmartinvoiceprefsId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].invoicetype = FormatUtilities.truncate(data[i].invoicetype, 32);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 32);        data[i].cBpartnerLocationId = FormatUtilities.truncate(data[i].cBpartnerLocationId, 32);        data[i].cDoctypeId = FormatUtilities.truncate(data[i].cDoctypeId, 32);        data[i].mPricelistId = FormatUtilities.truncate(data[i].mPricelistId, 32);        data[i].cPaymenttermId = FormatUtilities.truncate(data[i].cPaymenttermId, 32);        data[i].paymentrule = FormatUtilities.truncate(data[i].paymentrule, 50);        data[i].deliveryrule = FormatUtilities.truncate(data[i].deliveryrule, 50);        data[i].invoicerule = FormatUtilities.truncate(data[i].invoicerule, 50);        data[i].mWarehouseId = FormatUtilities.truncate(data[i].mWarehouseId, 32);        data[i].deliveryviarule = FormatUtilities.truncate(data[i].deliveryviarule, 50);        data[i].freightcostrule = FormatUtilities.truncate(data[i].freightcostrule, 50);        data[i].cIncotermsId = FormatUtilities.truncate(data[i].cIncotermsId, 32);        data[i].weightUom = FormatUtilities.truncate(data[i].weightUom, 32);        data[i].mShipperId = FormatUtilities.truncate(data[i].mShipperId, 32);}
    }
    return data;
  }
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|Zssi_Smartinvoiceprefs_ID", data[0].getField("zssiSmartinvoiceprefsId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZssi_Smartinvoiceprefs_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Preferences3D18346ED9BD4F70B308F4878E7830D6Data.set(Utility.getDefault(this, vars, "Paymentrule", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "Deliveryrule", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "C_Doctype_ID", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "M_Pricelist_ID", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "C_Incoterms_ID", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "Invoicetype", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "C_Paymentterm_ID", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Preferences3D18346ED9BD4F70B308F4878E7830D6Data.selectDef098C82C1E9EC4FA28E26CC27BECC914C_0(this, Utility.getDefault(this, vars, "Createdby", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Preferences3D18346ED9BD4F70B308F4878E7830D6Data.selectDefF8FC7E605916482D9BB182C702B852F3_1(this, Utility.getDefault(this, vars, "Updatedby", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField)), "", Utility.getDefault(this, vars, "Invoicerule", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "Freightcostrule", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_Location_ID", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "Isautoclosing", "N", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "N", dataField), Utility.getDefault(this, vars, "Isdefault", "Y", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "N", dataField), Utility.getDefault(this, vars, "Weight_Uom", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Utility.getDefault(this, vars, "Usecustomersdefaults", "N", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "N", dataField), "Y", Utility.getDefault(this, vars, "C_Bpartner_ID", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField), Preferences3D18346ED9BD4F70B308F4878E7830D6Data.selectDef0A747D2612984FB899B20B4AD1E145EC_2(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "4CDDF99823C94ACA81700FB8F12052AA", "3D18346ED9BD4F70B308F4878E7830D6", "", dataField));

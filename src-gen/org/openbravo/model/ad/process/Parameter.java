 ...
 */
public class Parameter extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_PINSTANCE = "pInstance";
    ...
    public ProcessInstance getPInstance() {
        return (ProcessInstance) get(PROPERTY_PINSTANCE);
    }

    public void setPInstance(ProcessInstance pInstance) {
        set(PROPERTY_PINSTANCE, pInstance);
    }

...
public class Textmodule703DA793449E4E2AB215385325C8B916 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Textmodule703DA793449E4E2AB215385325C8B916.class);
  
  private static final String windowId = "93C7676AA2A94769B48A4B6E102FDD67";
  private static final String tabId = "703DA793449E4E2AB215385325C8B916";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Textmodule703DA793449E4E2AB215385325C8B916.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Textmodule703DA793449E4E2AB215385325C8B916.view", "EDIT");

        printPageEdit(response, request, vars, false, strZssi_Order_Textmodule_ID, strPC_Order_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Textmodule703DA793449E4E2AB215385325C8B916.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamLine_f", tabId + "|paramLine_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strZssi_Order_Textmodule_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Textmodule703DA793449E4E2AB215385325C8B916.view", strView);
        }
      }
...
vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");
      ...
      vars.setSessionValue(tabId + "|Textmodule703DA793449E4E2AB215385325C8B916.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPC_Order_ID = vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Textmodule703DA793449E4E2AB215385325C8B916.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Textmodule703DA793449E4E2AB215385325C8B916.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Zssi_Order_Textmodule_ID");
      vars.setSessionValue(windowId + "|C_Order_ID", strPC_Order_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strZssi_Order_Textmodule_ID = vars.getRequiredStringParameter("inpzssiOrderTextmoduleId");
      //Textmodule703DA793449E4E2AB215385325C8B916Data data = getEditVariables(vars, strPC_Order_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Textmodule703DA793449E4E2AB215385325C8B916Data.delete(this, strZssi_Order_Textmodule_ID, strPC_Order_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strZssi_Order_Textmodule_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (Textmodule703DA793449E4E2AB215385325C8B916Data.deleteTransactional(conn, this, strKey, strPC_Order_ID)==0) {
...
*/
  private Textmodule703DA793449E4E2AB215385325C8B916Data getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
   ...
   private Textmodule703DA793449E4E2AB215385325C8B916Data[] getRelationData(Textmodule703DA793449E4E2AB215385325C8B916Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].zssiOrderTextmoduleId = FormatUtilities.truncate(data[i].zssiOrderTextmoduleId, 32);        data[i].cOrderId = FormatUtilities.truncate(data[i].cOrderId, 32);        data[i].zssiTextmoduleId = FormatUtilities.truncate(data[i].zssiTextmoduleId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].text = FormatUtilities.truncate(data[i].text, 50);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strZssi_Order_Textmodule_ID) throws ServletException {
    String strPC_Order_ID = Textmodule703DA793449E4E2AB215385325C8B916Data.selectParentID(this, strZssi_Order_Textmodule_ID);
    if (strPC_Order_ID.equals("")) {
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/OrderTemplates/Textmodule703DA793449E4E2AB215385325C8B916_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Textmodule703DA793449E4E2AB215385325C8B916", false, "document.frmMain.inpzssiOrderTextmoduleId", "grid", "..", "".equals("Y"), "OrderTemplates", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Textmodule703DA793449E4E2AB215385325C8B916_Relation.html", "OrderTemplates", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Textmodule703DA793449E4E2AB215385325C8B916_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", Textmodule703DA793449E4E2AB215385325C8B916Data.selectParent(this, strPC_Order_ID));
    else xmlDocument.setParameter("parent", Textmodule703DA793449E4E2AB215385325C8B916Data.selectParentTrl(this, strPC_Order_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZssi_Order_Textmodule_ID, String strPC_Order_ID, TableSQLData tableSQL)
    ...
    Textmodule703DA793449E4E2AB215385325C8B916Data[] data=null;
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Textmodule703DA793449E4E2AB215385325C8B916Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_Order_ID, strZssi_Order_Textmodule_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new Textmodule703DA793449E4E2AB215385325C8B916Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Textmodule703DA793449E4E2AB215385325C8B916Data.set(strPC_Order_ID, Utility.getDefault(this, vars, "Text", "", "93C7676AA2A94769B48A4B6E102FDD67", "703DA793449E4E2AB215385325C8B916", "", dataField), Utility.getDefault(this, vars, "Islower", "N", "93C7676AA2A94769B48A4B6E102FDD67", "703DA793449E4E2AB215385325C8B916", "N", dataField), Utility.getDefault(this, vars, "Ismodified", "N", "93C7676AA2A94769B48A4B6E102FDD67", "703DA793449E4E2AB215385325C8B916", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "93C7676AA2A94769B48A4B6E102FDD67", "703DA793449E4E2AB215385325C8B916", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "93C7676AA2A94769B48A4B6E102FDD67", "703DA793449E4E2AB215385325C8B916", "", dataField), Textmodule703DA793449E4E2AB215385325C8B916Data.selectDefE9FA66D9C5AE4E499DD4E6FAA9364C0E(this, strPC_Order_ID), Utility.getDefault(this, vars, "Updatedby", "", "93C7676AA2A94769B48A4B6E102FDD67", "703DA793449E4E2AB215385325C8B916", "", dataField), Textmodule703DA793449E4E2AB215385325C8B916Data.selectDef4AB8FAAB8CB64DFBA042409E35FF0884_0(this, Utility.getDefault(this, vars, "Updatedby", "", "93C7676AA2A94769B48A4B6E102FDD67", "703DA793449E4E2AB215385325C8B916", "", dataField)), Utility.getDefault(this, vars, "Createdby", "", "93C7676AA2A94769B48A4B6E102FDD67", "703DA793449E4E2AB215385325C8B916", "", dataField), Textmodule703DA793449E4E2AB215385325C8B916Data.selectDef68FEA96B6A2943BAA0F20E91C7D0A409_1(this, Utility.getDefault(this, vars, "Createdby", "", "93C7676AA2A94769B48A4B6E102FDD67", "703DA793449E4E2AB215385325C8B916", "", dataField)), Utility.getDefault(this, vars, "Zssi_Textmodule_ID", "", "93C7676AA2A94769B48A4B6E102FDD67", "703DA793449E4E2AB215385325C8B916", "", dataField), "", "Y");
        
      }
    } else {
      data = new Textmodule703DA793449E4E2AB215385325C8B916Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(Textmodule703DA793449E4E2AB215385325C8B916Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Textmodule703DA793449E4E2AB215385325C8B916", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpzssiOrderTextmoduleId", "", "..", "".equals("Y"), "OrderTemplates", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strZssi_Order_Textmodule_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Textmodule703DA793449E4E2AB215385325C8B916Data.getCurrentDBTimestamp(this, data.zssiOrderTextmoduleId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Textmodule703DA793449E4E2AB215385325C8B916. This Servlet was made by Wad constructor";

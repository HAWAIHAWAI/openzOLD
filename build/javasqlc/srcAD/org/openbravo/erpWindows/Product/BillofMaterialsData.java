...
WAD Generated class
 */
class BillofMaterialsData implements FieldProvider {
static Logger log4j = Logger.getLogger(BillofMaterialsData.class);
...
Select for edit
 */
  public static BillofMaterialsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static BillofMaterialsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        BillofMaterialsData objectBillofMaterialsData = new BillofMaterialsData();
        objectBillofMaterialsData.created = UtilSql.getValue(result, "created");
        objectBillofMaterialsData.createdbyr = UtilSql.getValue(result, "createdbyr");
        objectBillofMaterialsData.updated = UtilSql.getValue(result, "updated");
        objectBillofMaterialsData.updatedTimeStamp = UtilSql.getValue(result, "updated_time_stamp");
        objectBillofMaterialsData.updatedby = UtilSql.getValue(result, "updatedby");
        objectBillofMaterialsData.updatedbyr = UtilSql.getValue(result, "updatedbyr");
        objectBillofMaterialsData.bomtype = UtilSql.getValue(result, "bomtype");
        objectBillofMaterialsData.mProductId = UtilSql.getValue(result, "m_product_id");
        objectBillofMaterialsData.mProductIdr = UtilSql.getValue(result, "m_product_idr");
        objectBillofMaterialsData.isactive = UtilSql.getValue(result, "isactive");
        objectBillofMaterialsData.line = UtilSql.getValue(result, "line");
        objectBillofMaterialsData.productValue = UtilSql.getValue(result, "product_value");
        objectBillofMaterialsData.mProductbomId = UtilSql.getValue(result, "m_productbom_id");
        objectBillofMaterialsData.mProductbomIdr = UtilSql.getValue(result, "m_productbom_idr");
        objectBillofMaterialsData.bomqty = UtilSql.getValue(result, "bomqty");
        objectBillofMaterialsData.description = UtilSql.getValue(result, "description");
        objectBillofMaterialsData.constuctivemeasure = UtilSql.getValue(result, "constuctivemeasure");
        objectBillofMaterialsData.rawmaterial = UtilSql.getValue(result, "rawmaterial");
        objectBillofMaterialsData.cBpartnerId = UtilSql.getValue(result, "c_bpartner_id");
        objectBillofMaterialsData.cBpartnerIdr = UtilSql.getValue(result, "c_bpartner_idr");
        objectBillofMaterialsData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        objectBillofMaterialsData.adClientId = UtilSql.getValue(result, "ad_client_id");
        objectBillofMaterialsData.mProductBomId = UtilSql.getValue(result, "m_product_bom_id");
        objectBillofMaterialsData.language = UtilSql.getValue(result, "language");
        objectBillofMaterialsData.adUserClient = "";
        objectBillofMaterialsData.adOrgClient = "";
        objectBillofMaterialsData.createdby = "";
        objectBillofMaterialsData.trBgcolor = "";
        objectBillofMaterialsData.totalCount = "";
        objectBillofMaterialsData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectBillofMaterialsData);
    ...
    BillofMaterialsData objectBillofMaterialsData[] = new BillofMaterialsData[vector.size()];
    vector.copyInto(objectBillofMaterialsData);
    return(objectBillofMaterialsData);
  }

/**
Create a registry
 */
  public static BillofMaterialsData[] set(String mProductId, String productValue, String mProductIdr, String bomtype, String isactive, String adOrgId, String line, String createdby, String createdbyr, String description, String bomqty, String constuctivemeasure, String adClientId, String mProductbomId, String mProductbomIdr, String rawmaterial, String mProductBomId, String cBpartnerId, String cBpartnerIdr, String updatedby, String updatedbyr)    throws ServletException {
    BillofMaterialsData objectBillofMaterialsData[] = new BillofMaterialsData[1];
    objectBillofMaterialsData[0] = new BillofMaterialsData();
    objectBillofMaterialsData[0].created = "";
    objectBillofMaterialsData[0].createdbyr = createdbyr;
    objectBillofMaterialsData[0].updated = "";
    objectBillofMaterialsData[0].updatedTimeStamp = "";
    objectBillofMaterialsData[0].updatedby = updatedby;
    objectBillofMaterialsData[0].updatedbyr = updatedbyr;
    objectBillofMaterialsData[0].bomtype = bomtype;
    objectBillofMaterialsData[0].mProductId = mProductId;
    objectBillofMaterialsData[0].mProductIdr = mProductIdr;
    objectBillofMaterialsData[0].isactive = isactive;
    objectBillofMaterialsData[0].line = line;
    objectBillofMaterialsData[0].productValue = productValue;
    objectBillofMaterialsData[0].mProductbomId = mProductbomId;
    objectBillofMaterialsData[0].mProductbomIdr = mProductbomIdr;
    objectBillofMaterialsData[0].bomqty = bomqty;
    objectBillofMaterialsData[0].description = description;
    objectBillofMaterialsData[0].constuctivemeasure = constuctivemeasure;
    objectBillofMaterialsData[0].rawmaterial = rawmaterial;
    objectBillofMaterialsData[0].cBpartnerId = cBpartnerId;
    objectBillofMaterialsData[0].cBpartnerIdr = cBpartnerIdr;
    objectBillofMaterialsData[0].adOrgId = adOrgId;
    objectBillofMaterialsData[0].adClientId = adClientId;
    objectBillofMaterialsData[0].mProductBomId = mProductBomId;
    objectBillofMaterialsData[0].language = "";
    return objectBillofMaterialsData;
  }

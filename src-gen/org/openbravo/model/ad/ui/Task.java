...
import org.openbravo.model.ad.access.TaskAccess;
...
/**
 * Entity class for entity ADTask (stored in table AD_Task).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Task extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "AD_Task";
    public static final String ENTITY_NAME = "ADTask";

...
public class PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D.class);
  
  private static final String windowId = "80D2310724264A4390E29EBD2A4AAFE5";
  private static final String tabId = "6CA7D852D0AC4E459F132F5B63F9009D";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D.view", "EDIT");

        printPageEdit(response, request, vars, false, strMRP_Inoutplan_V_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamPlanneddate_f", tabId + "|paramPlanneddate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strMRP_Inoutplan_V_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|MRP_Inoutplan_V_ID");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strMRP_Inoutplan_V_ID = vars.getRequiredStringParameter("inpmrpInoutplanVId");
      //PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData.delete(this, strMRP_Inoutplan_V_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strMRP_Inoutplan_V_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData.deleteTransactional(conn, this, strKey)==0) {
...
*/
  private PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData data = new PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData();
   ...
   private PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData[] getRelationData(PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData[] data) {
    if (data!=null) {
...
String strParamPlanneddate_f = vars.getSessionValue(tabId + "|paramPlanneddate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/openbravo/zsoft/mrp/WarehouseOverview/PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D", false, "document.frmMain.inpmrpInoutplanVId", "grid", "..", "".equals("Y"), "WarehouseOverview", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D_Relation.html", "WarehouseOverview", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strMRP_Inoutplan_V_ID, TableSQLData tableSQL)
    ...
    PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData[] data=null;
...
String strParamPlanneddate_f = vars.getSessionValue(tabId + "|paramPlanneddate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strMRP_Inoutplan_V_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData.set(Utility.getDefault(this, vars, "Updatedby", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData.selectDef2F04CE6BDC284E2C80162ECBDD4A2984_0(this, Utility.getDefault(this, vars, "Updatedby", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField)), Utility.getDefault(this, vars, "Documenttype", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), "Y", Utility.getDefault(this, vars, "Estimated_Stock_Qty", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData.selectDefF082229707444D7BB13B9D59C0DD1B08_1(this, Utility.getDefault(this, vars, "Createdby", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField)), Utility.getDefault(this, vars, "Movementqty", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), Utility.getDefault(this, vars, "C_Uom_ID", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), "", Utility.getDefault(this, vars, "C_Bpartner_ID", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData.selectDefB92C73B63EE140898CC7EE877DE8A96E_2(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField)), Utility.getDefault(this, vars, "M_Product_ID", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData.selectDef7719E258DAF24AE1BDEE48E95ECCA4AE_3(this, Utility.getDefault(this, vars, "M_Product_ID", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField)), Utility.getDefault(this, vars, "Zssi_Onhanqty_Overview_ID", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), Utility.getDefault(this, vars, "Planneddate", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), Utility.getDefault(this, vars, "C_Orderline_ID", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField), Utility.getDefault(this, vars, "M_Product_Category_ID", "", "80D2310724264A4390E29EBD2A4AAFE5", "6CA7D852D0AC4E459F132F5B63F9009D", "", dataField));
        
      }
    } else {
      data = new PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmrpInoutplanVId", "", "..", "".equals("Y"), "WarehouseOverview", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strMRP_Inoutplan_V_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009DData.getCurrentDBTimestamp(this, data.mrpInoutplanVId).equals(
  ...
  public String getServletInfo() {
    return "Servlet PlannedMovementsComplete6CA7D852D0AC4E459F132F5B63F9009D. This Servlet was made by Wad constructor";

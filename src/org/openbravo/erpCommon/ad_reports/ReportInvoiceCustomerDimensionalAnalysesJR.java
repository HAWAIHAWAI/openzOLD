...
public class ReportInvoiceCustomerDimensionalAnalysesJR extends HttpSecureAppServlet {
  ...
  private void printPageHtml(HttpServletRequest request, HttpServletResponse response,
      ...
      String strPartnerSalesrepId, String strCurrencyId, String strOutput) throws Exception {
    if (log4j.isDebugEnabled())
    ...
    if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      String strRepTitle=LocalizationUtils.getElementTextByElementName(this, "Report Customer Dimensional Analyses", vars.getLanguage());

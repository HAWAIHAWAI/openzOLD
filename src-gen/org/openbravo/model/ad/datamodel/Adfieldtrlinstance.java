...
/**
 * Entity class for entity ad_field_trl_instance (stored in table ad_field_trl_instance).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Adfieldtrlinstance extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ad_field_trl_instance";
    public static final String ENTITY_NAME = "ad_field_trl_instance";

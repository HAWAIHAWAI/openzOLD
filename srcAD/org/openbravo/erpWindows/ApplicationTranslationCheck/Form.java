...
public class Form extends HttpSecureAppServlet {
  ...
  private static final String tabId = "531";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strAD_Form_Trl_ID = vars.getGlobalVariable("inpadFormTrlId", windowId + "|AD_Form_Trl_ID", "");
        ...
        strPAD_Language = getParentID(vars, strAD_Form_Trl_ID);
      ...
      if (strView.equals("EDIT")) 
        ...
        printPageEdit(response, request, vars, false, strAD_Form_Trl_ID, strPAD_Language, tableSQL);

      else printPageDataSheet(response, vars, strPAD_Language, strAD_Form_Trl_ID, tableSQL);
      ...
      String strPAD_Language = getParentID(vars, strAD_Form_Trl_ID);
      ...
      if (vars.commandIn("DIRECTRELATION")){
        ...
        printPageDataSheet(response, vars, strPAD_Language, strAD_Form_Trl_ID, tableSQL);
      }
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String message = deleteRelation(vars, strAD_Form_Trl_ID, strPAD_Language);
      if (!message.equals("")) {
      ...
      String strAD_Form_Trl_ID = vars.getRequiredStringParameter("inpadFormTrlId");
      //FormData data = getEditVariables(vars, strPAD_Language);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = FormData.delete(this, strAD_Form_Trl_ID, strPAD_Language, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
/*
  String deleteRelation(VariablesSecureApp vars, String strAD_Form_Trl_ID, String strPAD_Language) throws IOException, ServletException {
    ...
    try {
      ...
      if (!strAD_Form_Trl_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (FormData.deleteTransactional(conn, this, strKey, strPAD_Language)==0) {
...
*/
  private FormData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Language) throws IOException,ServletException {
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Form_Trl_ID) throws ServletException {
    String strPAD_Language = FormData.selectParentID(this, strAD_Form_Trl_ID);
    if (strPAD_Language.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPAD_Language) throws IOException,ServletException {
      FormData[] data = FormData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Language, vars.getStringParameter("inpadFormTrlId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPAD_Language, String strAD_Form_Trl_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ApplicationTranslationCheck/Form_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Form", false, "document.frmMain.inpadFormTrlId", "grid", "..", "".equals("Y"), "ApplicationTranslationCheck", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Form_Relation.html", "ApplicationTranslationCheck", "W", strReplaceWith, tabs.breadcrumb());
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", FormData.selectParent(this, strPAD_Language));
    else xmlDocument.setParameter("parent", FormData.selectParentTrl(this, strPAD_Language));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Form_Trl_ID, String strPAD_Language, TableSQLData tableSQL)
    throws IOException, ServletException {
    ...
    String orderClause = " AD_Form_Trl.Name";
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = FormData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Language, strAD_Form_Trl_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = FormData.set(strPAD_Language, Utility.getDefault(this, vars, "Description", "", "250", "531", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "250", "531", "", dataField), FormData.selectDef4616_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "250", "531", "", dataField)), "", "0", "0", Utility.getDefault(this, vars, "Name", "", "250", "531", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "250", "531", "", dataField), FormData.selectDef4614_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "250", "531", "", dataField)), Utility.getDefault(this, vars, "Help", "", "250", "531", "", dataField), Utility.getDefault(this, vars, "IsTranslated", "", "250", "531", "N", dataField), Utility.getDefault(this, vars, "AD_Form_ID", "", "250", "531", "", dataField), "Y");
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Form", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpadFormTrlId", "", "..", "".equals("Y"), "ApplicationTranslationCheck", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strAD_Form_Trl_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (FormData.getCurrentDBTimestamp(this, data.adFormTrlId).equals(

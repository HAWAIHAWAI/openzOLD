...
/**
 * Entity class for entity zspm_materialmovements_view (stored in table zspm_materialmovements_view).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zspm_materialmovements_view extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zspm_materialmovements_view";
    public static final String ENTITY_NAME = "zspm_materialmovements_view";
    ...
    public zspm_materialmovements_view() {

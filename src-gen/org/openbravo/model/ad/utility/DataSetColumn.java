 ...
 */
public class DataSetColumn extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISEXCLUDED = "isExcluded";
    public static final String PROPERTY_MODULE = "module";

    public DataSetColumn() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_ISEXCLUDED, false);
    }
    ...
    public Boolean isExcluded() {
        return (Boolean) get(PROPERTY_ISEXCLUDED);
    }

    public void setExcluded(Boolean isExcluded) {
        set(PROPERTY_ISEXCLUDED, isExcluded);
    }

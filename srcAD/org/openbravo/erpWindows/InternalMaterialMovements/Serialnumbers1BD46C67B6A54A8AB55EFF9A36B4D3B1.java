...
*/
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPM_Internal_Consumptionline_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|M_Internal_Consumptionline_ID", data[0].mInternalConsumptionlineId);    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);

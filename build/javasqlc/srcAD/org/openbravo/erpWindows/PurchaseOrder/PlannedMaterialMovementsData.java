...
Select for edit
 */
  public static PlannedMaterialMovementsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String m_product_id, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static PlannedMaterialMovementsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String m_product_id, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Create a registry
 */
  public static PlannedMaterialMovementsData[] set(String updatedby, String updatedbyr, String documenttype, String isactive, String estimatedStockQty, String createdby, String createdbyr, String movementqty, String adClientId, String cUomId, String cBpartnerId, String cBpartnerIdr, String mrpInoutplanVId, String mProductId, String mProductIdr, String zssiOnhanqtyOverviewId, String planneddate, String adOrgId, String cOrderlineId, String mWarehouseId, String cProjecttaskId, String mProductCategoryId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET MRP_Inoutplan_V_ID = (?) , M_Product_ID = (?) , Planneddate = TO_DATE(?) , AD_Client_ID = (?) , Movementqty = TO_NUMBER(?) , Estimated_Stock_Qty = TO_NUMBER(?) , Documenttype = (?) , C_Projecttask_ID = (?) , C_Orderline_ID = (?) , Isactive = (?) , C_Uom_ID = (?) , C_Bpartner_ID = (?) , M_Product_Category_ID = (?) , M_Warehouse_ID = (?) , AD_Org_ID = (?) , Zssi_Onhanqty_Overview_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (MRP_Inoutplan_V_ID, M_Product_ID, Planneddate, AD_Client_ID, Movementqty, Estimated_Stock_Qty, Documenttype, C_Projecttask_ID, C_Orderline_ID, Isactive, C_Uom_ID, C_Bpartner_ID, M_Product_Category_ID, M_Warehouse_ID, AD_Org_ID, Zssi_Onhanqty_Overview_ID, created, createdby, updated, updatedBy)" +

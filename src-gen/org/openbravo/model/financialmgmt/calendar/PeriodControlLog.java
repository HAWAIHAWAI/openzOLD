 ...
 */
public class PeriodControlLog extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISRECURSIVE = "isRecursive";
    ...
    public PeriodControlLog() {
        ...
        setDefaultValue(PROPERTY_ISRECURSIVE, false);
    }
    ...
    public Boolean isRecursive() {
        return (Boolean) get(PROPERTY_ISRECURSIVE);
    }

    public void setRecursive(Boolean isRecursive) {
        set(PROPERTY_ISRECURSIVE, isRecursive);
    }

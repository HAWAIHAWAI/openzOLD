 ...
 */
public class Period extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_FINANCIALMGMTPERIODCONTROLLIST =
        "financialMgmtPeriodControlList";
    ...
    public Period() {
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTPERIODCONTROLLIST,
            new ArrayList<Object>());
    }
    ...
    public void setFinancialMgmtPeriodControlList(
        List<PeriodControl> financialMgmtPeriodControlList) {
        set(PROPERTY_FINANCIALMGMTPERIODCONTROLLIST,
            financialMgmtPeriodControlList);
    }
}

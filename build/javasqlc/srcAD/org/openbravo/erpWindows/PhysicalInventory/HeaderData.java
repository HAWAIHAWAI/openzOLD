...
Create a registry
 */
  public static HeaderData[] set(String updateqty, String createdby, String createdbyr, String updatedby, String updatedbyr, String posted, String postedBtn, String mInventoryId, String mPerpetualinvId, String generatelist, String description, String adClientId, String user2Id, String processing, String mWarehouseId, String cActivityId, String cCampaignId, String movementdate, String processed, String adOrgtrxId, String user1Id, String cProjectId, String cProjectIdr, String isactive, String adOrgId, String name)    throws ServletException {

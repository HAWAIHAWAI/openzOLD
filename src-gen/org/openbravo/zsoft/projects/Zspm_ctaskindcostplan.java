...
/**
 * Entity class for entity zspm_ctaskindcostplan (stored in table zspm_ctaskindcostplan).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Zspm_ctaskindcostplan extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zspm_ctaskindcostplan";
    public static final String ENTITY_NAME = "zspm_ctaskindcostplan";

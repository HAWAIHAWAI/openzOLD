...
public class TaskAccess extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(TaskAccess.class);
  
  private static final String windowId = "111";
  private static final String tabId = "313";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strAD_Task_Access_ID = vars.getGlobalVariable("inpadTaskAccessId", windowId + "|AD_Task_Access_ID", "");
        ...
        strPAD_Role_ID = getParentID(vars, strAD_Task_Access_ID);
      ...
      String strView = vars.getSessionValue(tabId + "|TaskAccess.view");
      if (strView.equals("")) {
      ...
      if (strView.equals("EDIT")) 
        ...
        printPageEdit(response, request, vars, false, strAD_Task_Access_ID, strPAD_Role_ID, tableSQL);

      else printPageDataSheet(response, vars, strPAD_Role_ID, strAD_Task_Access_ID, tableSQL);
      ...
      String strPAD_Role_ID = getParentID(vars, strAD_Task_Access_ID);
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|TaskAccess.view", "EDIT");

        printPageEdit(response, request, vars, false, strAD_Task_Access_ID, strPAD_Role_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|TaskAccess.view", "RELATION");
        printPageDataSheet(response, vars, strPAD_Role_ID, strAD_Task_Access_ID, tableSQL);
      }
...
vars.getRequestGlobalVariable("inpParamAD_Task_ID", tabId + "|paramAD_Task_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strAD_Task_Access_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|TaskAccess.view", strView);
        }
      }
...
vars.getGlobalVariable("inpadRoleId", windowId + "|AD_Role_ID");
      ...
      vars.setSessionValue(tabId + "|TaskAccess.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPAD_Role_ID = vars.getGlobalVariable("inpadRoleId", windowId + "|AD_Role_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|TaskAccess.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|TaskAccess.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|AD_Task_Access_ID");
      vars.setSessionValue(windowId + "|AD_Role_ID", strPAD_Role_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String message = deleteRelation(vars, strAD_Task_Access_ID, strPAD_Role_ID);
      if (!message.equals("")) {
      ...
      String strAD_Task_Access_ID = vars.getRequiredStringParameter("inpadTaskAccessId");
      //TaskAccessData data = getEditVariables(vars, strPAD_Role_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = TaskAccessData.delete(this, strAD_Task_Access_ID, strPAD_Role_ID);
...
/*
  String deleteRelation(VariablesSecureApp vars, String strAD_Task_Access_ID, String strPAD_Role_ID) throws IOException, ServletException {
    ...
    try {
      ...
      if (!strAD_Task_Access_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (TaskAccessData.deleteTransactional(conn, this, strKey, strPAD_Role_ID)==0) {
...
*/
  private TaskAccessData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Role_ID) throws IOException,ServletException {
   ...
   private TaskAccessData[] getRelationData(TaskAccessData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adTaskAccessId = FormatUtilities.truncate(data[i].adTaskAccessId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].adRoleId = FormatUtilities.truncate(data[i].adRoleId, 44);        data[i].adTaskId = FormatUtilities.truncate(data[i].adTaskId, 44);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Task_Access_ID) throws ServletException {
    String strPAD_Role_ID = TaskAccessData.selectParentID(this, strAD_Task_Access_ID);
    if (strPAD_Role_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPAD_Role_ID) throws IOException,ServletException {
      TaskAccessData[] data = TaskAccessData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Role_ID, vars.getStringParameter("inpadTaskAccessId", ""));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPAD_Role_ID, String strAD_Task_Access_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Role/TaskAccess_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "TaskAccess", false, "document.frmMain.inpadTaskAccessId", "grid", "..", "".equals("Y"), "Role", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "TaskAccess_Relation.html", "Role", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "TaskAccess_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", TaskAccessData.selectParent(this, strPAD_Role_ID));
    else xmlDocument.setParameter("parent", TaskAccessData.selectParentTrl(this, strPAD_Role_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Task_Access_ID, String strPAD_Role_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = TaskAccessData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Role_ID, strAD_Task_Access_ID);
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = TaskAccessData.set(strPAD_Role_ID, Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "111", "313", "", dataField), "Y", Utility.getDefault(this, vars, "IsReadWrite", "", "111", "313", "N", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "111", "313", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "111", "313", "", dataField), TaskAccessData.selectDef1312_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "111", "313", "", dataField)), Utility.getDefault(this, vars, "AD_Task_ID", "", "111", "313", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "111", "313", "", dataField), TaskAccessData.selectDef1314_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "111", "313", "", dataField)));
        
      }
    } else {
      data = new TaskAccessData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(TaskAccessData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "TaskAccess", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpadTaskAccessId", "", "..", "".equals("Y"), "Role", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strAD_Task_Access_ID));
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
		     ...
		     if(type == 'I') {
		       ...
		       if (TaskAccessData.getCurrentDBTimestamp(this, data.adTaskAccessId).equals(
  ...
  public String getServletInfo() {
    return "Servlet TaskAccess. This Servlet was made by Wad constructor";

...
public class ProcessMapping extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(ProcessMapping.class);
  
  private static final String windowId = "165";
  private static final String tabId = "800201";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|ProcessMapping.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(windowId + "|AD_Model_Object_ID", strPAD_Model_Object_ID);
      vars.setSessionValue("800200|Process Class.view", "EDIT");
      vars.removeSessionValue(windowId + "|AD_Process_ID");
      refreshParentSession(vars, strPAD_Model_Object_ID);

      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|ProcessMapping.view", "EDIT");

        printPageEdit(response, request, vars, false, strAD_Model_Object_Mapping_ID, strPAD_Model_Object_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|ProcessMapping.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamMappingName", tabId + "|paramMappingName");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strAD_Model_Object_Mapping_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|ProcessMapping.view", strView);
        }
      }
...
vars.getGlobalVariable("inpadModelObjectId", windowId + "|AD_Model_Object_ID");
      ...
      vars.setSessionValue(tabId + "|ProcessMapping.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPAD_Model_Object_ID = vars.getGlobalVariable("inpadModelObjectId", windowId + "|AD_Model_Object_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|ProcessMapping.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|ProcessMapping.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|AD_Model_Object_Mapping_ID");
      vars.setSessionValue(windowId + "|AD_Model_Object_ID", strPAD_Model_Object_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strAD_Model_Object_Mapping_ID = vars.getRequiredStringParameter("inpadModelObjectMappingId");
      //ProcessMappingData data = getEditVariables(vars, strPAD_Model_Object_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = ProcessMappingData.delete(this, strAD_Model_Object_Mapping_ID, strPAD_Model_Object_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strAD_Model_Object_Mapping_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (ProcessMappingData.deleteTransactional(conn, this, strKey, strPAD_Model_Object_ID)==0) {
...
*/
  private ProcessMappingData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Model_Object_ID) throws IOException,ServletException {
    ProcessMappingData data = new ProcessMappingData();
   ...
   private ProcessMappingData[] getRelationData(ProcessMappingData[] data) {
    if (data!=null) {
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPAD_Model_Object_ID) throws IOException,ServletException {
      ProcessClassData[] data = ProcessClassData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getSessionValue(windowId + "|AD_Process_ID"), strPAD_Model_Object_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Model_Object_Mapping_ID) throws ServletException {
    String strPAD_Model_Object_ID = ProcessMappingData.selectParentID(this, strAD_Model_Object_Mapping_ID);
    if (strPAD_Model_Object_ID.equals("")) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Model_Object_Mapping_ID", data[0].getField("adModelObjectMappingId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars, String strPAD_Model_Object_ID) throws IOException,ServletException {
      ProcessMappingData[] data = ProcessMappingData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Model_Object_ID, vars.getStringParameter("inpadModelObjectMappingId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamMappingName = vars.getSessionValue(tabId + "|paramMappingName");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ReportandProcess/ProcessMapping_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ProcessMapping", false, "document.frmMain.inpadModelObjectMappingId", "grid", "..", "".equals("Y"), "ReportandProcess", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ProcessMapping_Relation.html", "ReportandProcess", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ProcessMapping_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", ProcessMappingData.selectParent(this, strPAD_Model_Object_ID));
    else xmlDocument.setParameter("parent", ProcessMappingData.selectParentTrl(this, strPAD_Model_Object_ID));
...
String strParamMappingName = vars.getSessionValue(tabId + "|paramMappingName");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = ProcessMappingData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Model_Object_ID, strAD_Model_Object_Mapping_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ProcessMappingData.set(strPAD_Model_Object_ID, "0", "0", Utility.getDefault(this, vars, "MappingName", "", "165", "800201", "", dataField), Utility.getDefault(this, vars, "IsDefault", "N", "165", "800201", "N", dataField), "", Utility.getDefault(this, vars, "Createdby", "", "165", "800201", "", dataField), ProcessMappingData.selectDef802462_0(this, Utility.getDefault(this, vars, "Createdby", "", "165", "800201", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "165", "800201", "", dataField), ProcessMappingData.selectDef802464_1(this, Utility.getDefault(this, vars, "Updatedby", "", "165", "800201", "", dataField)), "Y");
        
      }
    } else {
      data = new ProcessMappingData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(ProcessMappingData) ref1;
      data[0].created="";
      data[0].updated="";
    }
      
    String currentPOrg=ProcessClassData.selectOrg(this, strPAD_Model_Object_ID);
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "ProcessMapping", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpadModelObjectMappingId", "", "..", "".equals("Y"), "ReportandProcess", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strAD_Model_Object_Mapping_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (ProcessMappingData.getCurrentDBTimestamp(this, data.adModelObjectMappingId).equals(
  ...
  public String getServletInfo() {
    return "Servlet ProcessMapping. This Servlet was made by Wad constructor";

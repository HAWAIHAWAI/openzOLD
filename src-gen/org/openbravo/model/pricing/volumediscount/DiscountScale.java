 ...
 */
public class DiscountScale extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_RAPPEL = "rappel";
    public static final String PROPERTY_DISCOUNT = "discount";
    public static final String PROPERTY_AMNTFROM = "amntFrom";
    public static final String PROPERTY_AMNTTO = "amntTo";
    ...
    public VolumeDiscount getRappel() {
        return (VolumeDiscount) get(PROPERTY_RAPPEL);
    }

    public void setRappel(VolumeDiscount rappel) {
        set(PROPERTY_RAPPEL, rappel);
    }
    ...
    public BigDecimal getAmntFrom() {
        return (BigDecimal) get(PROPERTY_AMNTFROM);
    }

    public void setAmntFrom(BigDecimal amntFrom) {
        set(PROPERTY_AMNTFROM, amntFrom);
    }

    public BigDecimal getAmntTo() {
        return (BigDecimal) get(PROPERTY_AMNTTO);
    }

    public void setAmntTo(BigDecimal amntTo) {
        set(PROPERTY_AMNTTO, amntTo);
    }
}

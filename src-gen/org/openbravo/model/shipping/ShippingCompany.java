 ...
 */
public class ShippingCompany extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_SHIPPINGSHIPPINGCOMPANYFREIGHTLIST =
        "shippingShippingCompanyFreightList";

    public ShippingCompany() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_SHIPPINGSHIPPINGCOMPANYFREIGHTLIST,
    ...
    public void setShippingShippingCompanyFreightList(
        List<ShippingCompanyFreight> shippingShippingCompanyFreightList) {
        set(PROPERTY_SHIPPINGSHIPPINGCOMPANYFREIGHTLIST,
            shippingShippingCompanyFreightList);
    }
}

 ...
 */
public class TextInterface extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_STILLUSED = "stillused";
    ...
    public TextInterface() {
        ...
        setDefaultValue(PROPERTY_STILLUSED, false);
    ...
    public Boolean isStillused() {
        return (Boolean) get(PROPERTY_STILLUSED);
    }

    public void setStillused(Boolean stillused) {
        set(PROPERTY_STILLUSED, stillused);
    }

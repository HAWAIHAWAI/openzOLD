...
class FieldsData implements FieldProvider {
...
/**
Description of the fields of a tab
 */
  public static FieldsData[] selectDescription(ConnectionProvider connectionProvider, String tab)    throws ServletException {
    return selectDescription(connectionProvider, tab, 0, 0);
  }

/**
Description of the fields of a tab
 */
  public static FieldsData[] selectDescription(ConnectionProvider connectionProvider, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Description of the fields of a tab
 */
  public static FieldsData[] selectDescriptionTrl(ConnectionProvider connectionProvider, String adLanguage, String tab)    throws ServletException {
    return selectDescriptionTrl(connectionProvider, adLanguage, tab, 0, 0);
  }

/**
Description of the fields of a tab
 */
  public static FieldsData[] selectDescriptionTrl(ConnectionProvider connectionProvider, String adLanguage, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Name of the tab
 */
  public static String tabName(ConnectionProvider connectionProvider, String tab)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Name of the window
 */
  public static String windowName(ConnectionProvider connectionProvider, String tab)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Name of the columns parent of the tab
 */
  public static FieldsData[] parentsColumnRealAll(ConnectionProvider connectionProvider, String parentTab, String tab)    throws ServletException {
    return parentsColumnRealAll(connectionProvider, parentTab, tab, 0, 0);
  }

/**
Name of the columns parent of the tab
 */
  public static FieldsData[] parentsColumnRealAll(ConnectionProvider connectionProvider, String parentTab, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT ColumnName AS NAME, AD_REFERENCE_id AS reference, ad_reference_value_id AS referencevalue," +
      "        (SELECT tableNAME FROM AD_TABLE, AD_TAB WHERE AD_TABLE.ad_table_id = AD_TAB.ad_table_id" +
...
Name of the columns parent of the tab
 */
  public static FieldsData[] parentsColumnDisplayNameSortTab(ConnectionProvider connectionProvider, String adLanguage, String table)    throws ServletException {
    return parentsColumnDisplayNameSortTab(connectionProvider, adLanguage, table, 0, 0);
  }

/**
Name of the columns parent of the tab
 */
  public static FieldsData[] parentsColumnDisplayNameSortTab(ConnectionProvider connectionProvider, String adLanguage, String table, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Name of the columns parent of the tab
 */
  public static FieldsData[] parentsColumnDisplayName(ConnectionProvider connectionProvider, String adLanguage, String tab, String parentTab)    throws ServletException {
    return parentsColumnDisplayName(connectionProvider, adLanguage, tab, parentTab, 0, 0);
  }

/**
Name of the columns parent of the tab
 */
  public static FieldsData[] parentsColumnDisplayName(ConnectionProvider connectionProvider, String adLanguage, String tab, String parentTab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT ad_field.name As Name, ad_field_trl.name as columnname " +
      "          FROM ad_field left join ad_field_trl on ad_field.ad_field_id = ad_field_trl.ad_field_id " +
...
Name of the columns parent of the tab
 */
  public static FieldsData[] parentsColumnDisplayNameReal(ConnectionProvider connectionProvider, String adLanguage, String tab, String parentTab)    throws ServletException {
    return parentsColumnDisplayNameReal(connectionProvider, adLanguage, tab, parentTab, 0, 0);
  }

/**
Name of the columns parent of the tab
 */
  public static FieldsData[] parentsColumnDisplayNameReal(ConnectionProvider connectionProvider, String adLanguage, String tab, String parentTab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT ad_field.Name AS NAME, AD_FIELD_TRL.NAME AS COLUMNNAME" +
      "        FROM AD_FIELD left join AD_FIELD_TRL on AD_FIELD.AD_FIELD_ID = AD_FIELD_TRL.AD_FIELD_ID" +
...
Name of the columns parent of the tab
 */
  public static FieldsData[] parentsColumnDisplayNameRealAll(ConnectionProvider connectionProvider, String adLanguage, String tab)    throws ServletException {
    return parentsColumnDisplayNameRealAll(connectionProvider, adLanguage, tab, 0, 0);
  }

/**
Name of the columns parent of the tab
 */
  public static FieldsData[] parentsColumnDisplayNameRealAll(ConnectionProvider connectionProvider, String adLanguage, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT ad_field.Name AS NAME, AD_FIELD_TRL.NAME AS COLUMNNAME" +
      "        FROM AD_FIELD left join AD_FIELD_TRL on AD_FIELD.AD_FIELD_ID = AD_FIELD_TRL.AD_FIELD_ID " +
...
/**
Fields of reference list in a tab
 */
  public static FieldsData[] selectLists(ConnectionProvider connectionProvider, String tab)    throws ServletException {
    return selectLists(connectionProvider, tab, 0, 0);
  }

/**
Fields of reference list in a tab
 */
  public static FieldsData[] selectLists(ConnectionProvider connectionProvider, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  public static FieldsData[] selectTables(ConnectionProvider connectionProvider, String tab)    throws ServletException {
    return selectTables(connectionProvider, tab, 0, 0);
  }

/**
Fields of reference table in a tab
 */
  public static FieldsData[] selectTables(ConnectionProvider connectionProvider, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Fields of reference table in a tab
 */
  public static FieldsData[] selectTableDirs(ConnectionProvider connectionProvider, String tab)    throws ServletException {
    return selectTableDirs(connectionProvider, tab, 0, 0);
  }

/**
Fields of reference table in a tab
 */
  public static FieldsData[] selectTableDirs(ConnectionProvider connectionProvider, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Checks if the tab has action buttons
 */
  public static String hasButtonList(ConnectionProvider connectionProvider, String tab)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "          select count(*) as total" +
      "        from ad_field f," +
...
/**
Checks if the tab is not linked to parent tab 
 */
  public static String isStandaloneTab(ConnectionProvider connectionProvider, String tab)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "isstandalone");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);

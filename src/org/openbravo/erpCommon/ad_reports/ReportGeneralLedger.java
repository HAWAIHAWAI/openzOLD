...
public class ReportGeneralLedger extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      printPageDataSheet(response, vars, strDateFrom, strDateTo, strAmtFrom, strAmtTo,
          ...
          strcelementvaluetodes,strAccountMatch);
      ...
      if (vars.commandIn("PDF"))
        printPageDataPDF(request, response, vars, strDateFrom, strDateTo, strAmtFrom, strAmtTo,
            strcelementvaluefrom, strcelementvalueto, strOrg, strcBpartnerId, strmProductId,
            strcProjectId, strGroupBy, strHide, strcAcctSchemaId,strAccountMatch);
      else
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
      ...
      String strcAcctSchemaId, String strcelementvaluefromdes, String strcelementvaluetodes, String strAccountMatch)
      ...
      if (data != null && data.length > 1) {
        dataTotal = ReportGeneralLedgerData.select(this, rowNum, strGroupByText, strGroupBy,
            ...
            strcAcctSchemaId, strYearInitialDate, DateTimeData.nDaysAfter(this, data[0].dateacct,
                "1"), strAccountMatch,strOrgFamily, strcBpartnerId, strmProductId, strcProjectId, strAmtFrom,
  ...
  private void printPageDataPDF(HttpServletRequest request, HttpServletResponse response,
      ...
      String strHide, String strcAcctSchemaId,String strAccountMatch) throws IOException, ServletException {
    if (log4j.isDebugEnabled())

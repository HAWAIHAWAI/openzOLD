...
/**
 * Entity class for entity ADTaskTrl (stored in table AD_Task_Trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class TaskTrl extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "AD_Task_Trl";
    public static final String ENTITY_NAME = "ADTaskTrl";

...
/**
 * Entity class for entity ADChangeLog (stored in table AD_ChangeLog).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ADChangeLog extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "AD_ChangeLog";
    public static final String ENTITY_NAME = "ADChangeLog";

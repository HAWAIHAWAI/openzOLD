...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strC_Commission_ID = vars.getRequiredInStringParameter("inpcCommissionId");
      String message = deleteRelation(vars, strC_Commission_ID);
      if (!message.equals("")) {
...
/*
  String deleteRelation(VariablesSecureApp vars, String strC_Commission_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strC_Commission_ID.startsWith("(")) strC_Commission_ID = strC_Commission_ID.substring(1, strC_Commission_ID.length()-1);
      if (!strC_Commission_ID.equals("")) {
        strC_Commission_ID = Replace.replace(strC_Commission_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strC_Commission_ID, ",", false);
...
*/
   ...
   private HeaderData[] getRelationData(HeaderData[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|C_Commission_ID", data[0].getField("cCommissionId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strC_Commission_ID, TableSQLData tableSQL)
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Header", false, "document.frmMain.inpcCommissionId", "grid", "..", "".equals("Y"), "Commission", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "Commission", "W", strReplaceWith, tabs.breadcrumb());
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Commission_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "CreateFrom", "", "207", "355", "N", dataField), Utility.getDefault(this, vars, "Processing", "", "207", "355", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "207", "355", "", dataField), HeaderData.selectDef5672_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "207", "355", "", dataField)), Utility.getDefault(this, vars, "Name", "", "207", "355", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "207", "355", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "207", "355", "", dataField), HeaderData.selectDef5677_1(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "207", "355", "", dataField)), Utility.getDefault(this, vars, "DocBasisType", "I", "207", "355", "", dataField), Utility.getDefault(this, vars, "FrequencyType", "M", "207", "355", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "207", "355", "", dataField), Utility.getDefault(this, vars, "Description", "", "207", "355", "", dataField), Utility.getDefault(this, vars, "ListDetails", "", "207", "355", "N", dataField), "Y", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "207", "355", "", dataField), Utility.getDefault(this, vars, "DateLastRun", "", "207", "355", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "207", "355", "", dataField), HeaderData.selectDef802829_2(this, Utility.getDefault(this, vars, "M_Product_ID", "", "207", "355", "", dataField)), "", Utility.getDefault(this, vars, "UpdatedBy", "", "207", "355", "", dataField), HeaderData.selectDef5674_3(this, Utility.getDefault(this, vars, "UpdatedBy", "", "207", "355", "", dataField)));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcCommissionId", "", "..", "".equals("Y"), "Commission", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Commission_ID));
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonCreateFrom165(HttpServletResponse response, VariablesSecureApp vars, String strC_Commission_ID, String strcreatefrom, String strProcessing)
    throws IOException, ServletException {
    ...
    Scripthelper script = new Scripthelper();
      ...
      try {
        String name= LocalizationUtils.getProcessTitle(this, "165",vars.getLanguage());
        String info = LocalizationUtils.getProcessInfo(this, "165" ,vars.getLanguage());
        if (! info.isEmpty())
        ...
        strFG=strFG + fh.prepareProcessParameters(this, vars, script,"165" );
        String isDocAction=UtilsData.isProcessDocAction(this, "165");
        if (Integer.parseInt(isDocAction)>0) {
            ...
            strFG=strFG + ConfigureSelectBox.doConfigure(this,vars,script,"docaction", 0,3,true,false,"", strcreatefrom, dataDocAction, "ID","",true,"");
        ...
        String isJasper=UtilsData.isProcessJasper(this, "165");
        if (isJasper.equals("N"))
          strActionButtons= strActionButtons + ConfigureButton.doConfigure(this,vars,script,"buttonok",1,1,false, "ok",  "submitThisPage('SAVE_BUTTONCreateFrom" + "165" + "');", "","") + "";
        else
        ...
        script.addHiddenfield("inpadProcessId", "165");
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cCommissionId, vars, this);
        } catch(Exception ex) {

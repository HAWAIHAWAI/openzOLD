...
String strParamA_Asset_ID = vars.getSessionValue(tabId + "|paramA_Asset_ID");
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Header", false, "document.frmMain.inpmRequisitionId", "grid", "../RptM_Requisition.pdf", "N".equals("Y"), "Requisition", strReplaceWith, false);
...
String strParamA_Asset_ID = vars.getSessionValue(tabId + "|paramA_Asset_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "Processed", "N", "800092", "800249", "N", dataField), "Y", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "800249", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "800249", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "800249", "N", dataField))), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800092", "800249", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "800092", "800249", "", dataField), HeaderData.selectDef803540(this, Utility.getContext(this, vars, "ad_org_id", "800092")), Utility.getDefault(this, vars, "DocStatus", "DR", "800092", "800249", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800092", "800249", "", dataField), HeaderData.selectDef803539_0(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800092", "800249", "", dataField)), Utility.getDefault(this, vars, "Totallines", "0.00", "800092", "800249", "", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "800092", "800249", "", dataField), "", Utility.getDefault(this, vars, "DocumentNo", "", "800092", "800249", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "800092", "800249", "", dataField), Utility.getDefault(this, vars, "Createpo", "N", "800092", "800249", "N", dataField), Utility.getDefault(this, vars, "Createdby", "", "800092", "800249", "", dataField), HeaderData.selectDef803534_1(this, Utility.getDefault(this, vars, "Createdby", "", "800092", "800249", "", dataField)), Utility.getDefault(this, vars, "C_Project_ID", "", "800092", "800249", "", dataField), HeaderData.selectDef57FB487DAC4C4E209F648AB9C583191D_2(this, Utility.getDefault(this, vars, "C_Project_ID", "", "800092", "800249", "", dataField)), Utility.getDefault(this, vars, "Description", "", "800092", "800249", "", dataField), Utility.getDefault(this, vars, "Allowdirectpo", "N", "800092", "800249", "N", dataField), Utility.getDefault(this, vars, "Processing", "N", "800092", "800249", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800092", "800249", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "@#AD_User_ID@", "800092", "800249", "", dataField), Utility.getDefault(this, vars, "C_Projectphase_ID", "", "800092", "800249", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "800092", "800249", "", dataField), HeaderData.selectDef803536_3(this, Utility.getDefault(this, vars, "Updatedby", "", "800092", "800249", "", dataField)));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmRequisitionId", "", "../RptM_Requisition.pdf", "N".equals("Y"), "Requisition", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Requisition_ID));

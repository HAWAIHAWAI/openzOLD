...
public class SerialAndBatchNumbers  extends HttpSecureAppServlet {
   ...
   try {
      ...
      if (serialServletState.equals("PBATCH"))
        strPdcInfobar=fh.prepareInfobar(this, vars, script, Utility.messageBD(this, "pdc_ScanNewBatchonPMat",vars.getLanguage()), "font-size: 32pt; color: #000000;");
      if (serialServletState.equals("PSERIAL"))
        if (! strProductionid.isEmpty())
          strPdcInfobar=fh.prepareInfobar(this, vars, script, Utility.messageBD(this, "pdc_ScanNewSerialonPMat",vars.getLanguage()), "font-size: 32pt; color: #000000;");
        if (! strInOutid.isEmpty())
          strPdcInfobar=fh.prepareInfobar(this, vars, script, Utility.messageBD(this, "pdc_ScanShownProductSerial",vars.getLanguage()), "font-size: 32pt; color: #000000;");
      if (serialServletState.equals("DNORMAL"))
        strPdcInfobar=fh.prepareInfobar(this, vars, script, Utility.messageBD(this, "pdc_ScanSerialorBatch",vars.getLanguage()), "font-size: 32pt; color: #000000;");
      if (serialServletState.equals("ORDEREDSERIAL"))
        strPdcInfobar=fh.prepareInfobar(this, vars, script, Utility.messageBD(this, "pdc_ScanShownProductSerial",vars.getLanguage()), "font-size: 32pt; color: #000000;");
      if (serialServletState.equals("ORDEREDBATCH"))
        strPdcInfobar=fh.prepareInfobar(this, vars, script, Utility.messageBD(this, "pdc_ScanShownProductBatch",vars.getLanguage()), "font-size: 32pt; color: #000000;");
      ...
      strSkeleton = ConfigureFrameWindow.doConfigure(this,vars,"inpbarcode",null,"Serial Number",strToolbar,"NONE",tabs);

 ...
 */
public class TableAccess extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISEXCLUDE = "isExclude";

    public TableAccess() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_ISREADONLY, false);
        setDefaultValue(PROPERTY_ISEXCLUDE, true);
    }
    ...
    public Boolean isExclude() {
        return (Boolean) get(PROPERTY_ISEXCLUDE);
    }

    public void setExclude(Boolean isExclude) {
        set(PROPERTY_ISEXCLUDE, isExclude);
    }
}

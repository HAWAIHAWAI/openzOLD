 ...
 */
public class ProductCategory extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISSELECTABLEINPRODUCTION =
        "isselectableinproduction";
    ...
    public ProductCategory() {
        ...
        setDefaultValue(PROPERTY_ISSELECTABLEINPRODUCTION, true);
    ...
    public Boolean isSelectableinproduction() {
        return (Boolean) get(PROPERTY_ISSELECTABLEINPRODUCTION);
    }

    public void setSelectableinproduction(Boolean isselectableinproduction) {
        set(PROPERTY_ISSELECTABLEINPRODUCTION, isselectableinproduction);
    }
    ...
    public void setProductCategoryAccountsList(
        List<CategoryAccounts> productCategoryAccountsList) {

...
public class PrintProductionOrders extends PrintController {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = new DocumentType("PRODUCTIONORDERS","ZSSM_PRODUCTIONORDER_V","productionorders/","Productionorder",true,null,"c_getDefaultDocInfo");
    // The prefix PRINTORDERS is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTPRODUCTIONORDERS";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpzssmProductionorderVId_R");
    if (strDocumentId.equals(""))
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpzssmProductionorderVId");

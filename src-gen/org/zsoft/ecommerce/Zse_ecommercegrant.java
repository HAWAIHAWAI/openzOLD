...
/**
 * Entity class for entity zse_ecommercegrant (stored in table zse_ecommercegrant).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Zse_ecommercegrant extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zse_ecommercegrant";
    public static final String ENTITY_NAME = "zse_ecommercegrant";

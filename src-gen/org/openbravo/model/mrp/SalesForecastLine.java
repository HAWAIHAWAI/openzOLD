 ...
 */
public class SalesForecastLine extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_MRPSALESFORECAST = "mRPSalesforecast";
    ...
    public SalesForecast getMRPSalesforecast() {
        return (SalesForecast) get(PROPERTY_MRPSALESFORECAST);
    }

    public void setMRPSalesforecast(SalesForecast mRPSalesforecast) {
        set(PROPERTY_MRPSALESFORECAST, mRPSalesforecast);
    }

...
/**
 * Entity class for entity zspm_workstepdropdown_v (stored in table zspm_workstepdropdown_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zspm_workstepdropdown_v extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zspm_workstepdropdown_v";
    public static final String ENTITY_NAME = "zspm_workstepdropdown_v";
    ...
    public zspm_workstepdropdown_v() {

    ...
    try {
      ...
      if (!strZspr_Printinfo_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (PrintoutConfigurationData.deleteTransactional(conn, this, strKey, strPAD_Org_ID)==0) {

...
/**
 * Entity class for entity OrganizationAssignment (stored in table C_OrgAssignment).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class OrganizationAssignment extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "C_OrgAssignment";
    public static final String ENTITY_NAME = "OrganizationAssignment";

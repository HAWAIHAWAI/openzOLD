...
/**
 * Entity class for entity ADTreeNodeMM (stored in table AD_TreeNodeMM).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class TreeNodeMM extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "AD_TreeNodeMM";
    public static final String ENTITY_NAME = "ADTreeNodeMM";

 ...
 */
public class ModuleDependencyInst extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_STARTVERSION = "startversion";
    public static final String PROPERTY_ENDVERSION = "endversion";
    ...
    public String getStartversion() {
        return (String) get(PROPERTY_STARTVERSION);
    }

    public void setStartversion(String startversion) {
        set(PROPERTY_STARTVERSION, startversion);
    }

    public String getEndversion() {
        return (String) get(PROPERTY_ENDVERSION);
    }

    public void setEndversion(String endversion) {
        set(PROPERTY_ENDVERSION, endversion);
    }

...
*/
  private Serialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Inventoryline_ID) throws IOException,ServletException {
   ...
   private Serialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data[] getRelationData(Serialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].mInventorylineId = FormatUtilities.truncate(data[i].mInventorylineId, 32);        data[i].snrInventorylineId = FormatUtilities.truncate(data[i].snrInventorylineId, 32);        data[i].serialnumber = FormatUtilities.truncate(data[i].serialnumber, 40);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].lotnumber = FormatUtilities.truncate(data[i].lotnumber, 40);        data[i].rfidnumber = FormatUtilities.truncate(data[i].rfidnumber, 40);        data[i].description = FormatUtilities.truncate(data[i].description, 50);}
    }
    return data;
  }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strSNR_Inventoryline_ID, String strPM_Inventoryline_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Serialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data.set(strPM_Inventoryline_ID, Utility.getDefault(this, vars, "Serialnumber", "", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField), Utility.getDefault(this, vars, "Quantity", "1", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField), Utility.getDefault(this, vars, "Guaranteedate", "", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField), Serialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data.selectDefCDAFF29584E24F46A900AD54035F227B_0(this, Utility.getDefault(this, vars, "Updatedby", "", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField)), "Y", Utility.getDefault(this, vars, "Isunavailable", "N", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "N", dataField), Utility.getDefault(this, vars, "Rfidnumber", "", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField), Utility.getDefault(this, vars, "Guaranteedays", "", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField), Serialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data.selectDefDF80E990D232466DA7688A90F297EFB5_1(this, Utility.getDefault(this, vars, "Createdby", "", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField)), Utility.getDefault(this, vars, "Description", "", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField), "", Utility.getDefault(this, vars, "Lotnumber", "", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "168", "26BC2E065AFE41F9A7D99AB3FC8FC985", "", dataField));

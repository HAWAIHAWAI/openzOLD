...
*/
  private Value800230Data getEditVariables(Connection con, VariablesSecureApp vars, String strPMA_Indirect_Cost_ID) throws IOException,ServletException {
   ...
   private Value800230Data[] getRelationData(Value800230Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].maIndirectCostValueId = FormatUtilities.truncate(data[i].maIndirectCostValueId, 10);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].maIndirectCostId = FormatUtilities.truncate(data[i].maIndirectCostId, 44);        data[i].costUom = FormatUtilities.truncate(data[i].costUom, 21);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPMA_Indirect_Cost_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|MA_Indirect_Cost_ID", data[0].maIndirectCostId);
...
String strParamempCost_f = vars.getSessionValue(tabId + "|paramempCost_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Value800230Data.set(strPMA_Indirect_Cost_ID, Utility.getDefault(this, vars, "Cost_Uom", "", "800085", "800230", "", dataField), Utility.getDefault(this, vars, "DateFrom", "", "800085", "800230", "", dataField), Utility.getDefault(this, vars, "empCost", "", "800085", "800230", "", dataField), Utility.getDefault(this, vars, "Vendorcost", "", "800085", "800230", "", dataField), Utility.getDefault(this, vars, "Materialcost", "", "800085", "800230", "", dataField), Utility.getDefault(this, vars, "Machinecost", "", "800085", "800230", "", dataField), "", Utility.getDefault(this, vars, "DateTo", "", "800085", "800230", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "800085", "800230", "", dataField), Value800230Data.selectDef803192_0(this, Utility.getDefault(this, vars, "Createdby", "", "800085", "800230", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800085", "800230", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "800085", "800230", "", dataField), Value800230Data.selectDef803194_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800085", "800230", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800085", "800230", "", dataField), Utility.getDefault(this, vars, "Calculated", "N", "800085", "800230", "N", dataField), "Y", Utility.getDefault(this, vars, "Total", "", "800085", "800230", "", dataField));

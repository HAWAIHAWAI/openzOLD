   ...
   private Header800258Data[] getRelationData(Header800258Data[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|MRP_Run_Purchase_ID", data[0].getField("mrpRunPurchaseId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strMRP_Run_Purchase_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Header800258Data.set(Utility.getDefault(this, vars, "Simulate", "N", "800097", "800258", "N", dataField), Utility.getDefault(this, vars, "Updatedby", "", "800097", "800258", "", dataField), Header800258Data.selectDef803651_0(this, Utility.getDefault(this, vars, "Updatedby", "", "800097", "800258", "", dataField)), Utility.getDefault(this, vars, "Vendor_ID", "", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "800097", "800258", "", dataField), Header800258Data.selectDef803658_1(this, Utility.getDefault(this, vars, "M_Product_ID", "", "800097", "800258", "", dataField)), Utility.getDefault(this, vars, "Description", "", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "Launchpo", "N", "800097", "800258", "N", dataField), Utility.getDefault(this, vars, "DateDoc", "@#Date@", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "800097", "800258", "", dataField), Header800258Data.selectDef803649_2(this, Utility.getDefault(this, vars, "Createdby", "", "800097", "800258", "", dataField)), Utility.getDefault(this, vars, "Name", "", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "M_Product_Category_ID", "''", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "Timehorizon", "", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "MRP_Planner_ID", "", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "C_BP_Group_ID", "null", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "null", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800097", "800258", "", dataField), Header800258Data.selectDef803660_3(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800097", "800258", "", dataField)), "", "Y", Utility.getDefault(this, vars, "Securitymargin", "0", "800097", "800258", "", dataField));

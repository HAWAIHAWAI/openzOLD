...
/**
 * Entity class for entity zse_shop_defaultpaymethod (stored in table zse_shop_defaultpaymethod).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Zse_shop_defaultpaymethod extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zse_shop_defaultpaymethod";
    public static final String ENTITY_NAME = "zse_shop_defaultpaymethod";
    ...
    public Zse_shop_defaultpaymethod() {

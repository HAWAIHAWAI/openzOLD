...
public class Operation800112 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Operation800112.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Operation800112.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Operation800112.view", "EDIT");

        printPageEdit(response, request, vars, false, strMA_Wrphase_ID, strPMA_Workrequirement_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Operation800112.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamSeqNo_f", tabId + "|paramSeqNo_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strMA_Wrphase_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Operation800112.view", strView);
        }
      }
...
vars.getGlobalVariable("inpmaWorkrequirementId", windowId + "|MA_Workrequirement_ID");
      ...
      vars.setSessionValue(tabId + "|Operation800112.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPMA_Workrequirement_ID = vars.getGlobalVariable("inpmaWorkrequirementId", windowId + "|MA_Workrequirement_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Operation800112.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Operation800112.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|MA_Wrphase_ID");
      vars.setSessionValue(windowId + "|MA_Workrequirement_ID", strPMA_Workrequirement_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strMA_Wrphase_ID = vars.getRequiredInStringParameter("inpmaWrphaseId");
      String message = deleteRelation(vars, strMA_Wrphase_ID, strPMA_Workrequirement_ID);
      if (!message.equals("")) {
      ...
      String strMA_Wrphase_ID = vars.getRequiredStringParameter("inpmaWrphaseId");
      //Operation800112Data data = getEditVariables(vars, strPMA_Workrequirement_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Operation800112Data.delete(this, strMA_Wrphase_ID, strPMA_Workrequirement_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
/*
  String deleteRelation(VariablesSecureApp vars, String strMA_Wrphase_ID, String strPMA_Workrequirement_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strMA_Wrphase_ID.startsWith("(")) strMA_Wrphase_ID = strMA_Wrphase_ID.substring(1, strMA_Wrphase_ID.length()-1);
      if (!strMA_Wrphase_ID.equals("")) {
        strMA_Wrphase_ID = Replace.replace(strMA_Wrphase_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strMA_Wrphase_ID, ",", false);
        while (st.hasMoreTokens()) {
          String strKey = st.nextToken();
          if (Operation800112Data.deleteTransactional(conn, this, strKey, strPMA_Workrequirement_ID)==0) {
...
*/
  private Operation800112Data getEditVariables(Connection con, VariablesSecureApp vars, String strPMA_Workrequirement_ID) throws IOException,ServletException {
    Operation800112Data data = new Operation800112Data();
    ServletException ex = null;
    try {
    data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adClientIdr = vars.getStringParameter("inpadClientId_R");     data.maWrphaseId = vars.getRequestGlobalVariable("inpmaWrphaseId", windowId + "|MA_Wrphase_ID");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.maWorkrequirementId = vars.getStringParameter("inpmaWorkrequirementId");     data.maWorkrequirementIdr = vars.getStringParameter("inpmaWorkrequirementId_R");     data.description = vars.getStringParameter("inpdescription");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.maSequenceId = vars.getStringParameter("inpmaSequenceId");     data.maSequenceIdr = vars.getStringParameter("inpmaSequenceId_R");     data.maProcessId = vars.getStringParameter("inpmaProcessId");     data.maProcessIdr = vars.getStringParameter("inpmaProcessId_R");    try {   data.seqno = vars.getNumericParameter("inpseqno");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.quantity = vars.getNumericParameter("inpquantity");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.donequantity = vars.getNumericParameter("inpdonequantity");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.costcenteruse = vars.getNumericParameter("inpcostcenteruse");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.preptime = vars.getNumericParameter("inppreptime");  } catch (ServletException paramEx) { ex = paramEx; }     data.noqty = vars.getStringParameter("inpnoqty", "N");     data.groupuse = vars.getStringParameter("inpgroupuse", "N");     data.closed = vars.getStringParameter("inpclosed");     data.outsourced = vars.getStringParameter("inpoutsourced", "N");     data.name = vars.getStringParameter("inpname"); 
   ...
   private Operation800112Data[] getRelationData(Operation800112Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].maWrphaseId = FormatUtilities.truncate(data[i].maWrphaseId, 10);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].maWorkrequirementId = FormatUtilities.truncate(data[i].maWorkrequirementId, 44);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].maSequenceId = FormatUtilities.truncate(data[i].maSequenceId, 44);        data[i].maProcessId = FormatUtilities.truncate(data[i].maProcessId, 44);        data[i].name = FormatUtilities.truncate(data[i].name, 50);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPMA_Workrequirement_ID) throws IOException,ServletException {
      Header800111Data[] data = Header800111Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPMA_Workrequirement_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|MA_Workrequirement_ID", data[0].maWorkrequirementId);    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|MA_Processplan_ID", data[0].maProcessplanId);    vars.setSessionValue(windowId + "|Launchdate", data[0].launchdate);
  ...
  private String getParentID(VariablesSecureApp vars, String strMA_Wrphase_ID) throws ServletException {
    String strPMA_Workrequirement_ID = Operation800112Data.selectParentID(this, strMA_Wrphase_ID);
    if (strPMA_Workrequirement_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPMA_Workrequirement_ID) throws IOException,ServletException {
      Operation800112Data[] data = Operation800112Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPMA_Workrequirement_ID, vars.getStringParameter("inpmaWrphaseId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamSeqNo_f = vars.getSessionValue(tabId + "|paramSeqNo_f");
    ...
    if (!(strParamMA_Workrequirement_ID.equals("") && strParamSeqNo.equals("") && strParamMA_Process_ID.equals("") && strParamSeqNo_f.equals(""))) hasSearchCondition=true;
    String strOffset = "0";
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/openbravo/zsoft/serprod/WorkRequirement/Operation800112_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Operation800112", false, "document.frmMain.inpmaWrphaseId", "grid", "..", "".equals("Y"), "WorkRequirement", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Operation800112_Relation.html", "WorkRequirement", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Operation800112_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", Operation800112Data.selectParent(this, strPMA_Workrequirement_ID));
    else xmlDocument.setParameter("parent", Operation800112Data.selectParentTrl(this, strPMA_Workrequirement_ID));
...
String strParamSeqNo_f = vars.getSessionValue(tabId + "|paramSeqNo_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Operation800112Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPMA_Workrequirement_ID, strMA_Wrphase_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new Operation800112Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Operation800112Data.set(strPMA_Workrequirement_ID, Utility.getDefault(this, vars, "Createdby", "", "800052", "800112", "", dataField), Operation800112Data.selectDef801569_0(this, Utility.getDefault(this, vars, "Createdby", "", "800052", "800112", "", dataField)), "", Utility.getDefault(this, vars, "Preptime", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Groupuse", "N", "800052", "800112", "N", dataField), Utility.getDefault(this, vars, "Name", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Closed", "N", "800052", "800112", "N", dataField), "Y", Utility.getDefault(this, vars, "Outsourced", "", "800052", "800112", "N", dataField), Operation800112Data.selectDef801759(this, strPMA_Workrequirement_ID), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "CostCenterUse", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "MA_Process_ID", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "MA_Sequence_ID", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Noqty", "N", "800052", "800112", "N", dataField), Utility.getDefault(this, vars, "Quantity", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Description", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Donequantity", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "800052", "800112", "", dataField), Operation800112Data.selectDef801571_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800052", "800112", "", dataField)));
        
      }
    } else {
      data = new Operation800112Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(Operation800112Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
      
    String currentPOrg=Header800111Data.selectOrg(this, strPMA_Workrequirement_ID);
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Operation800112", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmaWrphaseId", "", "..", "".equals("Y"), "WorkRequirement", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strMA_Wrphase_ID));
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonClosed800118(HttpServletResponse response, VariablesSecureApp vars, String strMA_Wrphase_ID, String strclosed, String strProcessing)
    throws IOException, ServletException {
    ...
    Scripthelper script = new Scripthelper();
      ...
      try {
        String name= LocalizationUtils.getProcessTitle(this, "800118",vars.getLanguage());
        String info = LocalizationUtils.getProcessInfo(this, "800118" ,vars.getLanguage());
        if (! info.isEmpty())
        ...
        strFG=strFG + fh.prepareProcessParameters(this, vars, script,"800118" );
        String isDocAction=UtilsData.isProcessDocAction(this, "800118");
        if (Integer.parseInt(isDocAction)>0) {
            String strdocstatus=UtilsData.getDocStatus(this, "800099",strMA_Wrphase_ID);
            FieldProvider[] dataDocAction = DocActionWorkflowOptions.docAction(this, vars, "", "", strdocstatus,"N",
            "800099", strMA_Wrphase_ID);
            
            strFG=strFG + "<table cellspacing=\"0\" cellpadding=\"0\" class=\"Form_Table\"> <colgroup span=\"4\"></colgroup><tr><td colspan=\"4\"></td></tr><tr>";
            
            strFG=strFG + ConfigureSelectBox.doConfigure(this,vars,script,"docaction", 0,3,true,false,"", strclosed, dataDocAction, "ID","",true,"");
        ...
        String isJasper=UtilsData.isProcessJasper(this, "800118");
        if (isJasper.equals("N"))
          strActionButtons= strActionButtons + ConfigureButton.doConfigure(this,vars,script,"buttonok",1,1,false, "ok",  "submitThisPage('SAVE_BUTTONClosed" + "800118" + "');", "","") + "";
        else
        ...
        strSkeleton=Replace.replace(strSkeleton,"ActionButton_Responser.html","Operation800112_Edition.html");
        String strOutput=Replace.replace(strSkeleton, "@CONTENT@",info +  strFG +strActionButtons); 
        script.addSubmitPagePageSripts();
        
        script.addHiddenfield("inpadProcessId", "800118");
        script.addHiddenfield("inpKey",strMA_Wrphase_ID);
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Operation800112Data.getCurrentDBTimestamp(this, data.maWrphaseId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.maWrphaseId, vars, this);
        } catch(Exception ex) {
  ...
  public String getServletInfo() {
    return "Servlet Operation800112. This Servlet was made by Wad constructor";

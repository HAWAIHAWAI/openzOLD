...
static Logger log4j = Logger.getLogger(TableSQLQueryData.class);
  ...
  public static TableSQLQueryData[] selectRelationStructure(ConnectionProvider connectionProvider, String adLanguage, String adRoleID, String adTabId)    throws ServletException {
    return selectRelationStructure(connectionProvider, adLanguage, adRoleID, adTabId, 0, 0);
  }

  public static TableSQLQueryData[] selectRelationStructure(ConnectionProvider connectionProvider, String adLanguage, String adRoleID, String adTabId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTableSQLQueryData.gridseqno = UtilSql.getValue(result, "gridseqno");
 ...
 */
  ...
  public static String IsRoleAccessOnlyOwnData(ConnectionProvider connectionProvider, String roleID, String windowID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "ad_roleaccessonlyowndata");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);

 ...
 */
public class WorkCenter extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_MANUFACTURINGMACHINESTATIONLIST =
        "manufacturingMachineStationList";
    public static final String PROPERTY_MANUFACTURINGACTIVITYLIST =
        "manufacturingActivityList";

    public WorkCenter() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_MANUFACTURINGMACHINESTATIONLIST,
            new ArrayList<Object>());
        setDefaultValue(PROPERTY_MANUFACTURINGACTIVITYLIST,
            new ArrayList<Object>());
    }
    ...
    public void setManufacturingMachineStationList(
        List<WorkCenterMachine> manufacturingMachineStationList) {
        set(PROPERTY_MANUFACTURINGMACHINESTATIONLIST,
            manufacturingMachineStationList);
    }
    ...
    public void setManufacturingActivityList(
        List<Activity> manufacturingActivityList) {

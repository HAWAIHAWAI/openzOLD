...
/**
 * Entity class for entity juwimm_team_trl (stored in table juwimm_team_trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class juwimm_team_trl extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "juwimm_team_trl";
    public static final String ENTITY_NAME = "juwimm_team_trl";

 ...
 */
public class GreetingTrl extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_GREETING11 = "greeting11";
    ...
    public String getGreeting11() {
        return (String) get(PROPERTY_GREETING11);
    }

    public void setGreeting11(String greeting11) {
        set(PROPERTY_GREETING11, greeting11);
    }

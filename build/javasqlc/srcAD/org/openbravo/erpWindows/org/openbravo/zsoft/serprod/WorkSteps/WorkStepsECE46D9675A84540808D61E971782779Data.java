...
Create a registry
 */
  public static WorkStepsECE46D9675A84540808D61E971782779Data[] set(String help, String assembly, String receivingLocator, String receivingLocatorr, String zssmWorkstepPrpVId, String value, String forcematerialscan, String isautotriggered, String createdby, String createdbyr, String seqno, String indirectcostplan, String cProjecttaskId, String adClientId, String description, String updatedby, String updatedbyr, String name, String isautogeneratedplan, String zssmWorkstepVId, String mProductId, String mProductIdr, String timeperpiece, String plannedcost, String materialcostplan, String machinecostplan, String isactive, String issuingLocator, String issuingLocatorr, String adOrgId, String setuptime, String servcostplan, String startonlywithcompletematerial, String qty, String percentrejects)    throws ServletException {
...
Select for auxiliar field
 */
  public static String selectDef0BA9DC7FB4D9420EADBF95E46E79A679_2(ConnectionProvider connectionProvider, String UpdatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef180AE6A146914989BD5EC1B93EF10A9F_3(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefCE9C6CB4D92340A781A479792D144209_4(ConnectionProvider connectionProvider, String Issuing_LocatorR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Zssm_Workstep_Prp_V_ID = (?) , AD_Org_ID = (?) , C_Projecttask_ID = (?) , IsActive = (?) , AD_Client_ID = (?) , Value = (?) , Name = (?) , SeqNo = TO_NUMBER(?) , Description = (?) , Assembly = (?) , M_Product_ID = (?) , ForceMaterialScan = (?) , StartOnlyWithCompleteMaterial = (?) , Isautotriggered = (?) , isautogeneratedplan = (?) , Receiving_Locator = (?) , Issuing_Locator = (?) , Help = (?) , Timeperpiece = TO_NUMBER(?) , Setuptime = TO_NUMBER(?) , Qty = TO_NUMBER(?) , ServCostPlan = TO_NUMBER(?) , MachineCostPlan = TO_NUMBER(?) , MaterialCostPlan = TO_NUMBER(?) , PlannedCost = TO_NUMBER(?) , IndirectCostPlan = TO_NUMBER(?) , Zssm_Workstep_V_ID = (?) , PercentRejects = TO_NUMBER(?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zssm_Workstep_Prp_V_ID, AD_Org_ID, C_Projecttask_ID, IsActive, AD_Client_ID, Value, Name, SeqNo, Description, Assembly, M_Product_ID, ForceMaterialScan, StartOnlyWithCompleteMaterial, Isautotriggered, isautogeneratedplan, Receiving_Locator, Issuing_Locator, Help, Timeperpiece, Setuptime, Qty, ServCostPlan, MachineCostPlan, MaterialCostPlan, PlannedCost, IndirectCostPlan, Zssm_Workstep_V_ID, PercentRejects, created, createdby, updated, updatedBy)" +

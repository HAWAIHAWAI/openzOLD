...
*/
  private BusinessPartnerData getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Offer_ID) throws IOException,ServletException {
    ...
    try {
    data.mOfferBpartnerId = vars.getRequestGlobalVariable("inpmOfferBpartnerId", windowId + "|M_Offer_Bpartner_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adClientIdr = vars.getStringParameter("inpadClientId_R");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.mOfferId = vars.getStringParameter("inpmOfferId");     data.mOfferIdr = vars.getStringParameter("inpmOfferId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R"); 
   ...
   private BusinessPartnerData[] getRelationData(BusinessPartnerData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].mOfferBpartnerId = FormatUtilities.truncate(data[i].mOfferBpartnerId, 10);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].mOfferId = FormatUtilities.truncate(data[i].mOfferId, 44);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strM_Offer_Bpartner_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|M_Offer_Bpartner_ID", data[0].getField("mOfferBpartnerId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
...
String strParamC_BPartner_ID = vars.getSessionValue(tabId + "|paramC_BPartner_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = BusinessPartnerData.set(strPM_Offer_ID, Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800028", "800080", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800028", "800080", "", dataField), BusinessPartnerData.selectDef801132_0(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800028", "800080", "", dataField)), Utility.getDefault(this, vars, "Createdby", "", "800028", "800080", "", dataField), BusinessPartnerData.selectDef801128_1(this, Utility.getDefault(this, vars, "Createdby", "", "800028", "800080", "", dataField)), "Y", Utility.getDefault(this, vars, "Updatedby", "", "800028", "800080", "", dataField), BusinessPartnerData.selectDef801130_2(this, Utility.getDefault(this, vars, "Updatedby", "", "800028", "800080", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800028", "800080", "", dataField), "");

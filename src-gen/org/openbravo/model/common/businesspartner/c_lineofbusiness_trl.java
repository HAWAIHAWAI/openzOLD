...
/**
 * Entity class for entity c_lineofbusiness_trl (stored in table c_lineofbusiness_trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class c_lineofbusiness_trl extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "c_lineofbusiness_trl";
    public static final String ENTITY_NAME = "c_lineofbusiness_trl";

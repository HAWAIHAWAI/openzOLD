...
static Logger log4j = Logger.getLogger(ActionButtonRelationData.class);
  ...
  public String processbuttonhelper;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("realname"))
      ...
      return processCode;
    else if (fieldName.equalsIgnoreCase("processbuttonhelper"))
      return processbuttonhelper;
  ...
  public static ActionButtonRelationData[] select(ConnectionProvider connectionProvider, String tabId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectActionButtonRelationData.processbuttonhelper = UtilSql.getValue(result, "processbuttonhelper");
 ...
 */
  ...
  public static String isManualResponse(ConnectionProvider connectionProvider, String adProcessId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "manualresponse");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);

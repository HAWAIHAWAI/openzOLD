...
import org.openbravo.zsoft.projects.Zspm_ctaskhrplan;
 ...
 */
public class SalaryCategory extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISCOSTAPPLIED = "iscostapplied";
    public static final String PROPERTY_ZSPMCTASKHRPLANLIST =
        "zspmCtaskhrplanList";
    public static final String PROPERTY_SALARYCATEGORYCOSTLIST =
        "salaryCategoryCostList";
    public static final String PROPERTY_ZSPMPTASKHRPLANLIST =
        "zspmPtaskhrplanList";

    public SalaryCategory() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_ISCOSTAPPLIED, true);
        setDefaultValue(PROPERTY_ZSPMCTASKHRPLANLIST, new ArrayList<Object>());
    ...
    public Boolean isCostapplied() {
        return (Boolean) get(PROPERTY_ISCOSTAPPLIED);
    }

    public void setCostapplied(Boolean iscostapplied) {
        set(PROPERTY_ISCOSTAPPLIED, iscostapplied);
    }

    @SuppressWarnings("unchecked")
    public List<Zspm_ctaskhrplan> getZspmCtaskhrplanList() {
        return (List<Zspm_ctaskhrplan>) get(PROPERTY_ZSPMCTASKHRPLANLIST);
    }

    public void setZspmCtaskhrplanList(
        List<Zspm_ctaskhrplan> zspmCtaskhrplanList) {
        set(PROPERTY_ZSPMCTASKHRPLANLIST, zspmCtaskhrplanList);
    }
    ...
    public void setSalaryCategoryCostList(
        List<SalaryCategoryCost> salaryCategoryCostList) {

...
public class RptC_Bpartner extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    RptCBpartnerData[] dataTemplate = null;
        //RptCBpartnerData.selectTemplate(this, vars.getLanguage(),strcBpartnerId);
    RptCBpartnerData[] dataDiscount = null;
    //RptCBpartnerData.selectDiscount(this, strcBpartnerId);
  ...
  private void printPageAjaxResponse(HttpServletResponse response, VariablesSecureApp vars,
    ...
    RptCBpartnerData[] data = null;
    //RptCBpartnerData.selectTemplateDetail(this, strcBpartnerId,        strmProductTemplate);

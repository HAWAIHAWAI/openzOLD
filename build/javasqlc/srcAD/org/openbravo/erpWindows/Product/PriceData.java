...
WAD Generated class
 */
class PriceData implements FieldProvider {
static Logger log4j = Logger.getLogger(PriceData.class);
...
Select for edit
 */
  public static PriceData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static PriceData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        PriceData objectPriceData = new PriceData();
        objectPriceData.created = UtilSql.getValue(result, "created");
        objectPriceData.createdbyr = UtilSql.getValue(result, "createdbyr");
        objectPriceData.updated = UtilSql.getValue(result, "updated");
        objectPriceData.updatedTimeStamp = UtilSql.getValue(result, "updated_time_stamp");
        objectPriceData.updatedby = UtilSql.getValue(result, "updatedby");
        objectPriceData.updatedbyr = UtilSql.getValue(result, "updatedbyr");
        objectPriceData.mProductpriceId = UtilSql.getValue(result, "m_productprice_id");
        objectPriceData.adClientId = UtilSql.getValue(result, "ad_client_id");
        objectPriceData.adClientIdr = UtilSql.getValue(result, "ad_client_idr");
        objectPriceData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        objectPriceData.adOrgIdr = UtilSql.getValue(result, "ad_org_idr");
        objectPriceData.mProductId = UtilSql.getValue(result, "m_product_id");
        objectPriceData.mProductIdr = UtilSql.getValue(result, "m_product_idr");
        objectPriceData.mPricelistVersionId = UtilSql.getValue(result, "m_pricelist_version_id");
        objectPriceData.mPricelistVersionIdr = UtilSql.getValue(result, "m_pricelist_version_idr");
        objectPriceData.isactive = UtilSql.getValue(result, "isactive");
        objectPriceData.pricelist = UtilSql.getValue(result, "pricelist");
        objectPriceData.pricestd = UtilSql.getValue(result, "pricestd");
        objectPriceData.pricelimit = UtilSql.getValue(result, "pricelimit");
        objectPriceData.language = UtilSql.getValue(result, "language");
        objectPriceData.adUserClient = "";
        objectPriceData.adOrgClient = "";
        objectPriceData.createdby = "";
        objectPriceData.trBgcolor = "";
        objectPriceData.totalCount = "";
        objectPriceData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectPriceData);
    ...
    PriceData objectPriceData[] = new PriceData[vector.size()];
    vector.copyInto(objectPriceData);
    return(objectPriceData);
  }

/**
Create a registry
 */
  public static PriceData[] set(String mProductId, String mProductIdr, String pricelist, String pricestd, String isactive, String adClientId, String pricelimit, String adOrgId, String createdby, String createdbyr, String mPricelistVersionId, String mProductpriceId, String updatedby, String updatedbyr)    throws ServletException {
    PriceData objectPriceData[] = new PriceData[1];
    objectPriceData[0] = new PriceData();
    objectPriceData[0].created = "";
    objectPriceData[0].createdbyr = createdbyr;
    objectPriceData[0].updated = "";
    objectPriceData[0].updatedTimeStamp = "";
    objectPriceData[0].updatedby = updatedby;
    objectPriceData[0].updatedbyr = updatedbyr;
    objectPriceData[0].mProductpriceId = mProductpriceId;
    objectPriceData[0].adClientId = adClientId;
    objectPriceData[0].adClientIdr = "";
    objectPriceData[0].adOrgId = adOrgId;
    objectPriceData[0].adOrgIdr = "";
    objectPriceData[0].mProductId = mProductId;
    objectPriceData[0].mProductIdr = mProductIdr;
    objectPriceData[0].mPricelistVersionId = mPricelistVersionId;
    objectPriceData[0].mPricelistVersionIdr = "";
    objectPriceData[0].isactive = isactive;
    objectPriceData[0].pricelist = pricelist;
    objectPriceData[0].pricestd = pricestd;
    objectPriceData[0].pricelimit = pricelimit;
    objectPriceData[0].language = "";
    return objectPriceData;
  }

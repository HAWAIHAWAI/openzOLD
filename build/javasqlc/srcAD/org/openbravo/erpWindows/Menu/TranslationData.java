...
Select for edit
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adMenuId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adMenuId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((adMenuId==null || adMenuId.equals(""))?"":"  AND AD_Menu_Trl.AD_Menu_ID = ?  ");
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTranslationData.adMenuTrlId = UtilSql.getValue(result, "ad_menu_trl_id");
        ...
        objectTranslationData.adMenuId = UtilSql.getValue(result, "ad_menu_id");
        objectTranslationData.adMenuIdr = UtilSql.getValue(result, "ad_menu_idr");
...
Create a registry
 */
  public static TranslationData[] set(String adMenuId, String adClientId, String isactive, String name, String istranslated, String adMenuTrlId, String description, String adLanguage, String adOrgId, String createdby, String createdbyr, String updatedby, String updatedbyr)    throws ServletException {
    ...
    objectTranslationData[0].adMenuTrlId = adMenuTrlId;
    ...
    objectTranslationData[0].adMenuId = adMenuId;
    objectTranslationData[0].adMenuIdr = "";

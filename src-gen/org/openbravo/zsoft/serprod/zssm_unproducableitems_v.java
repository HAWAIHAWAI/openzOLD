...
/**
 * Entity class for entity zssm_unproducableitems_v (stored in table zssm_unproducableitems_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zssm_unproducableitems_v extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zssm_unproducableitems_v";
    public static final String ENTITY_NAME = "zssm_unproducableitems_v";
    ...
    public zssm_unproducableitems_v() {
    ...
    public String getCause() {
        return (String) get(PROPERTY_CAUSE);
    }

    public void setCause(String cause) {
        set(PROPERTY_CAUSE, cause);
    }
}

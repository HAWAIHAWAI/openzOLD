...
public class Access extends HttpSecureAppServlet {
  ...
  private static final String tabId = "311";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strAD_Window_Access_ID = vars.getGlobalVariable("inpadWindowAccessId", windowId + "|AD_Window_Access_ID", "");
        ...
        strPAD_Window_ID = getParentID(vars, strAD_Window_Access_ID);
      ...
      if (strView.equals("EDIT")) 
        ...
        printPageEdit(response, request, vars, false, strAD_Window_Access_ID, strPAD_Window_ID, tableSQL);

      else printPageDataSheet(response, vars, strPAD_Window_ID, strAD_Window_Access_ID, tableSQL);
      ...
      String strPAD_Window_ID = getParentID(vars, strAD_Window_Access_ID);
      ...
      if (vars.commandIn("DIRECTRELATION")){
        ...
        printPageDataSheet(response, vars, strPAD_Window_ID, strAD_Window_Access_ID, tableSQL);
      }
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String message = deleteRelation(vars, strAD_Window_Access_ID, strPAD_Window_ID);
      if (!message.equals("")) {
      ...
      String strAD_Window_Access_ID = vars.getRequiredStringParameter("inpadWindowAccessId");
      //AccessData data = getEditVariables(vars, strPAD_Window_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = AccessData.delete(this, strAD_Window_Access_ID, strPAD_Window_ID);
...
/*
  String deleteRelation(VariablesSecureApp vars, String strAD_Window_Access_ID, String strPAD_Window_ID) throws IOException, ServletException {
    ...
    try {
      ...
      if (!strAD_Window_Access_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (AccessData.deleteTransactional(conn, this, strKey, strPAD_Window_ID)==0) {
...
*/
  private AccessData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Window_ID) throws IOException,ServletException {
    AccessData data = new AccessData();
    ServletException ex = null;
    try {
    data.adWindowAccessId = vars.getRequestGlobalVariable("inpadWindowAccessId", windowId + "|AD_Window_Access_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adClientIdr = vars.getStringParameter("inpadClientId_R");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.adWindowId = vars.getStringParameter("inpadWindowId");     data.adWindowIdr = vars.getStringParameter("inpadWindowId_R");     data.adRoleId = vars.getStringParameter("inpadRoleId");     data.adRoleIdr = vars.getStringParameter("inpadRoleId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.isreadwrite = vars.getStringParameter("inpisreadwrite", "N"); 
   ...
   private AccessData[] getRelationData(AccessData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adWindowAccessId = FormatUtilities.truncate(data[i].adWindowAccessId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].adWindowId = FormatUtilities.truncate(data[i].adWindowId, 44);        data[i].adRoleId = FormatUtilities.truncate(data[i].adRoleId, 44);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Window_Access_ID) throws ServletException {
    String strPAD_Window_ID = AccessData.selectParentID(this, strAD_Window_Access_ID);
    if (strPAD_Window_ID.equals("")) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Window_Access_ID", data[0].getField("adWindowAccessId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars, String strPAD_Window_ID) throws IOException,ServletException {
      AccessData[] data = AccessData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Window_ID, vars.getStringParameter("inpadWindowAccessId", ""));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPAD_Window_ID, String strAD_Window_Access_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/WindowsTabsandFields/Access_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Access", false, "document.frmMain.inpadWindowAccessId", "grid", "..", "".equals("Y"), "WindowsTabsandFields", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Access_Relation.html", "WindowsTabsandFields", "W", strReplaceWith, tabs.breadcrumb());
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", AccessData.selectParent(this, vars.getLanguage(), strPAD_Window_ID));
    else xmlDocument.setParameter("parent", AccessData.selectParentTrl(this, vars.getLanguage(), strPAD_Window_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Window_Access_ID, String strPAD_Window_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = AccessData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Window_ID, strAD_Window_Access_ID);
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = AccessData.set(strPAD_Window_ID, Utility.getDefault(this, vars, "CreatedBy", "", "102", "311", "", dataField), AccessData.selectDef1335_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "102", "311", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "102", "311", "", dataField), "Y", Utility.getDefault(this, vars, "IsReadWrite", "", "102", "311", "N", dataField), Utility.getDefault(this, vars, "AD_Role_ID", "", "102", "311", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "102", "311", "", dataField), "", Utility.getDefault(this, vars, "UpdatedBy", "", "102", "311", "", dataField), AccessData.selectDef1337_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "102", "311", "", dataField)));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Access", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpadWindowAccessId", "", "..", "".equals("Y"), "WindowsTabsandFields", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strAD_Window_Access_ID));
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
		     ...
		     if(type == 'I') {
		       ...
		       if (AccessData.getCurrentDBTimestamp(this, data.adWindowAccessId).equals(

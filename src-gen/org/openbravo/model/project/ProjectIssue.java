 ...
 */
public class ProjectIssue extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_TIMEEXPENSELINE = "timeExpenseLine";
    ...
    public SheetLine getTimeExpenseLine() {
        return (SheetLine) get(PROPERTY_TIMEEXPENSELINE);
    }

    public void setTimeExpenseLine(SheetLine timeExpenseLine) {
        set(PROPERTY_TIMEEXPENSELINE, timeExpenseLine);
    }

...
public class TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0.class);
  
  private static final String windowId = "181";
  private static final String tabId = "C9AA9D04F1CB46918DD145035C9D8AB0";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0.view", "EDIT");

        printPageEdit(response, request, vars, false, strZssi_Order_Textmodule_ID, strPC_Order_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamLine_f", tabId + "|paramLine_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strZssi_Order_Textmodule_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0.view", strView);
        }
      }
...
vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");
      ...
      vars.setSessionValue(tabId + "|TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPC_Order_ID = vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Zssi_Order_Textmodule_ID");
      vars.setSessionValue(windowId + "|C_Order_ID", strPC_Order_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strZssi_Order_Textmodule_ID = vars.getRequiredStringParameter("inpzssiOrderTextmoduleId");
      //TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data data = getEditVariables(vars, strPC_Order_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.delete(this, strZssi_Order_Textmodule_ID, strPC_Order_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strZssi_Order_Textmodule_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.deleteTransactional(conn, this, strKey, strPC_Order_ID)==0) {
...
*/
  private TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
    TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data data = new TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data();
   ...
   private TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data[] getRelationData(TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data[] data) {
    if (data!=null) {
  ...
  private String getParentID(VariablesSecureApp vars, String strZssi_Order_Textmodule_ID) throws ServletException {
    String strPC_Order_ID = TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.selectParentID(this, strZssi_Order_Textmodule_ID);
    if (strPC_Order_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
      TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data[] data = TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_Order_ID, vars.getStringParameter("inpzssiOrderTextmoduleId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/PurchaseOrder/TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0", false, "document.frmMain.inpzssiOrderTextmoduleId", "grid", "..", "".equals("Y"), "PurchaseOrder", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0_Relation.html", "PurchaseOrder", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.selectParent(this, strPC_Order_ID));
    else xmlDocument.setParameter("parent", TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.selectParentTrl(this, strPC_Order_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZssi_Order_Textmodule_ID, String strPC_Order_ID, TableSQLData tableSQL)
    ...
    TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data[] data=null;
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_Order_ID, strZssi_Order_Textmodule_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.set(strPC_Order_ID, Utility.getDefault(this, vars, "Text", "", "181", "C9AA9D04F1CB46918DD145035C9D8AB0", "", dataField), Utility.getDefault(this, vars, "Islower", "N", "181", "C9AA9D04F1CB46918DD145035C9D8AB0", "N", dataField), Utility.getDefault(this, vars, "Ismodified", "N", "181", "C9AA9D04F1CB46918DD145035C9D8AB0", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "181", "C9AA9D04F1CB46918DD145035C9D8AB0", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "181", "C9AA9D04F1CB46918DD145035C9D8AB0", "", dataField), TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.selectDefE9FA66D9C5AE4E499DD4E6FAA9364C0E(this, strPC_Order_ID), Utility.getDefault(this, vars, "Updatedby", "", "181", "C9AA9D04F1CB46918DD145035C9D8AB0", "", dataField), TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.selectDef4AB8FAAB8CB64DFBA042409E35FF0884_0(this, Utility.getDefault(this, vars, "Updatedby", "", "181", "C9AA9D04F1CB46918DD145035C9D8AB0", "", dataField)), Utility.getDefault(this, vars, "Createdby", "", "181", "C9AA9D04F1CB46918DD145035C9D8AB0", "", dataField), TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.selectDef68FEA96B6A2943BAA0F20E91C7D0A409_1(this, Utility.getDefault(this, vars, "Createdby", "", "181", "C9AA9D04F1CB46918DD145035C9D8AB0", "", dataField)), Utility.getDefault(this, vars, "Zssi_Textmodule_ID", "", "181", "C9AA9D04F1CB46918DD145035C9D8AB0", "", dataField), "", "Y");
        
      }
    } else {
      data = new TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpzssiOrderTextmoduleId", "", "..", "".equals("Y"), "PurchaseOrder", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strZssi_Order_Textmodule_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0Data.getCurrentDBTimestamp(this, data.zssiOrderTextmoduleId).equals(
  ...
  public String getServletInfo() {
    return "Servlet TextmoduleC9AA9D04F1CB46918DD145035C9D8AB0. This Servlet was made by Wad constructor";

...
import org.openbravo.model.ad.access.Ad_preference_access;
 ...
 */
public class Preference extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISGLOBAL = "isglobal";
    public static final String PROPERTY_PREFERENCEACCESSLIST =
        "preferenceAccessList";

    public Preference() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_ISGLOBAL, false);
    ...
    public Boolean isGlobal() {
        return (Boolean) get(PROPERTY_ISGLOBAL);
    }

    public void setGlobal(Boolean isglobal) {
        set(PROPERTY_ISGLOBAL, isglobal);
    }

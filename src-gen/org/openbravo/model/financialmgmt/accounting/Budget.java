 ...
 */
public class Budget extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_EXPORTEXCEL = "exportexcel";
    public static final String PROPERTY_EXPORTACTUAL = "exportActual";
    public static final String PROPERTY_FINANCIALMGMTBUDGETLINELIST =
        "financialMgmtBudgetLineList";

    public Budget() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_COPYBUDGET, false);
        setDefaultValue(PROPERTY_BUDGETTYPE, "F");
        setDefaultValue(PROPERTY_EXPORTEXCEL, false);
        setDefaultValue(PROPERTY_EXPORTACTUAL, false);
        setDefaultValue(PROPERTY_FINANCIALMGMTBUDGETLINELIST,
    ...
    public Boolean isExportexcel() {
        return (Boolean) get(PROPERTY_EXPORTEXCEL);
    }

    public void setExportexcel(Boolean exportexcel) {
        set(PROPERTY_EXPORTEXCEL, exportexcel);
    }

    public Boolean isExportActual() {
        return (Boolean) get(PROPERTY_EXPORTACTUAL);
    }

    public void setExportActual(Boolean exportActual) {
        set(PROPERTY_EXPORTACTUAL, exportActual);
    }
    ...
    public void setFinancialMgmtBudgetLineList(
        List<BudgetLine> financialMgmtBudgetLineList) {

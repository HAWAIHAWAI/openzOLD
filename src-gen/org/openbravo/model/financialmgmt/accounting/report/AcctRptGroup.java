 ...
 */
public class AcctRptGroup extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ACCTRPT = "acctRpt";
    ...
    public static final String PROPERTY_FINANCIALMGMTACCTRPTNODELIST =
        "financialMgmtAcctRptNodeList";

    public AcctRptGroup() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_FINANCIALMGMTACCTRPTNODELIST,
    ...
    public AccountingReport getAcctRpt() {
        return (AccountingReport) get(PROPERTY_ACCTRPT);
    }

    public void setAcctRpt(AccountingReport acctRpt) {
        set(PROPERTY_ACCTRPT, acctRpt);
    }
    ...
    public void setFinancialMgmtAcctRptNodeList(
        List<AcctRptNode> financialMgmtAcctRptNodeList) {

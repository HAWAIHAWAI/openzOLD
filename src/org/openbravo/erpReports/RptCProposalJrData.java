...
static Logger log4j = Logger.getLogger(RptCProposalJrData.class);
  ...
  public static RptCProposalJrData[] selectLines(ConnectionProvider connectionProvider, String cProjectProposalId)    throws ServletException {
    return selectLines(connectionProvider, cProjectProposalId, 0, 0);
  }

  public static RptCProposalJrData[] selectLines(ConnectionProvider connectionProvider, String cProjectProposalId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectRptCProposalJrData.phone = UtilSql.getValue(result, "phone");
        objectRptCProposalJrData.fax = UtilSql.getValue(result, "fax");
        objectRptCProposalJrData.fecha = UtilSql.getValue(result, "fecha");
        objectRptCProposalJrData.bpname = UtilSql.getValue(result, "bpname");
        objectRptCProposalJrData.namecontacto = UtilSql.getValue(result, "namecontacto");
        objectRptCProposalJrData.contacto = UtilSql.getValue(result, "contacto");
        objectRptCProposalJrData.headernote = UtilSql.getValue(result, "headernote");
  ...
  public static RptCProposalJrData[] selectFootnote(ConnectionProvider connectionProvider, String cProjectProposalId)    throws ServletException {
    return selectFootnote(connectionProvider, cProjectProposalId, 0, 0);
  }

  public static RptCProposalJrData[] selectFootnote(ConnectionProvider connectionProvider, String cProjectProposalId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 

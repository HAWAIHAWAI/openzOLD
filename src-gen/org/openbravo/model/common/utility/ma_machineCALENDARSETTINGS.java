...
/**
 * Entity class for entity ma_machineCALENDARSETTINGS (stored in table ma_machineCALENDARSETTINGS).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ma_machineCALENDARSETTINGS extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ma_machineCALENDARSETTINGS";
    public static final String ENTITY_NAME = "ma_machineCALENDARSETTINGS";
    ...
    public ma_machineCALENDARSETTINGS() {

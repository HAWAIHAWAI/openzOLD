   ...
   private ReportHeader77515489D07B4FF3A7FA711D67F7E1DDData[] getRelationData(ReportHeader77515489D07B4FF3A7FA711D67F7E1DDData[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|Zspr_Bwaheader_ID", data[0].getField("zsprBwaheaderId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }

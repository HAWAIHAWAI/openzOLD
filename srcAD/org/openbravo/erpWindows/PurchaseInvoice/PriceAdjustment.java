...
public class PriceAdjustment extends HttpSecureAppServlet {
  ...
  private static final String tabId = "800224";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|C_InvoiceLine_ID", strPC_InvoiceLine_ID);
      vars.setSessionValue("291|Lines.view", "EDIT");
      vars.removeSessionValue(windowId + "|C_Invoice_ID");
      refreshParentSession(vars, strPC_InvoiceLine_ID);
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strC_Invoiceline_Offer_ID = vars.getRequiredStringParameter("inpcInvoicelineOfferId");
      //PriceAdjustmentData data = getEditVariables(vars, strPC_InvoiceLine_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = PriceAdjustmentData.delete(this, strC_Invoiceline_Offer_ID, strPC_InvoiceLine_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strC_Invoiceline_Offer_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (PriceAdjustmentData.deleteTransactional(conn, this, strKey, strPC_InvoiceLine_ID)==0) {
...
*/
  private PriceAdjustmentData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_InvoiceLine_ID) throws IOException,ServletException {
   ...
   private PriceAdjustmentData[] getRelationData(PriceAdjustmentData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].cInvoicelineId = FormatUtilities.truncate(data[i].cInvoicelineId, 44);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].cInvoicelineOfferId = FormatUtilities.truncate(data[i].cInvoicelineOfferId, 10);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].mOfferId = FormatUtilities.truncate(data[i].mOfferId, 44);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_InvoiceLine_ID) throws IOException,ServletException {
      ...
      vars.setSessionValue(windowId + "|HASSECONDUOM", LinesData.selectAux800003(this, Utility.getContext(this, vars, "M_Product_ID", "183")));
      
      vars.setSessionValue(windowId + "|C_BPARTNER_ID", Utility.getContext(this, vars, "C_BPARTNER_ID", "183"));
      
      vars.setSessionValue(windowId + "|Processed", LinesData.selectAux80BB79DBFEAA45CAB10F60A9DD388780(this, Utility.getContext(this, vars, "C_INVOICE_ID", "183")));
      
  }
    
  private String getParentID(VariablesSecureApp vars, String strC_Invoiceline_Offer_ID) throws ServletException {
    String strPC_InvoiceLine_ID = PriceAdjustmentData.selectParentID(this, strC_Invoiceline_Offer_ID);
    if (strPC_InvoiceLine_ID.equals("")) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|C_Invoiceline_Offer_ID", data[0].getField("cInvoicelineOfferId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars, String strPC_InvoiceLine_ID) throws IOException,ServletException {
      PriceAdjustmentData[] data = PriceAdjustmentData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_InvoiceLine_ID, vars.getStringParameter("inpcInvoicelineOfferId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamAmtoffer_f = vars.getSessionValue(tabId + "|paramAmtoffer_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/PurchaseInvoice/PriceAdjustment_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "PriceAdjustment", false, "document.frmMain.inpcInvoicelineOfferId", "grid", "..", "".equals("Y"), "PurchaseInvoice", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "PriceAdjustment_Relation.html", "PurchaseInvoice", "W", strReplaceWith, tabs.breadcrumb());
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", PriceAdjustmentData.selectParent(this, strPC_InvoiceLine_ID));
    else xmlDocument.setParameter("parent", PriceAdjustmentData.selectParentTrl(this, strPC_InvoiceLine_ID));
...
String strParamAmtoffer_f = vars.getSessionValue(tabId + "|paramAmtoffer_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = PriceAdjustmentData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_InvoiceLine_ID, strC_Invoiceline_Offer_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PriceAdjustmentData.set(strPC_InvoiceLine_ID, Utility.getDefault(this, vars, "Priceoffer", "0", "183", "800224", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "183", "800224", "", dataField), PriceAdjustmentData.selectDef803126_0(this, Utility.getDefault(this, vars, "Createdby", "", "183", "800224", "", dataField)), "Y", Utility.getDefault(this, vars, "Updatedby", "", "183", "800224", "", dataField), PriceAdjustmentData.selectDef803128_1(this, Utility.getDefault(this, vars, "Updatedby", "", "183", "800224", "", dataField)), PriceAdjustmentData.selectDef803130(this, strPC_InvoiceLine_ID), "", Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "183", "800224", "", dataField), Utility.getDefault(this, vars, "Amtoffer", "0", "183", "800224", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "183", "800224", "", dataField), Utility.getDefault(this, vars, "M_Offer_ID", "", "183", "800224", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "PriceAdjustment", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcInvoicelineOfferId", "", "..", "".equals("Y"), "PurchaseInvoice", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Invoiceline_Offer_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (PriceAdjustmentData.getCurrentDBTimestamp(this, data.cInvoicelineOfferId).equals(

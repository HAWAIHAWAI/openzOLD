...
static Logger log4j = Logger.getLogger(CreateFromBankData.class);
  ...
  public static CreateFromBankData[] select(ConnectionProvider connectionProvider, String adLanguage, String statementdate, String userClient, String userOrg, String cBPartnerId, String paymentrule, String planneddateFrom, String planneddateTo, String amountFrom, String amountTo, String isreceipt, String cBankaccountId, String adOrgId, String ischarge, String isapproved, String invoice, String pgLimit)    throws ServletException {
    return select(connectionProvider, adLanguage, statementdate, userClient, userOrg, cBPartnerId, paymentrule, planneddateFrom, planneddateTo, amountFrom, amountTo, isreceipt, cBankaccountId, adOrgId, ischarge, isapproved, invoice, pgLimit, 0, 0);
  }
  ...
  public static CreateFromBankData[] select(ConnectionProvider connectionProvider, String adLanguage, String statementdate, String userClient, String userOrg, String cBPartnerId, String paymentrule, String planneddateFrom, String planneddateTo, String amountFrom, String amountTo, String isreceipt, String cBankaccountId, String adOrgId, String ischarge, String isapproved, String invoice, String pgLimit, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "          	(select c_currency_id from c_bankaccount c where c.c_bankaccount_id = a.c_bankaccount_id)," +
 ...
 */
  public static int insert(Connection conn, ConnectionProvider connectionProvider, String cBankstatementlineId, String adClientId, String adUserId, String cBankstatementId, String statementdate, String cChargeAmt, String discountamt, String memo, String cPaymentId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "               C_Currency_Convert(p.Amount-coalesce(p.writeoffamt,0)-coalesce(p.discountamt,0),p.C_Currency_ID, (SELECT A.C_CURRENCY_ID" +
      ...
      "               C_Currency_Convert(coalesce(case p.isreceipt when 'N' then to_number(?)*-1 else 0 end,0),p.C_Currency_ID, (SELECT A.C_CURRENCY_ID" +
      "                                                                              FROM C_BANKSTATEMENT S, C_BANKACCOUNT A" +
      "                                                                              WHERE S.C_BANKACCOUNT_ID = A.C_BANKACCOUNT_ID" +
      "                                                                              AND S.C_BankStatement_ID = ?),TO_DATE(?),null,p.AD_Client_ID,p.AD_Org_ID)," +
  ...
  public static int insertPayment(Connection conn, ConnectionProvider connectionProvider, String cDebtPaymentId, String adUserId, String cSettlementId, String amount, String cPaymentId)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        NOW(), ?, NOW(), ?," +
      "        C_DEBT_PAYMENT.ISRECEIPT, ?, COALESCE(C_DEBT_PAYMENT.DESCRIPTION, '(Splited) NÂº ' || C_INVOICE.DOCUMENTNO), " +

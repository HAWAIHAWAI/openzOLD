 ...
 */
public class DPManagementLine extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_STATUSFROM = "statusFrom";
    ...
    public String getStatusFrom() {
        return (String) get(PROPERTY_STATUSFROM);
    }

    public void setStatusFrom(String statusFrom) {
        set(PROPERTY_STATUSFROM, statusFrom);
    }

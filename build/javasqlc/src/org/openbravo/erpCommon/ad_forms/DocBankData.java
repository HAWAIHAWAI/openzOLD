  ...
  public static DocBankData[] select(ConnectionProvider connectionProvider, String C_BankAccount_ID, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectDocBankData.discountamt = UtilSql.getValue(result, "discountamt");
        objectDocBankData.isvoided = UtilSql.getValue(result, "isvoided");
        objectDocBankData.sepaexportenabled = UtilSql.getValue(result, "sepaexportenabled");
        objectDocBankData.voidline = UtilSql.getValue(result, "voidline");

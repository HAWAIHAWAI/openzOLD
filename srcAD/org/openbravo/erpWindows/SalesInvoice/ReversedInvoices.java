...
public class ReversedInvoices extends HttpSecureAppServlet {
  ...
  private static final String tabId = "28D602B576DF417AB289B4EC94BE2C17";
...
*/
  private ReversedInvoicesData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Invoice_ID) throws IOException,ServletException {
   ...
   private ReversedInvoicesData[] getRelationData(ReversedInvoicesData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].cInvoiceReverseId = FormatUtilities.truncate(data[i].cInvoiceReverseId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].reversedCInvoiceId = FormatUtilities.truncate(data[i].reversedCInvoiceId, 32);        data[i].cInvoiceId = FormatUtilities.truncate(data[i].cInvoiceId, 32);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strC_Invoice_Reverse_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|C_Invoice_Reverse_ID", data[0].getField("cInvoiceReverseId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPC_Invoice_ID, String strC_Invoice_Reverse_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SalesInvoice/ReversedInvoices_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ReversedInvoices", false, "document.frmMain.inpcInvoiceReverseId", "grid", "..", "".equals("Y"), "SalesInvoice", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ReversedInvoices_Relation.html", "SalesInvoice", "W", strReplaceWith, tabs.breadcrumb());
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Invoice_Reverse_ID, String strPC_Invoice_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cInvoiceReverseId") == null || dataField.getField("cInvoiceReverseId").equals("")) {
        ...
        String strProcessed = ReversedInvoicesData.selectAux01379E71C9E342A28AD3A60B5D499362(this, strPC_Invoice_ID);
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ReversedInvoicesData.set(strPC_Invoice_ID, "Y", Utility.getDefault(this, vars, "Reversed_C_Invoice_ID", "", "167", "28D602B576DF417AB289B4EC94BE2C17", "", dataField), ReversedInvoicesData.selectDef739A9DDF905A8F87E040007F010123C7_0(this, Utility.getDefault(this, vars, "Reversed_C_Invoice_ID", "", "167", "28D602B576DF417AB289B4EC94BE2C17", "", dataField)), Utility.getDefault(this, vars, "Createdby", "", "167", "28D602B576DF417AB289B4EC94BE2C17", "", dataField), ReversedInvoicesData.selectDef7399CFDCF5B72DD0E040007F0101239A_1(this, Utility.getDefault(this, vars, "Createdby", "", "167", "28D602B576DF417AB289B4EC94BE2C17", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "167", "28D602B576DF417AB289B4EC94BE2C17", "", dataField), "", Utility.getDefault(this, vars, "Updatedby", "", "167", "28D602B576DF417AB289B4EC94BE2C17", "", dataField), ReversedInvoicesData.selectDef7399CFDCF5B92DD0E040007F0101239A_2(this, Utility.getDefault(this, vars, "Updatedby", "", "167", "28D602B576DF417AB289B4EC94BE2C17", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "167", "28D602B576DF417AB289B4EC94BE2C17", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "ReversedInvoices", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcInvoiceReverseId", "", "..", "".equals("Y"), "SalesInvoice", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Invoice_Reverse_ID));

...
public class FrameContractsSales extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(FrameContractsSales.class);
  
  private static final String windowId = "BEE6D919FC9B44C096DA60CB08F43494";
  private static final String tabId = "424A86FA6EBC4AA1B0AA739385BCF588";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|FrameContractsSales.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|FrameContractsSales.view", "EDIT");

        printPageEdit(response, request, vars, false, strC_Framecontractoverview_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|FrameContractsSales.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamEnddate_f", tabId + "|paramEnddate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strC_Framecontractoverview_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|FrameContractsSales.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|FrameContractsSales.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|FrameContractsSales.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|FrameContractsSales.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|C_Framecontractoverview_ID");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strC_Framecontractoverview_ID = vars.getRequiredStringParameter("inpcFramecontractoverviewId");
      //FrameContractsSalesData data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = FrameContractsSalesData.delete(this, strC_Framecontractoverview_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strC_Framecontractoverview_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (FrameContractsSalesData.deleteTransactional(conn, this, strKey)==0) {
  ...
  private FrameContractsSalesData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private FrameContractsSalesData[] getRelationData(FrameContractsSalesData[] data) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      FrameContractsSalesData[] data = FrameContractsSalesData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inpcFramecontractoverviewId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamEnddate_f = vars.getSessionValue(tabId + "|paramEnddate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/FrameContractOverview/FrameContractsSales_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "FrameContractsSales", false, "document.frmMain.inpcFramecontractoverviewId", "grid", "..", "".equals("Y"), "FrameContractOverview", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "FrameContractsSales_Relation.html", "FrameContractOverview", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "FrameContractsSales_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Framecontractoverview_ID, TableSQLData tableSQL)
    ...
    FrameContractsSalesData[] data=null;
...
String strParamEnddate_f = vars.getSessionValue(tabId + "|paramEnddate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = FrameContractsSalesData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strC_Framecontractoverview_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new FrameContractsSalesData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = FrameContractsSalesData.set(Utility.getDefault(this, vars, "Docstatus", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "C_Orderline_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "Calloffqty", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "Issotrx", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "N", dataField), Utility.getDefault(this, vars, "C_Uom_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), FrameContractsSalesData.selectDef1455A04D8C7D42AA922F0AB2A1B3E919_0(this, Utility.getDefault(this, vars, "M_Product_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_Location_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), FrameContractsSalesData.selectDef8BE3EBBA3F5744B2B3D8BF7BE76E60DB_1(this, Utility.getDefault(this, vars, "C_Bpartner_Location_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), FrameContractsSalesData.selectDefA69A05D740AD456A9753572F8A995BAF_2(this, Utility.getDefault(this, vars, "Updatedby", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField)), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), FrameContractsSalesData.selectDef00B7D3437CAF48FBBD7CDD820698A83B_3(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField)), Utility.getDefault(this, vars, "Line", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "Qtyordered", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), "", Utility.getDefault(this, vars, "Contractdate", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "Securityqty", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "Priceactual", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "Linenetamt", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "Documentno", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "Qtyleft", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "Deliverycomplete", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "N", dataField), Utility.getDefault(this, vars, "Createdby", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), FrameContractsSalesData.selectDefF05F251C24A240A1AADD0643F75FF2C3_4(this, Utility.getDefault(this, vars, "Createdby", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField)), Utility.getDefault(this, vars, "Enddate", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "424A86FA6EBC4AA1B0AA739385BCF588", "", dataField), "Y");
        
      }
    } else {
      data = new FrameContractsSalesData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(FrameContractsSalesData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "FrameContractsSales", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcFramecontractoverviewId", "", "..", "".equals("Y"), "FrameContractOverview", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Framecontractoverview_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (FrameContractsSalesData.getCurrentDBTimestamp(this, data.cFramecontractoverviewId).equals(
  ...
  public String getServletInfo() {
    return "Servlet FrameContractsSales. This Servlet was made by Wad constructor";

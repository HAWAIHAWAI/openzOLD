 ...
 */
public class ProjectType extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_PROJECTSTANDARDPHASELIST =
        "projectStandardPhaseList";

    public ProjectType() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_PROJECTCATEGORY, "S");
        setDefaultValue(PROPERTY_PROJECTSTANDARDPHASELIST,
    ...
    public void setProjectStandardPhaseList(
        List<StandardPhase> projectStandardPhaseList) {

 ...
 */
public class Periodicity extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_INITDATE = "initdate";
    public static final String PROPERTY_EXCLUDEWEEKEND = "excludeweekend";

    public Periodicity() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_EXCLUDEWEEKEND, true);
    }
    ...
    public Long getMonthday() {
        return (Long) get(PROPERTY_MONTHDAY);
    }

    public void setMonthday(Long monthday) {
        set(PROPERTY_MONTHDAY, monthday);
    }
    ...
    public Date getInitdate() {
        return (Date) get(PROPERTY_INITDATE);
    }

    public void setInitdate(Date initdate) {
        set(PROPERTY_INITDATE, initdate);
    }

    public Boolean isExcludeweekend() {
        return (Boolean) get(PROPERTY_EXCLUDEWEEKEND);
    }

    public void setExcludeweekend(Boolean excludeweekend) {
        set(PROPERTY_EXCLUDEWEEKEND, excludeweekend);
    }
}

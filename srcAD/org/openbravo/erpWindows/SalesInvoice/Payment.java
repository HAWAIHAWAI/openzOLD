...
public class Payment extends HttpSecureAppServlet {
  ...
  private static final String tabId = "800028";
...
*/
  private PaymentData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Invoice_ID) throws IOException,ServletException {
   ...
   private PaymentData[] getRelationData(PaymentData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].cDebtPaymentId = FormatUtilities.truncate(data[i].cDebtPaymentId, 10);        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 44);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cInvoiceId = FormatUtilities.truncate(data[i].cInvoiceId, 44);        data[i].cSettlementCancelId = FormatUtilities.truncate(data[i].cSettlementCancelId, 44);        data[i].paymentrule = FormatUtilities.truncate(data[i].paymentrule, 21);        data[i].cSettlementGenerateId = FormatUtilities.truncate(data[i].cSettlementGenerateId, 44);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].cCashbookId = FormatUtilities.truncate(data[i].cCashbookId, 44);        data[i].cCashlineId = FormatUtilities.truncate(data[i].cCashlineId, 44);        data[i].cBankaccountId = FormatUtilities.truncate(data[i].cBankaccountId, 44);        data[i].cBankstatementlineId = FormatUtilities.truncate(data[i].cBankstatementlineId, 44);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, 44);        data[i].statusInitial = FormatUtilities.truncate(data[i].statusInitial, 21);}
    }
    return data;
  }
...
String strParamAmount_f = vars.getSessionValue(tabId + "|paramAmount_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SalesInvoice/Payment_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Payment", false, "document.frmMain.inpcDebtPaymentId", "grid", "../RptPromissoryNote.pdf", "N".equals("Y"), "SalesInvoice", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Payment_Relation.html", "SalesInvoice", "W", strReplaceWith, tabs.breadcrumb());
...
String strParamAmount_f = vars.getSessionValue(tabId + "|paramAmount_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PaymentData.set(strPC_Invoice_ID, Utility.getDefault(this, vars, "C_Currency_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "C_CashLine_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "C_BankStatementLine_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "IsReceipt", "@IsSOTrx@", "167", "800028", "N", dataField), "Y", Utility.getDefault(this, vars, "IsPaid", "", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "Discountamt", "0", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Cancel_Processed", "N", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "WriteOffAmt", "0", "167", "800028", "", dataField), "", Utility.getDefault(this, vars, "C_Settlement_Cancel_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Description", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "C_BankAccount_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "IsManual", "", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "IsValid", "", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "167", "800028", "", dataField), PaymentData.selectDef800304_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "167", "800028", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "167", "800028", "", dataField), PaymentData.selectDef800311_1(this, strPC_Invoice_ID), Utility.getDefault(this, vars, "Dateplanned", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Changesettlementcancel", "N", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "C_CashBook_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Amount", "0", "167", "800028", "", dataField), Utility.getDefault(this, vars, "IsAutomaticGenerated", "", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "PaymentRule", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Status_Initial", "DE", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Generate_Processed", "N", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "167", "800028", "", dataField), PaymentData.selectDef800306_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "167", "800028", "", dataField)), Utility.getDefault(this, vars, "C_Settlement_Generate_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "@C_BPartner_ID@", "167", "800028", "", dataField), PaymentData.selectDef800312_3(this, Utility.getDefault(this, vars, "C_BPartner_ID", "@C_BPartner_ID@", "167", "800028", "", dataField)));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Payment", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcDebtPaymentId", "", "../RptPromissoryNote.pdf", "N".equals("Y"), "SalesInvoice", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Debt_Payment_ID));

...
class BuscadorData implements FieldProvider {
static Logger log4j = Logger.getLogger(BuscadorData.class);
  ...
  public static String selectFistFocusedfield(ConnectionProvider connectionProvider, String lang, String adTabId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "       select  pname as name from ad_selecttabBuscadorFields(?,?,'N') order by pline limit 1";
  ...
  public static String isOrgInFilter(ConnectionProvider connectionProvider, String lang, String adTabId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "       select  pname as name from ad_selecttabBuscadorFields(?,?,'N') where lower(pname)='ad_org_id'";

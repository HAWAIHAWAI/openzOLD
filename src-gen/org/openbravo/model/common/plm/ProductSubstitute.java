 ...
 */
public class ProductSubstitute extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_SUBSTITUTE = "substitute";
    ...
    public Product getSubstitute() {
        return (Product) get(PROPERTY_SUBSTITUTE);
    }

    public void setSubstitute(Product substitute) {
        set(PROPERTY_SUBSTITUTE, substitute);
    }

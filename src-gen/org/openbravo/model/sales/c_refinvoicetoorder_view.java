...
/**
 * Entity class for entity c_refinvoicetoorder_view (stored in table c_refinvoicetoorder_view).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class c_refinvoicetoorder_view extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "c_refinvoicetoorder_view";
    public static final String ENTITY_NAME = "c_refinvoicetoorder_view";
    ...
    public c_refinvoicetoorder_view() {

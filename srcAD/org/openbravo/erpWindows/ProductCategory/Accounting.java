...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strM_Product_Category_Acct_ID = vars.getRequiredInStringParameter("inpmProductCategoryAcctId");
      String message = deleteRelation(vars, strM_Product_Category_Acct_ID, strPM_Product_Category_ID);
      if (!message.equals("")) {
...
/*
  String deleteRelation(VariablesSecureApp vars, String strM_Product_Category_Acct_ID, String strPM_Product_Category_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strM_Product_Category_Acct_ID.startsWith("(")) strM_Product_Category_Acct_ID = strM_Product_Category_Acct_ID.substring(1, strM_Product_Category_Acct_ID.length()-1);
      if (!strM_Product_Category_Acct_ID.equals("")) {
        strM_Product_Category_Acct_ID = Replace.replace(strM_Product_Category_Acct_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strM_Product_Category_Acct_ID, ",", false);
        while (st.hasMoreTokens()) {
          String strKey = st.nextToken();
          if (AccountingData.deleteTransactional(conn, this, strKey, strPM_Product_Category_ID)==0) {
...
String strParamC_AcctSchema_ID = vars.getSessionValue(tabId + "|paramC_AcctSchema_ID");
    ...
    if (!(strParamM_Product_Category_ID.equals("") && strParamC_AcctSchema_ID.equals(""))) hasSearchCondition=true;
    String strOffset = "0";
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Accounting", false, "document.frmMain.inpmProductCategoryAcctId", "grid", "..", "".equals("Y"), "ProductCategory", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Accounting_Relation.html", "ProductCategory", "W", strReplaceWith, tabs.breadcrumb());
...
String strParamC_AcctSchema_ID = vars.getSessionValue(tabId + "|paramC_AcctSchema_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = AccountingData.set(strPM_Product_Category_ID, Utility.getDefault(this, vars, "P_Cogs_Acct", "", "144", "324", "", dataField), AccountingData.selectDef5122_0(this, Utility.getDefault(this, vars, "P_Cogs_Acct", "", "144", "324", "", dataField)), Utility.getDefault(this, vars, "C_AcctSchema_ID", "", "144", "324", "", dataField), Utility.getDefault(this, vars, "P_Revenue_Acct", "", "144", "324", "", dataField), AccountingData.selectDefB8074E1724704B6389F2BE77B8F8D3CE_1(this, Utility.getDefault(this, vars, "P_Revenue_Acct", "", "144", "324", "", dataField)), "Y", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "144", "324", "", dataField), Utility.getDefault(this, vars, "P_PurchasePriceVariance_Acct", "", "144", "324", "", dataField), AccountingData.selectDef5123_2(this, Utility.getDefault(this, vars, "P_PurchasePriceVariance_Acct", "", "144", "324", "", dataField)), Utility.getDefault(this, vars, "P_InvoicePriceVariance_Acct", "", "144", "324", "", dataField), AccountingData.selectDef6121_3(this, Utility.getDefault(this, vars, "P_InvoicePriceVariance_Acct", "", "144", "324", "", dataField)), Utility.getDefault(this, vars, "CreatedBy", "", "144", "324", "", dataField), AccountingData.selectDef5116_4(this, Utility.getDefault(this, vars, "CreatedBy", "", "144", "324", "", dataField)), Utility.getDefault(this, vars, "Processing", "N", "144", "324", "N", dataField), Utility.getDefault(this, vars, "P_TradeDiscountRec_Acct", "", "144", "324", "", dataField), AccountingData.selectDef6122_5(this, Utility.getDefault(this, vars, "P_TradeDiscountRec_Acct", "", "144", "324", "", dataField)), Utility.getDefault(this, vars, "P_Expense_Acct", "", "144", "324", "", dataField), AccountingData.selectDefC4B78616C86046FD85B9E29522B956B2_6(this, Utility.getDefault(this, vars, "P_Expense_Acct", "", "144", "324", "", dataField)), Utility.getDefault(this, vars, "P_Asset_Acct", "", "144", "324", "", dataField), AccountingData.selectDef5121_7(this, Utility.getDefault(this, vars, "P_Asset_Acct", "", "144", "324", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "144", "324", "", dataField), AccountingData.selectDef5118_8(this, Utility.getDefault(this, vars, "UpdatedBy", "", "144", "324", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "144", "324", "", dataField), Utility.getDefault(this, vars, "P_TradeDiscountGrant_Acct", "", "144", "324", "", dataField), AccountingData.selectDef6123_9(this, Utility.getDefault(this, vars, "P_TradeDiscountGrant_Acct", "", "144", "324", "", dataField)), "");
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonProcessing140(HttpServletResponse response, VariablesSecureApp vars, String strM_Product_Category_Acct_ID, String strprocessing, String strProcessing)
    throws IOException, ServletException {
    ...
    Scripthelper script = new Scripthelper();
      ...
      try {
        String name= LocalizationUtils.getProcessTitle(this, "140",vars.getLanguage());
        String info = LocalizationUtils.getProcessInfo(this, "140" ,vars.getLanguage());
        if (! info.isEmpty())
        ...
        strFG=strFG + fh.prepareProcessParameters(this, vars, script,"140" );
        String isDocAction=UtilsData.isProcessDocAction(this, "140");
        if (Integer.parseInt(isDocAction)>0) {
            String strdocstatus=UtilsData.getDocStatus(this, "401",strM_Product_Category_Acct_ID);
            FieldProvider[] dataDocAction = DocActionWorkflowOptions.docAction(this, vars, "", "", strdocstatus,"N",
            "401", strM_Product_Category_Acct_ID);
        ...
        String isJasper=UtilsData.isProcessJasper(this, "140");
        if (isJasper.equals("N"))
          strActionButtons= strActionButtons + ConfigureButton.doConfigure(this,vars,script,"buttonok",1,1,false, "ok",  "submitThisPage('SAVE_BUTTONProcessing" + "140" + "');", "","") + "";
        else
        ...
        script.addHiddenfield("inpadProcessId", "140");
        script.addHiddenfield("inpKey",strM_Product_Category_Acct_ID);
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPM_Product_Category_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mProductCategoryAcctId, vars, this);
        } catch(Exception ex) {

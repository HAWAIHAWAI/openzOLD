...
public class Lines extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|M_InOut_ID", strPM_InOut_ID);
      vars.setSessionValue("296|Goods Movement Vendor.view", "EDIT");
...
String strParamM_Product_ID = vars.getSessionValue(tabId + "|paramM_Product_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/GoodsMovementVendor/Lines_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Lines", false, "document.frmMain.inpmInoutlineId", "grid", "..", "".equals("Y"), "GoodsMovementVendor", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines_Relation.html", "GoodsMovementVendor", "W", strReplaceWith, tabs.breadcrumb());
...
String strParamM_Product_ID = vars.getSessionValue(tabId + "|paramM_Product_ID");
    ...
    vars.setSessionValue(windowId + "|HASSECONDUOM", strHASSECONDUOM);
        String strC_BPARTNER_ID = Utility.getContext(this, vars, "C_BPARTNER_ID", "184");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPM_InOut_ID, LinesData.selectDef3810(this, strPM_InOut_ID), Utility.getDefault(this, vars, "MovementQty", "1", "184", "297", "", dataField), Utility.getDefault(this, vars, "M_Locator_ID", "@#M_Locator_ID@", "184", "297", "", dataField), LinesData.selectDef3537_0(this, Utility.getDefault(this, vars, "M_Locator_ID", "@#M_Locator_ID@", "184", "297", "", dataField)), LinesData.selectDef3538_1(this, strPM_InOut_ID), "", Utility.getDefault(this, vars, "C_UOM_ID", "", "184", "297", "", dataField), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "184", "297", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "184", "297", "", dataField), LinesData.selectDef3536_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "184", "297", "", dataField)), Utility.getDefault(this, vars, "C_OrderLine_ID", "", "184", "297", "", dataField), LinesData.selectDef3811_3(this, Utility.getDefault(this, vars, "C_OrderLine_ID", "", "184", "297", "", dataField)), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "184", "297", "", dataField), LinesData.selectDef8772_4(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "184", "297", "", dataField)), LinesData.selectDefB219CD429DB14019BD3C1F903F141CD7(this, strPM_InOut_ID), Utility.getDefault(this, vars, "IsInvoiced", "", "184", "297", "N", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "184", "297", "", dataField), LinesData.selectDef3539_5(this, Utility.getDefault(this, vars, "M_Product_ID", "", "184", "297", "", dataField)), "Y", Utility.getDefault(this, vars, "QuantityOrder", "", "184", "297", "", dataField), Utility.getDefault(this, vars, "IsDescription", "N", "184", "297", "N", dataField), LinesData.selectDefFBFB0E5EAC68403BAA422D3D2EBF1CB8(this, strPM_InOut_ID), LinesData.selectDefFBFB0E5EAC68403BAA422D3D2EBF1CB8_6(this, LinesData.selectDefFBFB0E5EAC68403BAA422D3D2EBF1CB8(this, strPM_InOut_ID)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "184", "297", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "184", "297", "", dataField), LinesData.selectDef3534_7(this, Utility.getDefault(this, vars, "CreatedBy", "", "184", "297", "", dataField)), LinesData.selectDefF345198A17D24EE88F669F7698A01D10(this, strPM_InOut_ID), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "184", "297", "", dataField), Utility.getDefault(this, vars, "Description", "", "184", "297", "", dataField));
    ...
    String currentPOrg=GoodsMovementVendorData.selectOrg(this, strPM_InOut_ID);
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Lines", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmInoutlineId", "", "..", "".equals("Y"), "GoodsMovementVendor", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_InOutLine_ID));

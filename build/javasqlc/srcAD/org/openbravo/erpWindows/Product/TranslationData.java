...
Select for edit
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTranslationData.mProductId = UtilSql.getValue(result, "m_product_id");
        objectTranslationData.mProductIdr = UtilSql.getValue(result, "m_product_idr");
        ...
        objectTranslationData.documentnote = UtilSql.getValue(result, "documentnote");
        ...
        objectTranslationData.mProductTrlId = UtilSql.getValue(result, "m_product_trl_id");
...
Create a registry
 */
  public static TranslationData[] set(String mProductId, String createdby, String createdbyr, String mProductTrlId, String name, String description, String updatedby, String updatedbyr, String adClientId, String adLanguage, String istranslated, String documentnote, String mProductIdr, String isactive, String adOrgId)    throws ServletException {
    ...
    objectTranslationData[0].mProductId = mProductId;
    objectTranslationData[0].mProductIdr = mProductIdr;
    ...
    objectTranslationData[0].documentnote = documentnote;
    objectTranslationData[0].isactive = isactive;
    objectTranslationData[0].istranslated = istranslated;
    objectTranslationData[0].mProductTrlId = mProductTrlId;

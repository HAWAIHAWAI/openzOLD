...
public class FormMapping extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(FormMapping.class);
  
  private static final String windowId = "187";
  private static final String tabId = "800196";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|FormMapping.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(windowId + "|AD_Model_Object_ID", strPAD_Model_Object_ID);
      vars.setSessionValue("800195|Form Class.view", "EDIT");
      vars.removeSessionValue(windowId + "|AD_Form_ID");
      refreshParentSession(vars, strPAD_Model_Object_ID);

      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|FormMapping.view", "EDIT");

        printPageEdit(response, request, vars, false, strAD_Model_Object_Mapping_ID, strPAD_Model_Object_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|FormMapping.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamMappingName", tabId + "|paramMappingName");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strAD_Model_Object_Mapping_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|FormMapping.view", strView);
        }
      }
...
vars.getGlobalVariable("inpadModelObjectId", windowId + "|AD_Model_Object_ID");
      ...
      vars.setSessionValue(tabId + "|FormMapping.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPAD_Model_Object_ID = vars.getGlobalVariable("inpadModelObjectId", windowId + "|AD_Model_Object_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|FormMapping.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|FormMapping.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|AD_Model_Object_Mapping_ID");
      vars.setSessionValue(windowId + "|AD_Model_Object_ID", strPAD_Model_Object_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strAD_Model_Object_Mapping_ID = vars.getRequiredStringParameter("inpadModelObjectMappingId");
      //FormMappingData data = getEditVariables(vars, strPAD_Model_Object_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = FormMappingData.delete(this, strAD_Model_Object_Mapping_ID, strPAD_Model_Object_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strAD_Model_Object_Mapping_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (FormMappingData.deleteTransactional(conn, this, strKey, strPAD_Model_Object_ID)==0) {
...
*/
  private FormMappingData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Model_Object_ID) throws IOException,ServletException {
    FormMappingData data = new FormMappingData();
   ...
   private FormMappingData[] getRelationData(FormMappingData[] data) {
    if (data!=null) {
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPAD_Model_Object_ID) throws IOException,ServletException {
      FormClassData[] data = FormClassData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getSessionValue(windowId + "|AD_Form_ID"), strPAD_Model_Object_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Model_Object_Mapping_ID) throws ServletException {
    String strPAD_Model_Object_ID = FormMappingData.selectParentID(this, strAD_Model_Object_Mapping_ID);
    if (strPAD_Model_Object_ID.equals("")) {
...
String strParamMappingName = vars.getSessionValue(tabId + "|paramMappingName");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Form/FormMapping_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "FormMapping", false, "document.frmMain.inpadModelObjectMappingId", "grid", "..", "".equals("Y"), "Form", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "FormMapping_Relation.html", "Form", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "FormMapping_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", FormMappingData.selectParent(this, strPAD_Model_Object_ID));
    else xmlDocument.setParameter("parent", FormMappingData.selectParentTrl(this, strPAD_Model_Object_ID));
...
String strParamMappingName = vars.getSessionValue(tabId + "|paramMappingName");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = FormMappingData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Model_Object_ID, strAD_Model_Object_Mapping_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = FormMappingData.set(strPAD_Model_Object_ID, "0", "0", Utility.getDefault(this, vars, "MappingName", "", "187", "800196", "", dataField), Utility.getDefault(this, vars, "IsDefault", "N", "187", "800196", "N", dataField), "", Utility.getDefault(this, vars, "Createdby", "", "187", "800196", "", dataField), FormMappingData.selectDef802462_0(this, Utility.getDefault(this, vars, "Createdby", "", "187", "800196", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "187", "800196", "", dataField), FormMappingData.selectDef802464_1(this, Utility.getDefault(this, vars, "Updatedby", "", "187", "800196", "", dataField)), "Y");
        
      }
    } else {
      data = new FormMappingData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(FormMappingData) ref1;
      data[0].created="";
      data[0].updated="";
    }
      
    String currentPOrg=FormClassData.selectOrg(this, strPAD_Model_Object_ID);
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "FormMapping", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpadModelObjectMappingId", "", "..", "".equals("Y"), "Form", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strAD_Model_Object_Mapping_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (FormMappingData.getCurrentDBTimestamp(this, data.adModelObjectMappingId).equals(
  ...
  public String getServletInfo() {
    return "Servlet FormMapping. This Servlet was made by Wad constructor";

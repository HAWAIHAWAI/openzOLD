...
public class Customer extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Customer.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Customer.view", "EDIT");

        printPageEdit(response, request, vars, false, strC_BPartner_ID, strPC_BPartner_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Customer.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamAD_Org_ID", tabId + "|paramAD_Org_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strC_BPartner_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Customer.view", strView);
        }
      }
...
vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");
      ...
      vars.setSessionValue(tabId + "|Customer.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPC_BPartner_ID = vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Customer.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Customer.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|C_BPartner_ID");
      vars.setSessionValue(windowId + "|C_BPartner_ID", strPC_BPartner_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strC_BPartner_ID = vars.getRequiredStringParameter("inpcBpartnerId");
      //CustomerData data = getEditVariables(vars, strPC_BPartner_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = CustomerData.delete(this, strC_BPartner_ID, strPC_BPartner_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strC_BPartner_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (CustomerData.deleteTransactional(conn, this, strKey, strPC_BPartner_ID)==0) {
...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strC_BPartner_ID) throws ServletException {
    String strPC_BPartner_ID = CustomerData.selectParentID(this, strC_BPartner_ID);
    if (strPC_BPartner_ID.equals("")) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|Value", data[0].getField("value"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|C_BPartner_ID", data[0].getField("cBpartnerId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars, String strPC_BPartner_ID) throws IOException,ServletException {
      CustomerData[] data = CustomerData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_BPartner_ID, vars.getStringParameter("inpcBpartnerId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamAD_Org_ID = vars.getSessionValue(tabId + "|paramAD_Org_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/BusinessPartner/Customer_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Customer", false, "document.frmMain.inpcBpartnerId", "grid", "..", "".equals("Y"), "BusinessPartner", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Customer_Relation.html", "BusinessPartner", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Customer_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", CustomerData.selectParent(this, strPC_BPartner_ID));
    else xmlDocument.setParameter("parent", CustomerData.selectParentTrl(this, strPC_BPartner_ID));
...
String strParamAD_Org_ID = vars.getSessionValue(tabId + "|paramAD_Org_ID");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = CustomerData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_BPartner_ID, strC_BPartner_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = CustomerData.set(strPC_BPartner_ID, CustomerData.selectDef2901(this, Utility.getContext(this, vars, "AD_ORG_ID", "123")), Utility.getDefault(this, vars, "DocumentCopies", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "IsCustomer", "N", "123", "223", "N", dataField), Utility.getDefault(this, vars, "Fixmonthday3", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "Name", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "InvoiceRule", "I", "123", "223", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "123", "223", "", dataField), CustomerData.selectDef2898_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "123", "223", "", dataField)), Utility.getDefault(this, vars, "IsDiscountPrinted", "", "123", "223", "N", dataField), Utility.getDefault(this, vars, "Isecommerceactive", "Y", "123", "223", "N", dataField), Utility.getDefault(this, vars, "FixMonthDay", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "SO_CreditLimit", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "PaymentRule", "R", "123", "223", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "123", "223", "", dataField), CustomerData.selectDef2900_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "123", "223", "", dataField)), Utility.getDefault(this, vars, "SO_Description", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "123", "223", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "FixMonthDay2", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "SO_CreditUsed", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "Invoicegrouping", "000000000000000", "123", "223", "", dataField), Utility.getDefault(this, vars, "SO_Bankaccount_ID", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "DeliveryRule", "A", "123", "223", "", dataField), Utility.getDefault(this, vars, "POReference", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "C_InvoiceSchedule_ID", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "123", "223", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "123", "223", "", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "D", "123", "223", "", dataField));
        
      }
    } else {
      data = new CustomerData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(CustomerData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Customer", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcBpartnerId", "", "..", "".equals("Y"), "BusinessPartner", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_BPartner_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (CustomerData.getCurrentDBTimestamp(this, data.cBpartnerId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Customer. This Servlet was made by Wad constructor";

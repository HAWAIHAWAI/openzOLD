...
/**
 * Entity class for entity BusinessPartnerTreeNode (stored in table AD_TreeNodeBP).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class BusinessPartnerTreeNode extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "AD_TreeNodeBP";
    public static final String ENTITY_NAME = "BusinessPartnerTreeNode";
    ...
    public BusinessPartnerTreeNode() {
    ...
    public String getParent() {
        return (String) get(PROPERTY_PARENT);
    }

...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strC_Debt_Payment_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|C_Debt_Payment_ID", data[0].getField("cDebtPaymentId"));
    }
...
String strParamAmount_f = vars.getSessionValue(tabId + "|paramAmount_f");
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "CreatedPayments", false, "document.frmMain.inpcDebtPaymentId", "grid", "../RptPromissoryNote.pdf", "N".equals("Y"), "Settlement", strReplaceWith, false);
...
String strParamAmount_f = vars.getSessionValue(tabId + "|paramAmount_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = CreatedPaymentsData.set(strPC_Settlement_ID, Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "Dateplanned", "@#Date@", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "IsPaid", "", "800005", "800027", "N", dataField), "", Utility.getDefault(this, vars, "C_Invoice_ID", "", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "Description", "", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "Discountamt", "", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "800005", "800027", "", dataField), CreatedPaymentsData.selectDef800377_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "800005", "800027", "", dataField)), Utility.getDefault(this, vars, "C_BankStatementLine_ID", "", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "IsValid", "", "800005", "800027", "N", dataField), Utility.getDefault(this, vars, "PaymentRule", "", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "WriteOffAmt", "0", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "C_Settlement_Cancel_ID", "", "800005", "800027", "", dataField), "Y", Utility.getDefault(this, vars, "IsReceipt", "Y", "800005", "800027", "N", dataField), Utility.getDefault(this, vars, "C_CashBook_ID", "", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "IsManual", "@MANUAL@", "800005", "800027", "N", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800005", "800027", "", dataField), CreatedPaymentsData.selectDef800384_1(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800005", "800027", "", dataField)), Utility.getDefault(this, vars, "Isdirectposting", "", "800005", "800027", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "800005", "800027", "", dataField), CreatedPaymentsData.selectDef800379_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "800005", "800027", "", dataField)), Utility.getDefault(this, vars, "Amount", "", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "Generate_Processed", "", "800005", "800027", "N", dataField), Utility.getDefault(this, vars, "C_BankAccount_ID", "", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "C_CashLine_ID", "", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "800005", "800027", "", dataField), Utility.getDefault(this, vars, "Created", "", "800005", "800027", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "CreatedPayments", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcDebtPaymentId", "", "../RptPromissoryNote.pdf", "N".equals("Y"), "Settlement", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Debt_Payment_ID));

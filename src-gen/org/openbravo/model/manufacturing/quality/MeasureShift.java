 ...
 */
public class MeasureShift extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_MEASUREDATE = "measuredate";
    ...
    public static final String PROPERTY_MANUFACTURINGMEASUREGROUPLIST =
        "manufacturingMeasureGroupList";

    public MeasureShift() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_EDIT, false);
        setDefaultValue(PROPERTY_PROCESSED, false);
        setDefaultValue(PROPERTY_MANUFACTURINGMEASUREGROUPLIST,
    ...
    public Date getMeasuredate() {
        return (Date) get(PROPERTY_MEASUREDATE);
    }

    public void setMeasuredate(Date measuredate) {
        set(PROPERTY_MEASUREDATE, measuredate);
    }
    ...
    public Boolean isEdit() {
        return (Boolean) get(PROPERTY_EDIT);
    }

    public void setEdit(Boolean edit) {
        set(PROPERTY_EDIT, edit);
    }
    ...
    public void setManufacturingMeasureGroupList(
        List<MeasureGroup> manufacturingMeasureGroupList) {
        set(PROPERTY_MANUFACTURINGMEASUREGROUPLIST,
            manufacturingMeasureGroupList);
    }
}

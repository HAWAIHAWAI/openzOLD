 ...
 */
public class Toolset extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_NUMBERUSES = "numberuses";
    public static final String PROPERTY_DISCARDED = "discarded";

    public Toolset() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_NUMBERUSES, new BigDecimal(0));
    ...
    public BigDecimal getNumberuses() {
        return (BigDecimal) get(PROPERTY_NUMBERUSES);
    }

    public void setNumberuses(BigDecimal numberuses) {
        set(PROPERTY_NUMBERUSES, numberuses);
    }

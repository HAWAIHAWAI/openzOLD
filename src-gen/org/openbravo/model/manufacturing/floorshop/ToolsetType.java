 ...
 */
public class ToolsetType extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_MANUFACTURINGTOOLSETLIST =
        "manufacturingToolsetList";

    public ToolsetType() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_MANUFACTURINGTOOLSETLIST,
    ...
    public void setManufacturingToolsetList(
        List<Toolset> manufacturingToolsetList) {

...
*/
  private InformationData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private InformationData[] getRelationData(InformationData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 20);        data[i].adTreeOrgId = FormatUtilities.truncate(data[i].adTreeOrgId, 20);        data[i].adTreeMenuId = FormatUtilities.truncate(data[i].adTreeMenuId, 20);        data[i].adTreeBpartnerId = FormatUtilities.truncate(data[i].adTreeBpartnerId, 20);        data[i].adTreeProductId = FormatUtilities.truncate(data[i].adTreeProductId, 20);        data[i].adTreeProjectId = FormatUtilities.truncate(data[i].adTreeProjectId, 20);        data[i].adTreeSalesregionId = FormatUtilities.truncate(data[i].adTreeSalesregionId, 20);        data[i].yourCompanyBigImage = FormatUtilities.truncate(data[i].yourCompanyBigImage, 10);        data[i].yourCompanyDocumentImage = FormatUtilities.truncate(data[i].yourCompanyDocumentImage, 10);        data[i].yourCompanyMenuImage = FormatUtilities.truncate(data[i].yourCompanyMenuImage, 32);        data[i].mProductfreightId = FormatUtilities.truncate(data[i].mProductfreightId, 20);        data[i].cBpartnercashtrxId = FormatUtilities.truncate(data[i].cBpartnercashtrxId, 20);        data[i].mPricelistId = FormatUtilities.truncate(data[i].mPricelistId, 20);        data[i].cUomTimeId = FormatUtilities.truncate(data[i].cUomTimeId, 10);        data[i].cUomLengthId = FormatUtilities.truncate(data[i].cUomLengthId, 10);        data[i].cUomWeightId = FormatUtilities.truncate(data[i].cUomWeightId, 10);        data[i].cCalendarId = FormatUtilities.truncate(data[i].cCalendarId, 20);        data[i].cAcctschema1Id = FormatUtilities.truncate(data[i].cAcctschema1Id, 44);        data[i].cAcctschema2Id = FormatUtilities.truncate(data[i].cAcctschema2Id, 44);        data[i].cAcctschema3Id = FormatUtilities.truncate(data[i].cAcctschema3Id, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cUomVolumeId = FormatUtilities.truncate(data[i].cUomVolumeId, 10);}
    }
    return data;
  }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Client_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = InformationData.set(Utility.getDefault(this, vars, "Your_Company_Document_Image", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "109", "169", "", dataField), Utility.getDefault(this, vars, "M_ProductFreight_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "Your_Company_Menu_Image", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "C_UOM_Weight_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "AllowNegativeStock", "Y", "109", "169", "N", dataField), "Y", Utility.getDefault(this, vars, "UpdatedBy", "", "109", "169", "", dataField), InformationData.selectDef1989_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "109", "169", "", dataField)), Utility.getDefault(this, vars, "M_PriceList_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "C_Calendar_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "C_AcctSchema3_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "AD_Tree_Menu_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "Checkorderorg", "Y", "109", "169", "N", dataField), Utility.getDefault(this, vars, "AD_Tree_Org_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "IsDiscountLineAmt", "", "109", "169", "N", dataField), Utility.getDefault(this, vars, "Groupacctinvlines", "N", "109", "169", "N", dataField), Utility.getDefault(this, vars, "C_AcctSchema2_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "Acct2_Active", "", "109", "169", "N", dataField), Utility.getDefault(this, vars, "AD_Tree_SalesRegion_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "Checkinoutorg", "Y", "109", "169", "N", dataField), Utility.getDefault(this, vars, "Acct3_Active", "", "109", "169", "N", dataField), Utility.getDefault(this, vars, "C_UOM_Time_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "C_AcctSchema1_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "AD_Tree_Product_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "109", "169", "", dataField), InformationData.selectDef1987_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "109", "169", "", dataField)), Utility.getDefault(this, vars, "AD_Tree_BPartner_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "C_BPartnerCashTrx_ID", "", "109", "169", "", dataField), "0", Utility.getDefault(this, vars, "C_UOM_Length_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "Your_Company_Big_Image", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "C_UOM_Volume_ID", "", "109", "169", "", dataField), Utility.getDefault(this, vars, "AD_Tree_Project_ID", "", "109", "169", "", dataField));

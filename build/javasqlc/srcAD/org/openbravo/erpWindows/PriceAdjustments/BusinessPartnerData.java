...
static Logger log4j = Logger.getLogger(BusinessPartnerData.class);
  ...
  public String mOfferBpartnerId;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return updatedbyr;
    else if (fieldName.equalsIgnoreCase("m_offer_bpartner_id") || fieldName.equals("mOfferBpartnerId"))
...
Select for edit
 */
  public static BusinessPartnerData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mOfferId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static BusinessPartnerData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mOfferId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((mOfferId==null || mOfferId.equals(""))?"":"  AND M_Offer_BPartner.M_Offer_ID = ?  ");
    strSql = strSql + 
      "        AND M_Offer_BPartner.M_Offer_Bpartner_ID = ? " +
      "        AND M_Offer_BPartner.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ") " +
      "           AND M_Offer_BPartner.AD_Org_ID IN (";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectBusinessPartnerData.mOfferBpartnerId = UtilSql.getValue(result, "m_offer_bpartner_id");
        ...
        objectBusinessPartnerData.mOfferId = UtilSql.getValue(result, "m_offer_id");
        objectBusinessPartnerData.mOfferIdr = UtilSql.getValue(result, "m_offer_idr");
        ...
        objectBusinessPartnerData.cBpartnerIdr = UtilSql.getValue(result, "c_bpartner_idr");
...
Create a registry
 */
  public static BusinessPartnerData[] set(String mOfferId, String adClientId, String cBpartnerId, String cBpartnerIdr, String createdby, String createdbyr, String isactive, String updatedby, String updatedbyr, String adOrgId, String mOfferBpartnerId)    throws ServletException {
    ...
    objectBusinessPartnerData[0].mOfferBpartnerId = mOfferBpartnerId;
    ...
    objectBusinessPartnerData[0].mOfferId = mOfferId;
    objectBusinessPartnerData[0].mOfferIdr = "";
    objectBusinessPartnerData[0].isactive = isactive;
    objectBusinessPartnerData[0].cBpartnerId = cBpartnerId;
    objectBusinessPartnerData[0].cBpartnerIdr = cBpartnerIdr;
 ...
 */
  public static String selectDef801132_0(ConnectionProvider connectionProvider, String C_BPartner_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef801128_1(ConnectionProvider connectionProvider, String CreatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef801130_2(ConnectionProvider connectionProvider, String UpdatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, mOfferBpartnerId);

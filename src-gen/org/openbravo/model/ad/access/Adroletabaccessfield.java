...
/**
 * Entity class for entity ad_role_tabaccess_field (stored in table ad_role_tabaccess_field).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Adroletabaccessfield extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ad_role_tabaccess_field";
    public static final String ENTITY_NAME = "ad_role_tabaccess_field";
    public static final String PROPERTY_ID = "id";
    public static final String PROPERTY_FIELD = "field";
    public static final String PROPERTY_ROLETABACCESS = "roleTabaccess";
    ...
    public Adroletabaccess getRoleTabaccess() {
        return (Adroletabaccess) get(PROPERTY_ROLETABACCESS);
    }

    public void setRoleTabaccess(Adroletabaccess roleTabaccess) {
        set(PROPERTY_ROLETABACCESS, roleTabaccess);
    }

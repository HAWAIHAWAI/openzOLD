 ...
 */
public class Calendar extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_FINANCIALMGMTYEARLIST =
        "financialMgmtYearList";
    public static final String PROPERTY_FINANCIALMGMTNONBUSINESSDAYLIST =
        "financialMgmtNonBusinessDayList";

    public Calendar() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_FINANCIALMGMTYEARLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_FINANCIALMGMTNONBUSINESSDAYLIST,
    ...
    public void setFinancialMgmtNonBusinessDayList(
        List<NonBusinessDay> financialMgmtNonBusinessDayList) {
        set(PROPERTY_FINANCIALMGMTNONBUSINESSDAYLIST,
            financialMgmtNonBusinessDayList);
    }
}

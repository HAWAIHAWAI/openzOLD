...
/**
 * Entity class for entity zssm_productionorder_v (stored in table zssm_productionorder_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zssm_productionorder_v extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zssm_productionorder_v";
    public static final String ENTITY_NAME = "zssm_productionorder_v";
    ...
    public static final String PROPERTY_ZSSMWORKSTEPVLIST = "zssmWorkstepVList";
    public static final String PROPERTY_ZSPMMATERIALMOVEMENTSVIEWLIST =
        "zspmMaterialmovementsViewList";
    public static final String PROPERTY_ZSSMPRODUCTIONORDERTASKDEPVLIST =
        "zssmProductionorderTaskdepVList";
    public static final String PROPERTY_ZSSMFEEDBACKVLIST = "zssmFeedbackVList";

    public zssm_productionorder_v() {
        ...
        setDefaultValue(PROPERTY_ACTUALCOSTAMOUNT, new BigDecimal(0));
        setDefaultValue(PROPERTY_CLOSEPROJECT, false);
        setDefaultValue(PROPERTY_REOPENPROJECT, false);
        setDefaultValue(PROPERTY_ZSSMWORKSTEPVLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_ZSPMMATERIALMOVEMENTSVIEWLIST,
            new ArrayList<Object>());
        setDefaultValue(PROPERTY_ZSSMPRODUCTIONORDERTASKDEPVLIST,
            new ArrayList<Object>());
    ...
    public List<org.openbravo.zsoft.serprod.zssm_workstep_v> getZssmWorkstepVList() {
        return (List<org.openbravo.zsoft.serprod.zssm_workstep_v>) get(PROPERTY_ZSSMWORKSTEPVLIST);
    }

    public void setZssmWorkstepVList(
        List<org.openbravo.zsoft.serprod.zssm_workstep_v> zssmWorkstepVList) {
        set(PROPERTY_ZSSMWORKSTEPVLIST, zssmWorkstepVList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.zsoft.serprod.zssm_productionorder_taskdep_v> getZssmProductionorderTaskdepVList() {
        return (List<org.openbravo.zsoft.serprod.zssm_productionorder_taskdep_v>) get(PROPERTY_ZSSMPRODUCTIONORDERTASKDEPVLIST);
    }

    public void setZssmProductionorderTaskdepVList(
        List<org.openbravo.zsoft.serprod.zssm_productionorder_taskdep_v> zssmProductionorderTaskdepVList) {
        set(PROPERTY_ZSSMPRODUCTIONORDERTASKDEPVLIST,
            zssmProductionorderTaskdepVList);
    }

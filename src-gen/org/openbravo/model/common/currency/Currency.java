 ...
 */
public class Currency extends BaseOBObject implements ClientEnabled {
    ...
    public Boolean isSymbolrightside() {
        return (Boolean) get(PROPERTY_ISSYMBOLRIGHTSIDE);
    }

    public void setSymbolrightside(Boolean issymbolrightside) {
        set(PROPERTY_ISSYMBOLRIGHTSIDE, issymbolrightside);
    }

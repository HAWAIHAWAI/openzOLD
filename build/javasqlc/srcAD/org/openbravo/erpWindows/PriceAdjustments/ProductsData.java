  ...
  public static ProductsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mOfferId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductsData.adClientIdr = UtilSql.getValue(result, "ad_client_idr");
        objectProductsData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        objectProductsData.adOrgIdr = UtilSql.getValue(result, "ad_org_idr");
...
Create a registry
 */
  public static ProductsData[] set(String mOfferId, String adOrgId, String mOfferProductId, String mProductId, String mProductIdr, String isactive, String updatedby, String updatedbyr, String createdby, String createdbyr, String adClientId)    throws ServletException {
    ...
    objectProductsData[0].adClientIdr = "";
    objectProductsData[0].adOrgId = adOrgId;
    objectProductsData[0].adOrgIdr = "";

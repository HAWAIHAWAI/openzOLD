...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strZssm_Productionplan_Taskdep_V_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|Zssm_Productionplan_Taskdep_V_ID", data[0].getField("zssmProductionplanTaskdepVId"));
    }

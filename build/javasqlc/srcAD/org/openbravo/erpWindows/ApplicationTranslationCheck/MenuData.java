...
static Logger log4j = Logger.getLogger(MenuData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return updatedbyr;
    else if (fieldName.equalsIgnoreCase("ad_menu_trl_id") || fieldName.equals("adMenuTrlId"))
      return adMenuTrlId;
...
Select for edit
 */
  public static MenuData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adLanguage, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static MenuData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((adLanguage==null || adLanguage.equals(""))?"":"  AND AD_Menu_Trl.AD_Language = ?  ");
    strSql = strSql + 
      "        AND AD_Menu_Trl.AD_Menu_Trl_ID = ? " +
      "        AND AD_Menu_Trl.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ") " +
      "           AND AD_Menu_Trl.AD_Org_ID IN (";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectMenuData.adMenuTrlId = UtilSql.getValue(result, "ad_menu_trl_id");
        ...
        objectMenuData.adMenuIdr = UtilSql.getValue(result, "ad_menu_idr");
        objectMenuData.adLanguage = UtilSql.getValue(result, "ad_language");
        objectMenuData.adLanguager = UtilSql.getValue(result, "ad_languager");
        objectMenuData.isactive = UtilSql.getValue(result, "isactive");
        objectMenuData.istranslated = UtilSql.getValue(result, "istranslated");
...
Create a registry
 */
  public static MenuData[] set(String adLanguage, String adClientId, String isactive, String adMenuTrlId, String istranslated, String name, String adMenuId, String description, String adOrgId, String createdby, String createdbyr, String updatedby, String updatedbyr)    throws ServletException {
    ...
    objectMenuData[0].adMenuTrlId = adMenuTrlId;
    ...
    objectMenuData[0].adMenuIdr = "";
    objectMenuData[0].adLanguage = adLanguage;
    objectMenuData[0].adLanguager = "";
    objectMenuData[0].isactive = isactive;
    objectMenuData[0].istranslated = istranslated;
 ...
 */
  public static String selectDef638_0(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef640_1(ConnectionProvider connectionProvider, String UpdatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, adMenuTrlId);

...
/**
 * Entity class for entity C_User_Department (stored in table C_User_Department).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class CUserDepartment extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "C_User_Department";
    public static final String ENTITY_NAME = "C_User_Department";

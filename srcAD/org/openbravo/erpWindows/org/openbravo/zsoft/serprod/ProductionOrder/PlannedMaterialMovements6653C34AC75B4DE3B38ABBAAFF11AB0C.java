...
public class PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C.class);
  
  private static final String windowId = "A2BEBB9B07564D2AAA372B4CB2D01165";
  private static final String tabId = "6653C34AC75B4DE3B38ABBAAFF11AB0C";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C.view", "EDIT");

        printPageEdit(response, request, vars, false, strMRP_Inoutplan_V_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamPlanneddate_f", tabId + "|paramPlanneddate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strMRP_Inoutplan_V_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|MRP_Inoutplan_V_ID");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strMRP_Inoutplan_V_ID = vars.getRequiredStringParameter("inpmrpInoutplanVId");
      //PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData.delete(this, strMRP_Inoutplan_V_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strMRP_Inoutplan_V_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData.deleteTransactional(conn, this, strKey)==0) {
...
*/
  private PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData data = new PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData();
   ...
   private PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData[] getRelationData(PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData[] data) {
    if (data!=null) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData[] data = PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "Zssm_Productionorder_V_ID", windowId), vars.getStringParameter("inpmrpInoutplanVId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamPlanneddate_f = vars.getSessionValue(tabId + "|paramPlanneddate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/openbravo/zsoft/serprod/ProductionOrder/PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C", false, "document.frmMain.inpmrpInoutplanVId", "grid", "..", "".equals("Y"), "ProductionOrder", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C_Relation.html", "ProductionOrder", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strMRP_Inoutplan_V_ID, TableSQLData tableSQL)
    ...
    PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData[] data=null;
...
String strParamPlanneddate_f = vars.getSessionValue(tabId + "|paramPlanneddate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "Zssm_Productionorder_V_ID", windowId), strMRP_Inoutplan_V_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData.set(Utility.getDefault(this, vars, "Updatedby", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData.selectDef2F04CE6BDC284E2C80162ECBDD4A2984_0(this, Utility.getDefault(this, vars, "Updatedby", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField)), Utility.getDefault(this, vars, "Documenttype", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), "Y", Utility.getDefault(this, vars, "Estimated_Stock_Qty", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData.selectDefF082229707444D7BB13B9D59C0DD1B08_1(this, Utility.getDefault(this, vars, "Createdby", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField)), Utility.getDefault(this, vars, "Movementqty", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), "", Utility.getDefault(this, vars, "C_Bpartner_ID", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData.selectDefB92C73B63EE140898CC7EE877DE8A96E_2(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField)), Utility.getDefault(this, vars, "C_Uom_ID", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData.selectDef7719E258DAF24AE1BDEE48E95ECCA4AE_3(this, Utility.getDefault(this, vars, "M_Product_ID", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField)), Utility.getDefault(this, vars, "Zssi_Onhanqty_Overview_ID", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), Utility.getDefault(this, vars, "Planneddate", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), Utility.getDefault(this, vars, "C_Orderline_ID", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField), Utility.getDefault(this, vars, "M_Product_Category_ID", "", "A2BEBB9B07564D2AAA372B4CB2D01165", "6653C34AC75B4DE3B38ABBAAFF11AB0C", "", dataField));
        
      }
    } else {
      data = new PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmrpInoutplanVId", "", "..", "".equals("Y"), "ProductionOrder", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strMRP_Inoutplan_V_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0CData.getCurrentDBTimestamp(this, data.mrpInoutplanVId).equals(
  ...
  public String getServletInfo() {
    return "Servlet PlannedMaterialMovements6653C34AC75B4DE3B38ABBAAFF11AB0C. This Servlet was made by Wad constructor";

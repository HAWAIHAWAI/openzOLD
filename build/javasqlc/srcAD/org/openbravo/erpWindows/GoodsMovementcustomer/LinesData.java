...
static Logger log4j = Logger.getLogger(LinesData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return movementqty;
    else if (fieldName.equalsIgnoreCase("boxnumber"))
      return boxnumber;
  ...
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mInoutId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLinesData.mInoutIdr = UtilSql.getValue(result, "m_inout_idr");
        ...
        objectLinesData.boxnumber = UtilSql.getValue(result, "boxnumber");
        ...
        objectLinesData.upc = UtilSql.getValue(result, "upc");
...
Create a registry
 */
  public static LinesData[] set(String mInoutId, String line, String movementqty, String mLocatorId, String mLocatorIdr, String mInoutlineId, String mInoutIdr, String cUomId, String mProductUomId, String updatedby, String updatedbyr, String cOrderlineId, String cOrderlineIdr, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String isdescription, String cProjecttaskId, String mProductId, String mProductIdr, String isinvoiced, String isactive, String quantityorder, String cProjectId, String cProjectIdr, String adOrgId, String boxnumber, String createdby, String createdbyr, String adClientId, String upc, String description)    throws ServletException {
    ...
    objectLinesData[0].mInoutIdr = mInoutIdr;
    ...
    objectLinesData[0].boxnumber = boxnumber;
...
Select for auxiliar field
 */
  public static String selectDef3538_1(ConnectionProvider connectionProvider, String M_InOut_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef3536_2(ConnectionProvider connectionProvider, String UpdatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefB219CD429DB14019BD3C1F903F141CD7(ConnectionProvider connectionProvider, String m_inout_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef3539_5(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefFBFB0E5EAC68403BAA422D3D2EBF1CB8(ConnectionProvider connectionProvider, String m_inout_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefFBFB0E5EAC68403BAA422D3D2EBF1CB8_6(ConnectionProvider connectionProvider, String C_Project_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef3534_7(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, boxnumber);

...
public class Transactions8508B665665C49A1ABA2A74BCFF23565 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Transactions8508B665665C49A1ABA2A74BCFF23565.class);
  
  private static final String windowId = "18C5A42061B9456085182F129F3F1832";
  private static final String tabId = "8508B665665C49A1ABA2A74BCFF23565";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strSNR_Serialnumbertracking_ID = vars.getGlobalVariable("inpsnrSerialnumbertrackingId", windowId + "|SNR_Serialnumbertracking_ID", "");
        ...
        strPSNR_Batchmasterdata_ID = getParentID(vars, strSNR_Serialnumbertracking_ID);
      ...
      String strView = vars.getSessionValue(tabId + "|Transactions8508B665665C49A1ABA2A74BCFF23565.view");
      if (strView.equals("")) {
      ...
      if (strView.equals("EDIT")) 
        ...
        printPageEdit(response, request, vars, false, strSNR_Serialnumbertracking_ID, strPSNR_Batchmasterdata_ID, tableSQL);

      else printPageDataSheet(response, vars, strPSNR_Batchmasterdata_ID, strSNR_Serialnumbertracking_ID, tableSQL);
      ...
      String strPSNR_Batchmasterdata_ID = getParentID(vars, strSNR_Serialnumbertracking_ID);
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Transactions8508B665665C49A1ABA2A74BCFF23565.view", "EDIT");

        printPageEdit(response, request, vars, false, strSNR_Serialnumbertracking_ID, strPSNR_Batchmasterdata_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Transactions8508B665665C49A1ABA2A74BCFF23565.view", "RELATION");
        printPageDataSheet(response, vars, strPSNR_Batchmasterdata_ID, strSNR_Serialnumbertracking_ID, tableSQL);
      }
...
vars.getRequestGlobalVariable("inpParamGuaranteedate_f", tabId + "|paramGuaranteedate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strSNR_Serialnumbertracking_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Transactions8508B665665C49A1ABA2A74BCFF23565.view", strView);
        }
      }
...
vars.getGlobalVariable("inpsnrBatchmasterdataId", windowId + "|SNR_Batchmasterdata_ID");
      ...
      vars.setSessionValue(tabId + "|Transactions8508B665665C49A1ABA2A74BCFF23565.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPSNR_Batchmasterdata_ID = vars.getGlobalVariable("inpsnrBatchmasterdataId", windowId + "|SNR_Batchmasterdata_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Transactions8508B665665C49A1ABA2A74BCFF23565.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Transactions8508B665665C49A1ABA2A74BCFF23565.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|SNR_Serialnumbertracking_ID");
      vars.setSessionValue(windowId + "|SNR_Batchmasterdata_ID", strPSNR_Batchmasterdata_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String message = deleteRelation(vars, strSNR_Serialnumbertracking_ID, strPSNR_Batchmasterdata_ID);
      if (!message.equals("")) {
      ...
      String strSNR_Serialnumbertracking_ID = vars.getRequiredStringParameter("inpsnrSerialnumbertrackingId");
      //Transactions8508B665665C49A1ABA2A74BCFF23565Data data = getEditVariables(vars, strPSNR_Batchmasterdata_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Transactions8508B665665C49A1ABA2A74BCFF23565Data.delete(this, strSNR_Serialnumbertracking_ID, strPSNR_Batchmasterdata_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
/*
  String deleteRelation(VariablesSecureApp vars, String strSNR_Serialnumbertracking_ID, String strPSNR_Batchmasterdata_ID) throws IOException, ServletException {
    ...
    try {
      ...
      if (!strSNR_Serialnumbertracking_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (Transactions8508B665665C49A1ABA2A74BCFF23565Data.deleteTransactional(conn, this, strKey, strPSNR_Batchmasterdata_ID)==0) {
...
*/
  private Transactions8508B665665C49A1ABA2A74BCFF23565Data getEditVariables(Connection con, VariablesSecureApp vars, String strPSNR_Batchmasterdata_ID) throws IOException,ServletException {
   ...
   private Transactions8508B665665C49A1ABA2A74BCFF23565Data[] getRelationData(Transactions8508B665665C49A1ABA2A74BCFF23565Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].lotnumber = FormatUtilities.truncate(data[i].lotnumber, 40);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].serialnumber = FormatUtilities.truncate(data[i].serialnumber, 40);        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 32);        data[i].mAttributesetinstanceId = FormatUtilities.truncate(data[i].mAttributesetinstanceId, 32);        data[i].mLocatorId = FormatUtilities.truncate(data[i].mLocatorId, 32);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 32);        data[i].cOrderlineId = FormatUtilities.truncate(data[i].cOrderlineId, 32);        data[i].movementtype = FormatUtilities.truncate(data[i].movementtype, 50);        data[i].mMovementId = FormatUtilities.truncate(data[i].mMovementId, 50);        data[i].mInventoryId = FormatUtilities.truncate(data[i].mInventoryId, 50);        data[i].mInoutId = FormatUtilities.truncate(data[i].mInoutId, -5);        data[i].mInternalConsumptionId = FormatUtilities.truncate(data[i].mInternalConsumptionId, -5);        data[i].mInoutlineId = FormatUtilities.truncate(data[i].mInoutlineId, -5);        data[i].rfidnumber = FormatUtilities.truncate(data[i].rfidnumber, 40);        data[i].mMovementlineId = FormatUtilities.truncate(data[i].mMovementlineId, 50);        data[i].mInternalConsumptionlineId = FormatUtilities.truncate(data[i].mInternalConsumptionlineId, -5);        data[i].mInventorylineId = FormatUtilities.truncate(data[i].mInventorylineId, 50);        data[i].snrSerialnumbertrackingId = FormatUtilities.truncate(data[i].snrSerialnumbertrackingId, 32);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, -5);        data[i].cProjecttaskId = FormatUtilities.truncate(data[i].cProjecttaskId, -5);        data[i].aAssetId = FormatUtilities.truncate(data[i].aAssetId, -5);        data[i].assemblyProductid = FormatUtilities.truncate(data[i].assemblyProductid, -5);        data[i].assemblySnr = FormatUtilities.truncate(data[i].assemblySnr, 40);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].docstatus = FormatUtilities.truncate(data[i].docstatus, 50);        data[i].snrBatchmasterdataId = FormatUtilities.truncate(data[i].snrBatchmasterdataId, 32);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPSNR_Batchmasterdata_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|SNR_Batchmasterdata_ID", data[0].snrBatchmasterdataId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|Batchnumber", data[0].batchnumber);
  ...
  private String getParentID(VariablesSecureApp vars, String strSNR_Serialnumbertracking_ID) throws ServletException {
    String strPSNR_Batchmasterdata_ID = Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectParentID(this, strSNR_Serialnumbertracking_ID);
    if (strPSNR_Batchmasterdata_ID.equals("")) {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPSNR_Batchmasterdata_ID, String strSNR_Serialnumbertracking_ID, TableSQLData tableSQL)
...
String strParamGuaranteedate_f = vars.getSessionValue(tabId + "|paramGuaranteedate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/zsoft/serial/BatchNumberTracking/Transactions8508B665665C49A1ABA2A74BCFF23565_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Transactions8508B665665C49A1ABA2A74BCFF23565", false, "document.frmMain.inpsnrSerialnumbertrackingId", "grid", "..", "".equals("Y"), "BatchNumberTracking", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Transactions8508B665665C49A1ABA2A74BCFF23565_Relation.html", "BatchNumberTracking", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Transactions8508B665665C49A1ABA2A74BCFF23565_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectParent(this, strPSNR_Batchmasterdata_ID));
    else xmlDocument.setParameter("parent", Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectParentTrl(this, strPSNR_Batchmasterdata_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strSNR_Serialnumbertracking_ID, String strPSNR_Batchmasterdata_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    ...
    Transactions8508B665665C49A1ABA2A74BCFF23565Data[] data=null;
...
String strParamGuaranteedate_f = vars.getSessionValue(tabId + "|paramGuaranteedate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPSNR_Batchmasterdata_ID, strSNR_Serialnumbertracking_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new Transactions8508B665665C49A1ABA2A74BCFF23565Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Transactions8508B665665C49A1ABA2A74BCFF23565Data.set(strPSNR_Batchmasterdata_ID, Utility.getDefault(this, vars, "Assembly_Productid", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDefA71F774962944D41B980C9C2D5B34669_0(this, Utility.getDefault(this, vars, "Assembly_Productid", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), Utility.getDefault(this, vars, "M_Inoutline_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDef90CAE05DF99641938BECABEA651659F3_1(this, Utility.getDefault(this, vars, "M_Inoutline_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), "", "Y", Utility.getDefault(this, vars, "C_Projecttask_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "M_Movement_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Description", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Quantity", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "M_Inventoryline_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Movementdate", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "M_Internal_Consumptionline_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Lotnumber", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Guaranteedate", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "M_Movementline_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDef775B3326D4104402A931CEDBFEA06933_2(this, Utility.getDefault(this, vars, "Createdby", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), Utility.getDefault(this, vars, "Movementtype", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "M_Internal_Consumption_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Assembly_Snr", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDefABA0AE095068430AAF34BB38C525657A_3(this, Utility.getDefault(this, vars, "Updatedby", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), Utility.getDefault(this, vars, "M_Inventory_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Guaranteedays", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "M_Attributesetinstance_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDefD6E8C36F2B8F4CC7AB52999AB9D274DA_4(this, Utility.getDefault(this, vars, "M_Attributesetinstance_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDefFE03AA8BA4B7448088819DDAB664189F_5(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), Utility.getDefault(this, vars, "M_Inout_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDefB78C46BB7000448EA0E2B35DF351ADC6_6(this, Utility.getDefault(this, vars, "M_Inout_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Rfidnumber", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Docstatus", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "Serialnumber", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Utility.getDefault(this, vars, "M_Locator_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDefC25C3D6A592D47C8B084245749AD006C_7(this, Utility.getDefault(this, vars, "M_Locator_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), Utility.getDefault(this, vars, "C_Project_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDef4F68001A1827490B8E25617CCFE9A835_8(this, Utility.getDefault(this, vars, "C_Project_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), Utility.getDefault(this, vars, "C_Orderline_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDef8E2C92CCC5F547E998DC56323ADBAB8F_9(this, Utility.getDefault(this, vars, "C_Orderline_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), Utility.getDefault(this, vars, "M_Product_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField), Transactions8508B665665C49A1ABA2A74BCFF23565Data.selectDefED4444A033624267A14E465923306FF7_10(this, Utility.getDefault(this, vars, "M_Product_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField)), Utility.getDefault(this, vars, "A_Asset_ID", "", "18C5A42061B9456085182F129F3F1832", "8508B665665C49A1ABA2A74BCFF23565", "", dataField));
        
      }
    } else {
      data = new Transactions8508B665665C49A1ABA2A74BCFF23565Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(Transactions8508B665665C49A1ABA2A74BCFF23565Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Transactions8508B665665C49A1ABA2A74BCFF23565", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpsnrSerialnumbertrackingId", "", "..", "".equals("Y"), "BatchNumberTracking", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strSNR_Serialnumbertracking_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Transactions8508B665665C49A1ABA2A74BCFF23565Data.getCurrentDBTimestamp(this, data.snrSerialnumbertrackingId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Transactions8508B665665C49A1ABA2A74BCFF23565. This Servlet was made by Wad constructor";

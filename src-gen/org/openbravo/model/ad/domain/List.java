 ...
 */
public class List extends BaseOBObject implements ClientEnabled {
    ...
    public java.util.List<Ad_ref_listinstance> getRefListinstanceList() {
        return (java.util.List<Ad_ref_listinstance>) get(PROPERTY_REFLISTINSTANCELIST);
    }

    public void setRefListinstanceList(
        java.util.List<Ad_ref_listinstance> refListinstanceList) {

...
public class Include extends HttpSecureAppServlet {
  ...
  private static final String tabId = "B30CF79CF71245339E94B4B332BAABF1";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Include.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Include.view", "EDIT");

        printPageEdit(response, request, vars, false, strAD_Module_Dependency_ID, strPAD_Module_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Include.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamStartVersion", tabId + "|paramStartVersion");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strAD_Module_Dependency_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Include.view", strView);
        }
      }
...
vars.getGlobalVariable("inpadModuleId", windowId + "|AD_Module_ID");
      ...
      vars.setSessionValue(tabId + "|Include.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPAD_Module_ID = vars.getGlobalVariable("inpadModuleId", windowId + "|AD_Module_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Include.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Include.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|AD_Module_Dependency_ID");
      vars.setSessionValue(windowId + "|AD_Module_ID", strPAD_Module_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strAD_Module_Dependency_ID = vars.getRequiredStringParameter("inpadModuleDependencyId");
      //IncludeData data = getEditVariables(vars, strPAD_Module_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = IncludeData.delete(this, strAD_Module_Dependency_ID, strPAD_Module_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strAD_Module_Dependency_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (IncludeData.deleteTransactional(conn, this, strKey, strPAD_Module_ID)==0) {
...
*/
  private IncludeData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Module_ID) throws IOException,ServletException {
    IncludeData data = new IncludeData();
    ServletException ex = null;
    try {
    data.adModuleDependencyId = vars.getRequestGlobalVariable("inpadModuleDependencyId", windowId + "|AD_Module_Dependency_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adClientIdr = vars.getStringParameter("inpadClientId_R");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.adModuleId = vars.getStringParameter("inpadModuleId");     data.adModuleIdr = vars.getStringParameter("inpadModuleId_R");     data.adDependentModuleId = vars.getStringParameter("inpadDependentModuleId");     data.adDependentModuleIdr = vars.getStringParameter("inpadDependentModuleId_R");     data.startversion = vars.getStringParameter("inpstartversion");     data.isincluded = vars.getStringParameter("inpisincluded", "N"); 
   ...
   private IncludeData[] getRelationData(IncludeData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adModuleDependencyId = FormatUtilities.truncate(data[i].adModuleDependencyId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].adModuleId = FormatUtilities.truncate(data[i].adModuleId, 32);        data[i].adDependentModuleId = FormatUtilities.truncate(data[i].adDependentModuleId, 32);        data[i].startversion = FormatUtilities.truncate(data[i].startversion, 10);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Module_Dependency_ID) throws ServletException {
    String strPAD_Module_ID = IncludeData.selectParentID(this, strAD_Module_Dependency_ID);
    if (strPAD_Module_ID.equals("")) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Module_Dependency_ID", data[0].getField("adModuleDependencyId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars, String strPAD_Module_ID) throws IOException,ServletException {
      IncludeData[] data = IncludeData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Module_ID, vars.getStringParameter("inpadModuleDependencyId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamStartVersion = vars.getSessionValue(tabId + "|paramStartVersion");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Module/Include_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Include", false, "document.frmMain.inpadModuleDependencyId", "grid", "..", "".equals("Y"), "Module", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Include_Relation.html", "Module", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Include_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", IncludeData.selectParent(this, strPAD_Module_ID));
    else xmlDocument.setParameter("parent", IncludeData.selectParentTrl(this, strPAD_Module_ID));
...
String strParamStartVersion = vars.getSessionValue(tabId + "|paramStartVersion");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = IncludeData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Module_ID, strAD_Module_Dependency_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = IncludeData.set(strPAD_Module_ID, Utility.getDefault(this, vars, "AD_Dependent_Module_ID", "", "D586192D06C14EC182B44CAD34CA4295", "B30CF79CF71245339E94B4B332BAABF1", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "D586192D06C14EC182B44CAD34CA4295", "B30CF79CF71245339E94B4B332BAABF1", "", dataField), "Y", "0", Utility.getDefault(this, vars, "StartVersion", "", "D586192D06C14EC182B44CAD34CA4295", "B30CF79CF71245339E94B4B332BAABF1", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "D586192D06C14EC182B44CAD34CA4295", "B30CF79CF71245339E94B4B332BAABF1", "", dataField), "", "0", Utility.getDefault(this, vars, "IsIncluded", "@IncludeModule@", "D586192D06C14EC182B44CAD34CA4295", "B30CF79CF71245339E94B4B332BAABF1", "N", dataField));
        
      }
    } else {
      data = new IncludeData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(IncludeData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Include", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpadModuleDependencyId", "", "..", "".equals("Y"), "Module", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strAD_Module_Dependency_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (IncludeData.getCurrentDBTimestamp(this, data.adModuleDependencyId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Include. This Servlet was made by Wad constructor";

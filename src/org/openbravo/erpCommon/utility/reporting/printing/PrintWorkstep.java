...
public class PrintWorkstep extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintWorkstep.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = new DocumentType("WORKSTEP","ZSSM_WORKSTEP_V","workstep/","Workstep",false,null,"c_getDefaultDocInfo");
    // The prefix PRINTORDERS is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTWORKSTEP";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpzssmWorkstepVId_R");
    if (strDocumentId.equals(""))
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpzssmWorkstepVId");

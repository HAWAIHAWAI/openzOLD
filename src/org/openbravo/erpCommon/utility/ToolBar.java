...
public class ToolBar {
  ...
  public void prepareEditionTemplate(boolean hasTree, boolean isFiltered, boolean isTest,
    ...
    //TODO  Use setEmail method for this! Has to be done From Window-Tab (fix in DD)
    if (pdf != null && !pdf.contains("orders") && !pdf.contains("invoices") && !pdf.contains("shipments")) {
      removeElement("EMAIL");
    }
    if (!hasTree)
      removeElement("TREE");
...
//      sbElement
//          .append(
//              "<td><a class=\"Main_ToolBar_text_relatedinfo\" href=\"#\" onclick=\""
...
//          .append(Utility.messageBD(conn, "Linked Items", language)).append("</a></td>\n");
    ...
    if (isReference)
      //sbElement.append("class=\"Main_ToolBar_textlabel_bg_right\" ");
    	sbElement.append("></td><td width=\"1\"><td ");

 ...
 */
public class InternalMovement extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_MOVEFROMTOLOCATOR = "moveFromToLocator";
    public static final String PROPERTY_DOCUMENTNO = "documentNo";
    public static final String PROPERTY_MATERIALMGMTINTERNALMOVEMENTLINELIST =
        "materialMgmtInternalMovementLineList";

    public InternalMovement() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_PROCESSED, false);
        setDefaultValue(PROPERTY_PROCESSING, false);
        setDefaultValue(PROPERTY_MOVEFROMTOLOCATOR, false);
        setDefaultValue(PROPERTY_MATERIALMGMTINTERNALMOVEMENTLINELIST,
    ...
    public Boolean isMoveFromToLocator() {
        return (Boolean) get(PROPERTY_MOVEFROMTOLOCATOR);
    }

    public void setMoveFromToLocator(Boolean moveFromToLocator) {
        set(PROPERTY_MOVEFROMTOLOCATOR, moveFromToLocator);
    }
    ...
    public void setMaterialMgmtInternalMovementLineList(
        List<InternalMovementLine> materialMgmtInternalMovementLineList) {
        set(PROPERTY_MATERIALMGMTINTERNALMOVEMENTLINELIST,
            materialMgmtInternalMovementLineList);
    }
}

...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String message = deleteRelation(vars, strAD_Ref_Gridcolumn_ID, strPAD_Ref_Group_ID);
      if (!message.equals("")) {
...
/*
  String deleteRelation(VariablesSecureApp vars, String strAD_Ref_Gridcolumn_ID, String strPAD_Ref_Group_ID) throws IOException, ServletException {
    ...
    try {
      ...
      if (!strAD_Ref_Gridcolumn_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (EditableGridColumnsData.deleteTransactional(conn, this, strKey, strPAD_Ref_Group_ID)==0) {
...
*/
  private EditableGridColumnsData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Ref_Group_ID) throws IOException,ServletException {
   ...
   private EditableGridColumnsData[] getRelationData(EditableGridColumnsData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adRefGroupId = FormatUtilities.truncate(data[i].adRefGroupId, 32);        data[i].adRefGridcolumnId = FormatUtilities.truncate(data[i].adRefGridcolumnId, 32);        data[i].name = FormatUtilities.truncate(data[i].name, 50);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].adElementId = FormatUtilities.truncate(data[i].adElementId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].adReferenceId = FormatUtilities.truncate(data[i].adReferenceId, 32);        data[i].headertext = FormatUtilities.truncate(data[i].headertext, 50);        data[i].colreference = FormatUtilities.truncate(data[i].colreference, 32);        data[i].referenceurl = FormatUtilities.truncate(data[i].referenceurl, 50);        data[i].adTableId = FormatUtilities.truncate(data[i].adTableId, 32);        data[i].adValRuleId = FormatUtilities.truncate(data[i].adValRuleId, 32);        data[i].template = FormatUtilities.truncate(data[i].template, 50);        data[i].defaultvalue = FormatUtilities.truncate(data[i].defaultvalue, 50);        data[i].onchangeevent = FormatUtilities.truncate(data[i].onchangeevent, 50);        data[i].readonlylogic = FormatUtilities.truncate(data[i].readonlylogic, 50);        data[i].mandantorylogic = FormatUtilities.truncate(data[i].mandantorylogic, 50);        data[i].rowkeysuffix = FormatUtilities.truncate(data[i].rowkeysuffix, 20);}
    }
    return data;
  }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Ref_Gridcolumn_ID, String strPAD_Ref_Group_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = EditableGridColumnsData.set(strPAD_Ref_Group_ID, Utility.getDefault(this, vars, "Updatedby", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), EditableGridColumnsData.selectDef80B39AFB5F564DDAA7D2333503751AD7_0(this, Utility.getDefault(this, vars, "Updatedby", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField)), Utility.getDefault(this, vars, "AD_Element_ID", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "Required", "N", "101", "6E35388135644A70A6A709039E338EA3", "N", dataField), Utility.getDefault(this, vars, "Onchangeevent", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "Issortable", "Y", "101", "6E35388135644A70A6A709039E338EA3", "N", dataField), Utility.getDefault(this, vars, "Mandantorylogic", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), "0", Utility.getDefault(this, vars, "Readonlylogic", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "Rowkeysuffix", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), EditableGridColumnsData.selectDefC531C9F2EC594BD280D6D97AFD0A60CC_1(this, Utility.getDefault(this, vars, "Createdby", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField)), Utility.getDefault(this, vars, "ReadOnly", "N", "101", "6E35388135644A70A6A709039E338EA3", "N", dataField), Utility.getDefault(this, vars, "Issplitgroup", "N", "101", "6E35388135644A70A6A709039E338EA3", "N", dataField), "0", "Y", Utility.getDefault(this, vars, "AD_Table_ID", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "Defaultvalue", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), EditableGridColumnsData.selectDef8C68026A92AE4C2FAE5001D12D74C6BE(this, strPAD_Ref_Group_ID), Utility.getDefault(this, vars, "Includesemptyitem", "N", "101", "6E35388135644A70A6A709039E338EA3", "N", dataField), Utility.getDefault(this, vars, "Colspan", "0", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), "", Utility.getDefault(this, vars, "Headertext", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "AD_Reference_ID", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "Isinheader", "N", "101", "6E35388135644A70A6A709039E338EA3", "N", dataField), Utility.getDefault(this, vars, "Issecondheader", "N", "101", "6E35388135644A70A6A709039E338EA3", "N", dataField), Utility.getDefault(this, vars, "Referenceurl", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "MaxLength", "0", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "Isdisplayed", "Y", "101", "6E35388135644A70A6A709039E338EA3", "N", dataField), Utility.getDefault(this, vars, "Isrowkey", "N", "101", "6E35388135644A70A6A709039E338EA3", "N", dataField), Utility.getDefault(this, vars, "colreference", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "Template", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "Name", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField), Utility.getDefault(this, vars, "AD_Val_Rule_ID", "", "101", "6E35388135644A70A6A709039E338EA3", "", dataField));

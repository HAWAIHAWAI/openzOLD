...
/**
 * Entity class for entity c_orgcalendar_v (stored in table c_orgcalendar_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class c_orgcalendar_v extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "c_orgcalendar_v";
    public static final String ENTITY_NAME = "c_orgcalendar_v";

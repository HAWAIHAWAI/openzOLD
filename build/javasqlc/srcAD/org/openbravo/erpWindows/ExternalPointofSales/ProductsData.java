...
static Logger log4j = Logger.getLogger(ProductsData.class);
  ...
  public String cExternalposProductId;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return updatedbyr;
    else if (fieldName.equalsIgnoreCase("c_externalpos_product_id") || fieldName.equals("cExternalposProductId"))
...
Select for edit
 */
  public static ProductsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cExternalposId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static ProductsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cExternalposId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((cExternalposId==null || cExternalposId.equals(""))?"":"  AND C_ExternalPOS_Product.C_Externalpos_ID = ?  ");
    strSql = strSql + 
      "        AND C_ExternalPOS_Product.C_Externalpos_Product_ID = ? " +
      "        AND C_ExternalPOS_Product.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ") " +
      "           AND C_ExternalPOS_Product.AD_Org_ID IN (";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductsData.cExternalposProductId = UtilSql.getValue(result, "c_externalpos_product_id");
        ...
        objectProductsData.cExternalposId = UtilSql.getValue(result, "c_externalpos_id");
        objectProductsData.cExternalposIdr = UtilSql.getValue(result, "c_externalpos_idr");
...
Create a registry
 */
  public static ProductsData[] set(String cExternalposId, String mProductId, String mProductIdr, String cExternalposProductId, String createdby, String createdbyr, String adClientId, String isactive, String adOrgId, String updatedby, String updatedbyr)    throws ServletException {
    ...
    objectProductsData[0].cExternalposProductId = cExternalposProductId;
    ...
    objectProductsData[0].cExternalposId = cExternalposId;
    objectProductsData[0].cExternalposIdr = "";
 ...
 */
  public static String selectDef803076_0(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef803072_1(ConnectionProvider connectionProvider, String CreatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef803074_2(ConnectionProvider connectionProvider, String UpdatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cExternalposProductId);

...
/**
 * Entity class for entity c_bpartner_org (stored in table c_bpartner_org).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class c_bpartner_org extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "c_bpartner_org";
    public static final String ENTITY_NAME = "c_bpartner_org";

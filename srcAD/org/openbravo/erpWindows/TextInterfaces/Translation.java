...
*/
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPAD_Textinterfaces_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Textinterfaces_ID", data[0].adTextinterfacesId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_TextInterfaces_Trl_ID, String strPAD_Textinterfaces_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = TranslationData.set(strPAD_Textinterfaces_ID, Utility.getDefault(this, vars, "AD_Language", "", "800068", "800168", "", dataField), "Y", Utility.getDefault(this, vars, "IsTranslated", "N", "800068", "800168", "N", dataField), "0", "0", "", Utility.getDefault(this, vars, "Createdby", "", "800068", "800168", "", dataField), TranslationData.selectDef802439_0(this, Utility.getDefault(this, vars, "Createdby", "", "800068", "800168", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "800068", "800168", "", dataField), TranslationData.selectDef802441_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800068", "800168", "", dataField)), Utility.getDefault(this, vars, "Text", "", "800068", "800168", "", dataField));

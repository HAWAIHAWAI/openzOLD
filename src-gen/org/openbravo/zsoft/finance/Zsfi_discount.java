...
/**
 * Entity class for entity zsfi_discount (stored in table zsfi_discount).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Zsfi_discount extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zsfi_discount";
    public static final String ENTITY_NAME = "zsfi_discount";

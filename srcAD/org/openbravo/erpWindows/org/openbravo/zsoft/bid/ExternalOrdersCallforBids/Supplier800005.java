...
public class Supplier800005 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Supplier800005.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Supplier800005.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Supplier800005.view", "EDIT");

        printPageEdit(response, request, vars, false, strC_Project_Vendor_ID, strPC_Project_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Supplier800005.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamC_BPartner_ID", tabId + "|paramC_BPartner_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strC_Project_Vendor_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Supplier800005.view", strView);
        }
      }
...
vars.getGlobalVariable("inpcProjectId", windowId + "|C_Project_ID");
      ...
      vars.setSessionValue(tabId + "|Supplier800005.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPC_Project_ID = vars.getGlobalVariable("inpcProjectId", windowId + "|C_Project_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Supplier800005.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Supplier800005.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|C_Project_Vendor_ID");
      vars.setSessionValue(windowId + "|C_Project_ID", strPC_Project_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strC_Project_Vendor_ID = vars.getRequiredInStringParameter("inpcProjectVendorId");
      String message = deleteRelation(vars, strC_Project_Vendor_ID, strPC_Project_ID);
      if (!message.equals("")) {
      ...
      String strC_Project_Vendor_ID = vars.getRequiredStringParameter("inpcProjectVendorId");
      //Supplier800005Data data = getEditVariables(vars, strPC_Project_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Supplier800005Data.delete(this, strC_Project_Vendor_ID, strPC_Project_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
/*
  String deleteRelation(VariablesSecureApp vars, String strC_Project_Vendor_ID, String strPC_Project_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strC_Project_Vendor_ID.startsWith("(")) strC_Project_Vendor_ID = strC_Project_Vendor_ID.substring(1, strC_Project_Vendor_ID.length()-1);
      if (!strC_Project_Vendor_ID.equals("")) {
        strC_Project_Vendor_ID = Replace.replace(strC_Project_Vendor_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strC_Project_Vendor_ID, ",", false);
        while (st.hasMoreTokens()) {
          String strKey = st.nextToken();
          if (Supplier800005Data.deleteTransactional(conn, this, strKey, strPC_Project_ID)==0) {
...
*/
  private Supplier800005Data getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Project_ID) throws IOException,ServletException {
    Supplier800005Data data = new Supplier800005Data();
    ServletException ex = null;
    try {
    data.cProjectVendorId = vars.getRequestGlobalVariable("inpcProjectVendorId", windowId + "|C_Project_Vendor_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adClientIdr = vars.getStringParameter("inpadClientId_R");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.note = vars.getStringParameter("inpnote");     data.mPricelistId = vars.getStringParameter("inpmPricelistId");     data.mPricelistIdr = vars.getStringParameter("inpmPricelistId_R");     data.generateorder = vars.getStringParameter("inpgenerateorder");     data.cIncotermsId = vars.getStringParameter("inpcIncotermsId");     data.cIncotermsIdr = vars.getStringParameter("inpcIncotermsId_R");     data.incotermsDescription = vars.getStringParameter("inpincotermsDescription");     data.mPricelistVersionId = vars.getStringParameter("inpmPricelistVersionId"); 
   ...
   private Supplier800005Data[] getRelationData(Supplier800005Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].cProjectVendorId = FormatUtilities.truncate(data[i].cProjectVendorId, 10);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, 44);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);        data[i].note = FormatUtilities.truncate(data[i].note, 50);        data[i].mPricelistId = FormatUtilities.truncate(data[i].mPricelistId, 44);        data[i].cIncotermsId = FormatUtilities.truncate(data[i].cIncotermsId, 44);        data[i].incotermsDescription = FormatUtilities.truncate(data[i].incotermsDescription, 50);        data[i].mPricelistVersionId = FormatUtilities.truncate(data[i].mPricelistVersionId, 44);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strC_Project_Vendor_ID) throws ServletException {
    String strPC_Project_ID = Supplier800005Data.selectParentID(this, strC_Project_Vendor_ID);
    if (strPC_Project_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPC_Project_ID) throws IOException,ServletException {
      Supplier800005Data[] data = Supplier800005Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_Project_ID, vars.getStringParameter("inpcProjectVendorId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamC_BPartner_ID = vars.getSessionValue(tabId + "|paramC_BPartner_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/openbravo/zsoft/bid/ExternalOrdersCallforBids/Supplier800005_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Supplier800005", false, "document.frmMain.inpcProjectVendorId", "grid", "..", "".equals("Y"), "ExternalOrdersCallforBids", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Supplier800005_Relation.html", "ExternalOrdersCallforBids", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Supplier800005_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", Supplier800005Data.selectParent(this, strPC_Project_ID));
    else xmlDocument.setParameter("parent", Supplier800005Data.selectParentTrl(this, strPC_Project_ID));
...
String strParamC_BPartner_ID = vars.getSessionValue(tabId + "|paramC_BPartner_ID");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Supplier800005Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_Project_ID, strC_Project_Vendor_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Supplier800005Data.set(strPC_Project_ID, Utility.getDefault(this, vars, "Note", "", "800001", "800005", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "800001", "800005", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "800001", "800005", "", dataField), Supplier800005Data.selectDef800084_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "800001", "800005", "", dataField)), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800001", "800005", "", dataField), Supplier800005Data.selectDef800086_1(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800001", "800005", "", dataField)), Utility.getDefault(this, vars, "Incoterms_Description", "", "800001", "800005", "", dataField), "Y", Utility.getDefault(this, vars, "M_PriceList_Version_ID", "", "800001", "800005", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800001", "800005", "", dataField), "", Utility.getDefault(this, vars, "C_Incoterms_ID", "", "800001", "800005", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800001", "800005", "", dataField), Utility.getDefault(this, vars, "GenerateOrder", "N", "800001", "800005", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "800001", "800005", "", dataField), Supplier800005Data.selectDef800082_2(this, Utility.getDefault(this, vars, "CreatedBy", "", "800001", "800005", "", dataField)));
        
      }
    } else {
      data = new Supplier800005Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(Supplier800005Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Supplier800005", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcProjectVendorId", "", "..", "".equals("Y"), "ExternalOrdersCallforBids", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Project_Vendor_ID));
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonGenerateOrder800006(HttpServletResponse response, VariablesSecureApp vars, String strC_Project_Vendor_ID, String strgenerateorder, String strProcessing)
    throws IOException, ServletException {
    ...
    Scripthelper script = new Scripthelper();
      ...
      try {
        String name= LocalizationUtils.getProcessTitle(this, "800006",vars.getLanguage());
        String info = LocalizationUtils.getProcessInfo(this, "800006" ,vars.getLanguage());
        if (! info.isEmpty())
        ...
        strFG=strFG + fh.prepareProcessParameters(this, vars, script,"800006" );
        String isDocAction=UtilsData.isProcessDocAction(this, "800006");
        if (Integer.parseInt(isDocAction)>0) {
            String strdocstatus=UtilsData.getDocStatus(this, "800002",strC_Project_Vendor_ID);
            FieldProvider[] dataDocAction = DocActionWorkflowOptions.docAction(this, vars, "", "", strdocstatus,"N",
            "800002", strC_Project_Vendor_ID);
            
            strFG=strFG + "<table cellspacing=\"0\" cellpadding=\"0\" class=\"Form_Table\"> <colgroup span=\"4\"></colgroup><tr><td colspan=\"4\"></td></tr><tr>";
            
            strFG=strFG + ConfigureSelectBox.doConfigure(this,vars,script,"docaction", 0,3,true,false,"", strgenerateorder, dataDocAction, "ID","",true,"");
        ...
        String isJasper=UtilsData.isProcessJasper(this, "800006");
        if (isJasper.equals("N"))
          strActionButtons= strActionButtons + ConfigureButton.doConfigure(this,vars,script,"buttonok",1,1,false, "ok",  "submitThisPage('SAVE_BUTTONGenerateOrder" + "800006" + "');", "","") + "";
        else
        ...
        strSkeleton=Replace.replace(strSkeleton,"ActionButton_Responser.html","Supplier800005_Edition.html");
        String strOutput=Replace.replace(strSkeleton, "@CONTENT@",info +  strFG +strActionButtons); 
        script.addSubmitPagePageSripts();
        
        script.addHiddenfield("inpadProcessId", "800006");
        script.addHiddenfield("inpKey",strC_Project_Vendor_ID);
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Supplier800005Data.getCurrentDBTimestamp(this, data.cProjectVendorId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cProjectVendorId, vars, this);
        } catch(Exception ex) {
  ...
  public String getServletInfo() {
    return "Servlet Supplier800005. This Servlet was made by Wad constructor";

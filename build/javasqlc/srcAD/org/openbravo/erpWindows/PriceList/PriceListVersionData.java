...
Create a registry
 */
  public static PriceListVersionData[] set(String mPricelistId, String description, String adOrgId, String mPricelistVersionBaseId, String isactive, String proccreate, String name, String mPricelistVersionGenerate, String createdby, String createdbyr, String mPricelistVersionId, String validfrom, String updatedby, String updatedbyr, String mDiscountschemaId, String adClientId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_DiscountSchema_ID = (?) , AD_Client_ID = (?) , M_Pricelist_Version_Generate = (?) , AD_Org_ID = (?) , M_PriceList_ID = (?) , Name = (?) , Description = (?) , ValidFrom = TO_DATE(?) , M_PriceList_Version_ID = (?) , ProcCreate = (?) , M_Pricelist_Version_Base_ID = (?) , IsActive = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_PriceList_Version.M_PriceList_Version_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_DiscountSchema_ID, AD_Client_ID, M_Pricelist_Version_Generate, AD_Org_ID, M_PriceList_ID, Name, Description, ValidFrom, M_PriceList_Version_ID, ProcCreate, M_Pricelist_Version_Base_ID, IsActive, created, createdby, updated, updatedBy)" +

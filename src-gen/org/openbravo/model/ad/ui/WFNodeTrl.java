...
/**
 * Entity class for entity ADWFNodeTrl (stored in table AD_WF_Node_Trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class WFNodeTrl extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "AD_WF_Node_Trl";
    public static final String ENTITY_NAME = "ADWFNodeTrl";

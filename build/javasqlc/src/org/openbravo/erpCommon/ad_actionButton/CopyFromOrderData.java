...
static Logger log4j = Logger.getLogger(CopyFromOrderData.class);
  ...
  public static CopyFromOrderData[] select(ConnectionProvider connectionProvider, String cBpartnerId, String mPricelistId, String dateOrdered, String issotrx, String lastDays)    throws ServletException {
    return select(connectionProvider, cBpartnerId, mPricelistId, dateOrdered, issotrx, lastDays, 0, 0);
  }

  public static CopyFromOrderData[] select(ConnectionProvider connectionProvider, String cBpartnerId, String mPricelistId, String dateOrdered, String issotrx, String lastDays, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 

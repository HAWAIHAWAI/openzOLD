...
import org.openbravo.model.common.plm.PerpetualInv;
 ...
 */
public class InventoryCount extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_UPDATEQTY = "updateQty";
    public static final String PROPERTY_GENERATELIST = "generateList";
    public static final String PROPERTY_PERPETUALINV = "perpetualInv";
    ...
    public static final String PROPERTY_MATERIALMGMTINVENTORYCOUNTLINELIST =
        "materialMgmtInventoryCountLineList";

    public InventoryCount() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_PROCESSED, false);
        setDefaultValue(PROPERTY_PROCESSING, false);
        setDefaultValue(PROPERTY_UPDATEQTY, false);
        setDefaultValue(PROPERTY_GENERATELIST, false);
        setDefaultValue(PROPERTY_MATERIALMGMTINVENTORYCOUNTLINELIST,
    ...
    public Boolean isUpdateQty() {
        return (Boolean) get(PROPERTY_UPDATEQTY);
    }

    public void setUpdateQty(Boolean updateQty) {
        set(PROPERTY_UPDATEQTY, updateQty);
    }
    ...
    public PerpetualInv getPerpetualInv() {
        return (PerpetualInv) get(PROPERTY_PERPETUALINV);
    }

    public void setPerpetualInv(PerpetualInv perpetualInv) {
        set(PROPERTY_PERPETUALINV, perpetualInv);
    }
    ...
    public void setMaterialMgmtInventoryCountLineList(
        List<InventoryCountLine> materialMgmtInventoryCountLineList) {
        set(PROPERTY_MATERIALMGMTINVENTORYCOUNTLINELIST,
            materialMgmtInventoryCountLineList);
    }
}

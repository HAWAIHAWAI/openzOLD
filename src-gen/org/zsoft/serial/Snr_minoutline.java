...
/**
 * Entity class for entity snr_minoutline (stored in table snr_minoutline).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Snr_minoutline extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "snr_minoutline";
    public static final String ENTITY_NAME = "snr_minoutline";

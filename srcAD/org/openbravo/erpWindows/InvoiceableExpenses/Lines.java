...
package org.openbravo.erpWindows.InvoiceableExpenses;
...
public class Lines extends HttpSecureAppServlet {
  ...
  private static final String windowId = "242";
  private static final String tabId = "432";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|C_BPartner_ID", strPC_BPartner_ID);
      vars.setSessionValue("431|Customer.view", "EDIT");
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/InvoiceableExpenses/Lines_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Lines", false, "document.frmMain.inpsTimeexpenselineId", "grid", "..", "".equals("Y"), "InvoiceableExpenses", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines_Relation.html", "InvoiceableExpenses", "W", strReplaceWith, tabs.breadcrumb());
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strS_TimeExpenseLine_ID, String strPC_BPartner_ID, TableSQLData tableSQL)
    ...
    String orderClause = "  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Name), ''))),'') ),  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(table3.DateReport, 'DD-MM-YYYY')),'') ), S_TimeExpenseLine.Line";
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPC_BPartner_ID, Utility.getDefault(this, vars, "C_ProjectPhase_ID", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "S_TimeType_ID", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "C_UOM_ID", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "Description", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "C_ProjectTask_ID", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "242", "432", "", dataField), LinesData.selectDef6881_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "242", "432", "", dataField)), Utility.getDefault(this, vars, "C_Activity_ID", "", "242", "432", "", dataField), LinesData.selectDef6879(this, Utility.getContext(this, vars, "S_TimeExpense_ID", "242")), "", Utility.getDefault(this, vars, "Note", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@$C_Currency_ID@", "242", "432", "", dataField), LinesData.selectDef6867_1(this, strPC_BPartner_ID), "Y", Utility.getDefault(this, vars, "ConvertedAmt", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "InvoicePrice", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "ExpenseAmt", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "DateExpense", "@DateReport@", "242", "432", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "242", "432", "", dataField), Utility.getDefault(this, vars, "S_TimeExpense_ID", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "C_InvoiceLine_ID", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "IsInvoiced", "", "242", "432", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "242", "432", "", dataField), LinesData.selectDef6883_2(this, Utility.getDefault(this, vars, "CreatedBy", "", "242", "432", "", dataField)), Utility.getDefault(this, vars, "IsTimeReport", "", "242", "432", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "242", "432", "", dataField), Utility.getDefault(this, vars, "Qty", "1", "242", "432", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "S_ResourceAssignment_ID", "", "242", "432", "", dataField), Utility.getDefault(this, vars, "C_OrderLine_ID", "", "242", "432", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Lines", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpsTimeexpenselineId", "", "..", "".equals("Y"), "InvoiceableExpenses", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strS_TimeExpenseLine_ID));

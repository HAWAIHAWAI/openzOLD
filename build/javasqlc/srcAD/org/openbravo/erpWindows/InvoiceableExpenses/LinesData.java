 ...
 */
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      " AND S_TimeExpenseLine.IsInvoiced='Y' AND S_TimeExpenseLine.C_OrderLine_ID IS NULL AND EXISTS (SELECT * FROM S_TimeExpense t WHERE t.S_TimeExpense_ID=S_TimeExpenseLine.S_TimeExpense_ID AND t.Processed='Y')" +
      "        AND 1=1 ";
    strSql = strSql + ((cBpartnerId==null || cBpartnerId.equals(""))?"":"  AND S_TimeExpenseLine.C_BPartner_ID = ?  ");
    strSql = strSql + 
...
Create a registry
 */
  public static LinesData[] set(String cBpartnerId, String cProjectphaseId, String sTimetypeId, String cUomId, String description, String cProjecttaskId, String updatedby, String updatedbyr, String cActivityId, String line, String sTimeexpenselineId, String note, String cCurrencyId, String cBpartnerIdr, String isactive, String convertedamt, String invoiceprice, String expenseamt, String dateexpense, String adOrgId, String sTimeexpenseId, String cInvoicelineId, String mProductId, String isinvoiced, String createdby, String createdbyr, String istimereport, String adClientId, String qty, String cCampaignId, String cProjectId, String sResourceassignmentId, String cOrderlineId)    throws ServletException {
 ...
 */
  public static String selectParentID(ConnectionProvider connectionProvider, String key)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT S_TimeExpenseLine.C_BPartner_ID AS NAME" +
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET S_TimeExpenseLine_ID = (?) , C_Activity_ID = (?) , S_ResourceAssignment_ID = (?) , C_InvoiceLine_ID = (?) , C_Campaign_ID = (?) , IsActive = (?) , C_OrderLine_ID = (?) , S_TimeType_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , S_TimeExpense_ID = (?) , Line = TO_NUMBER(?) , IsTimeReport = (?) , IsInvoiced = (?) , M_Product_ID = (?) , Qty = TO_NUMBER(?) , C_Currency_ID = (?) , C_UOM_ID = (?) , InvoicePrice = TO_NUMBER(?) , DateExpense = TO_DATE(?) , ExpenseAmt = TO_NUMBER(?) , ConvertedAmt = TO_NUMBER(?) , Description = (?) , Note = (?) , C_Project_ID = (?) , C_BPartner_ID = (?) , C_ProjectPhase_ID = (?) , C_ProjectTask_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE S_TimeExpenseLine.S_TimeExpenseLine_ID = ? " +
      "                 AND S_TimeExpenseLine.C_BPartner_ID = ? " +
      "        AND S_TimeExpenseLine.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ") " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (S_TimeExpenseLine_ID, C_Activity_ID, S_ResourceAssignment_ID, C_InvoiceLine_ID, C_Campaign_ID, IsActive, C_OrderLine_ID, S_TimeType_ID, AD_Client_ID, AD_Org_ID, S_TimeExpense_ID, Line, IsTimeReport, IsInvoiced, M_Product_ID, Qty, C_Currency_ID, C_UOM_ID, InvoicePrice, DateExpense, ExpenseAmt, ConvertedAmt, Description, Note, C_Project_ID, C_BPartner_ID, C_ProjectPhase_ID, C_ProjectTask_ID, created, createdby, updated, updatedBy)" +

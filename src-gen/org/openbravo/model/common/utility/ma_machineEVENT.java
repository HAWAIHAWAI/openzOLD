...
/**
 * Entity class for entity ma_machineEVENT (stored in table ma_machineEVENT).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ma_machineEVENT extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ma_machineEVENT";
    public static final String ENTITY_NAME = "ma_machineEVENT";

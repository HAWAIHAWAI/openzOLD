 ...
 */
public class DiscountInvoice extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_RAPPELBPARTNER = "rappelBpartner";
    ...
    public BusinessPartner getRappelBpartner() {
        return (BusinessPartner) get(PROPERTY_RAPPELBPARTNER);
    }

    public void setRappelBpartner(BusinessPartner rappelBpartner) {
        set(PROPERTY_RAPPELBPARTNER, rappelBpartner);
    }

...
/**
 * Entity class for entity zssi_textmodule_trl (stored in table zssi_textmodule_trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Zssi_textmodule_trl extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zssi_textmodule_trl";
    public static final String ENTITY_NAME = "zssi_textmodule_trl";

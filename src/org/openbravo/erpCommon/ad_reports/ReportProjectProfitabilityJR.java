...
public class ReportProjectProfitabilityJR extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strOrg = vars.getGlobalVariable("inpOrg", "ReportProjectProfitabilityJR|Org", vars
          .getOrg());
  ...
  private void printPageDataHtml(HttpServletRequest request, HttpServletResponse response,
    ...
    try {
      data = ReportProjectProfitabilityData.select(this, vars.getLanguage(),Utility
          .getContext(this, vars, "#User_Client", "ReportProjectProfitabilityJR"),Utility.getContext(this, vars,
              "#AccessibleOrgTree", "ReportProjectProgress"),strOrg,
          strDateFrom2, strDateTo2,  strDateFrom,
          strDateTo, strDateFrom3, strDateTo3, strProjectType, strProject, strResponsible, strPartner);
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
          "ReportProjectProfitabilityJR.html", classInfo.id, classInfo.type, strReplaceWith, tabs
              .breadcrumb());

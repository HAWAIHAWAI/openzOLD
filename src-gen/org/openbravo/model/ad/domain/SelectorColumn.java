 ...
 */
public class SelectorColumn extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_REFSEARCH = "refSearch";
    ...
    public static final String PROPERTY_COLUMNSUFFIX = "columnSuffix";
    ...
    public Selector getRefSearch() {
        return (Selector) get(PROPERTY_REFSEARCH);
    }

    public void setRefSearch(Selector refSearch) {
        set(PROPERTY_REFSEARCH, refSearch);
    }
    ...
    public String getColumnSuffix() {
        return (String) get(PROPERTY_COLUMNSUFFIX);
    }

    public void setColumnSuffix(String columnSuffix) {
        set(PROPERTY_COLUMNSUFFIX, columnSuffix);
    }
}

    ...
    try {
      ...
      if (strCommand.equals("SAVE")) {
        ...
        for (int i = 0; i < retval.size(); i++) {
          ...
          strLine=grid.getValue(servlet, vars, strPTBOMId, "Line");
          ...
          if (ProjecttaskMaterialDispositionData.isExisting(servlet, strPTBOMId).equals("0")) {
            ...
            ProjecttaskMaterialDispositionData.update(conn, servlet, strUser, strLine,strLocator,strProduct, strQty, strRequisition,

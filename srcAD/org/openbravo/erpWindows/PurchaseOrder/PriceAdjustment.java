...
public class PriceAdjustment extends HttpSecureAppServlet {
  ...
  private static final String tabId = "800221";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|C_OrderLine_ID", strPC_OrderLine_ID);
      vars.setSessionValue("293|Lines.view", "EDIT");
      vars.removeSessionValue(windowId + "|C_Order_ID");
      refreshParentSession(vars, strPC_OrderLine_ID);
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strC_Orderline_Offer_ID = vars.getRequiredStringParameter("inpcOrderlineOfferId");
      //PriceAdjustmentData data = getEditVariables(vars, strPC_OrderLine_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = PriceAdjustmentData.delete(this, strC_Orderline_Offer_ID, strPC_OrderLine_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strC_Orderline_Offer_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (PriceAdjustmentData.deleteTransactional(conn, this, strKey, strPC_OrderLine_ID)==0) {
...
*/
  private PriceAdjustmentData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_OrderLine_ID) throws IOException,ServletException {
   ...
   private PriceAdjustmentData[] getRelationData(PriceAdjustmentData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].cOrderlineOfferId = FormatUtilities.truncate(data[i].cOrderlineOfferId, 10);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].mOfferId = FormatUtilities.truncate(data[i].mOfferId, 44);        data[i].cOrderlineId = FormatUtilities.truncate(data[i].cOrderlineId, 44);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_OrderLine_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|C_Order_ID", data[0].cOrderId);    vars.setSessionValue(windowId + "|C_BPartner_Location_ID", data[0].cBpartnerLocationId);    vars.setSessionValue(windowId + "|DateOrdered", data[0].dateordered);    vars.setSessionValue(windowId + "|DatePromised", data[0].datepromised);    vars.setSessionValue(windowId + "|M_Product_ID", data[0].mProductId);    vars.setSessionValue(windowId + "|QtyOrdered", data[0].qtyordered);    vars.setSessionValue(windowId + "|M_Shipper_ID", data[0].mShipperId);    vars.setSessionValue(windowId + "|C_Currency_ID", data[0].cCurrencyId);    vars.setSessionValue(windowId + "|C_OrderLine_ID", data[0].cOrderlineId);    vars.setSessionValue(windowId + "|M_Warehouse_ID", data[0].mWarehouseId);
      vars.setSessionValue(windowId + "|C_OrderLine_ID", strPC_OrderLine_ID); //to ensure key parent is set for EM_* cols

      FieldProvider dataField = null; // Define this so that auxiliar inputs using SQL will work
      
      vars.setSessionValue(windowId + "|Processed", LinesData.selectAux1F6072F3CE0F43F6AF71874398914072(this, Utility.getContext(this, vars, "C_ORDER_ID", "181")));
      
      vars.setSessionValue(windowId + "|HASSECONDUOM", LinesData.selectAux800000(this, Utility.getContext(this, vars, "M_Product_ID", "181")));
      
  }
    
  private String getParentID(VariablesSecureApp vars, String strC_Orderline_Offer_ID) throws ServletException {
    String strPC_OrderLine_ID = PriceAdjustmentData.selectParentID(this, strC_Orderline_Offer_ID);
    if (strPC_OrderLine_ID.equals("")) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|C_Orderline_Offer_ID", data[0].getField("cOrderlineOfferId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars, String strPC_OrderLine_ID) throws IOException,ServletException {
      PriceAdjustmentData[] data = PriceAdjustmentData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_OrderLine_ID, vars.getStringParameter("inpcOrderlineOfferId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamM_Offer_ID = vars.getSessionValue(tabId + "|paramM_Offer_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/PurchaseOrder/PriceAdjustment_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "PriceAdjustment", false, "document.frmMain.inpcOrderlineOfferId", "grid", "..", "".equals("Y"), "PurchaseOrder", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "PriceAdjustment_Relation.html", "PurchaseOrder", "W", strReplaceWith, tabs.breadcrumb());
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", PriceAdjustmentData.selectParent(this, strPC_OrderLine_ID));
    else xmlDocument.setParameter("parent", PriceAdjustmentData.selectParentTrl(this, strPC_OrderLine_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Orderline_Offer_ID, String strPC_OrderLine_ID, TableSQLData tableSQL)
    ...
    String orderClause = " C_OrderLine_Offer.Line";
...
String strParamM_Offer_ID = vars.getSessionValue(tabId + "|paramM_Offer_ID");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = PriceAdjustmentData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_OrderLine_ID, strC_Orderline_Offer_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PriceAdjustmentData.set(strPC_OrderLine_ID, Utility.getDefault(this, vars, "M_Offer_ID", "", "181", "800221", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "181", "800221", "", dataField), PriceAdjustmentData.selectDef803115_0(this, Utility.getDefault(this, vars, "Updatedby", "", "181", "800221", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "181", "800221", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "181", "800221", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "181", "800221", "", dataField), PriceAdjustmentData.selectDef803113_1(this, Utility.getDefault(this, vars, "Createdby", "", "181", "800221", "", dataField)), "", PriceAdjustmentData.selectDef803117(this, strPC_OrderLine_ID), Utility.getDefault(this, vars, "PriceOffer", "0", "181", "800221", "", dataField), "Y", Utility.getDefault(this, vars, "AmtOffer", "0", "181", "800221", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "PriceAdjustment", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcOrderlineOfferId", "", "..", "".equals("Y"), "PurchaseOrder", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Orderline_Offer_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (PriceAdjustmentData.getCurrentDBTimestamp(this, data.cOrderlineOfferId).equals(

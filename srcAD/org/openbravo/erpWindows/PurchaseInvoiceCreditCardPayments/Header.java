...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strC_Invoice_Creditcard_V_ID = vars.getRequiredInStringParameter("inpcInvoiceCreditcardVId");
      String message = deleteRelation(vars, strC_Invoice_Creditcard_V_ID);
      if (!message.equals("")) {
...
/*
  String deleteRelation(VariablesSecureApp vars, String strC_Invoice_Creditcard_V_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strC_Invoice_Creditcard_V_ID.startsWith("(")) strC_Invoice_Creditcard_V_ID = strC_Invoice_Creditcard_V_ID.substring(1, strC_Invoice_Creditcard_V_ID.length()-1);
      if (!strC_Invoice_Creditcard_V_ID.equals("")) {
        strC_Invoice_Creditcard_V_ID = Replace.replace(strC_Invoice_Creditcard_V_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strC_Invoice_Creditcard_V_ID, ",", false);
...
String strParamAD_User_ID = vars.getSessionValue(tabId + "|paramAD_User_ID");
    ...
    if (!(strParamDocumentNo.equals("") && strParamC_BPartner_ID.equals("") && strParamDescription.equals("") && strParamInternalNote.equals("") && strParamDocStatus.equals("") && strParamAD_User_ID.equals(""))) hasSearchCondition=true;
    String strOffset = "0";
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cInvoiceCreditcardVId, vars, this);
        } catch(Exception ex) {

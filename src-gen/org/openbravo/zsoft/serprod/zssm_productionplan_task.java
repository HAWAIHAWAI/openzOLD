...
/**
 * Entity class for entity zssm_productionplan_task (stored in table zssm_productionplan_task).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zssm_productionplan_task extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zssm_productionplan_task";
    public static final String ENTITY_NAME = "zssm_productionplan_task";
    ...
    public zssm_productionplan_task() {

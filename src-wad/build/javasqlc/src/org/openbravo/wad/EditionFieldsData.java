...
class EditionFieldsData implements FieldProvider {
 ...
 */
  public static EditionFieldsData[] select(ConnectionProvider connectionProvider, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "      moc.classname as classname_callout, momc.mappingname as mappingname_callout, '' AS COLUMNNAME_END, ad_field.isactive, ad_column.readonlylogic ,ad_process.isdirectservletcall" +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectEditionFieldsData.isdirectservletcall = UtilSql.getValue(result, "isdirectservletcall");
...
Names of the columns and name of the fields of a tab
 */
  public static EditionFieldsData[] selectionColumns(ConnectionProvider connectionProvider, String tab)    throws ServletException {
    return selectionColumns(connectionProvider, tab, 0, 0);
  }

/**
Names of the columns and name of the fields of a tab
 */
  public static EditionFieldsData[] selectionColumns(ConnectionProvider connectionProvider, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public static String fieldGroupDisplay(ConnectionProvider connectionProvider, String adFieldgroupId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      select displayed " +
      "      from ad_fieldgroup " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "displayed");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);

 ...
 */
public class Incidence extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_STRTIME = "strtime";
    ...
    public String getStrtime() {
        return (String) get(PROPERTY_STRTIME);
    }

    public void setStrtime(String strtime) {
        set(PROPERTY_STRTIME, strtime);
    }
}

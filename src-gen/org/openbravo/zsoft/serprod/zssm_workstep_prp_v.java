...
/**
 * Entity class for entity zssm_workstep_prp_v (stored in table zssm_workstep_prp_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zssm_workstep_prp_v extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zssm_workstep_prp_v";
    public static final String ENTITY_NAME = "zssm_workstep_prp_v";
    ...
    public static final String PROPERTY_ISAUTOGENERATEDPLAN =
        "isautogeneratedplan";
    ...
    public zssm_workstep_prp_v() {
        ...
        setDefaultValue(PROPERTY_ISAUTOGENERATEDPLAN, true);
    ...
    public String getZssmWorkstepV() {
        return (String) get(PROPERTY_ZSSMWORKSTEPV);
    }

    public void setZssmWorkstepV(String zssmWorkstepV) {
    ...
    public Boolean isAutogeneratedplan() {
        return (Boolean) get(PROPERTY_ISAUTOGENERATEDPLAN);
    }

    public void setAutogeneratedplan(Boolean isautogeneratedplan) {
        set(PROPERTY_ISAUTOGENERATEDPLAN, isautogeneratedplan);
    }

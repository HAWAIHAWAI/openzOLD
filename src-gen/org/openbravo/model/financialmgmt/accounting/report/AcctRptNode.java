 ...
 */
public class AcctRptNode extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ACCTRPTGROUP = "acctRptGroup";
    ...
    public AcctRptGroup getAcctRptGroup() {
        return (AcctRptGroup) get(PROPERTY_ACCTRPTGROUP);
    }

    public void setAcctRptGroup(AcctRptGroup acctRptGroup) {
        set(PROPERTY_ACCTRPTGROUP, acctRptGroup);
    }

...
/**
 * Entity class for entity RequestType (stored in table R_RequestType).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RequestType extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "R_RequestType";
    public static final String ENTITY_NAME = "RequestType";
    ...
    public RequestType() {
        ...
        setDefaultValue(PROPERTY_ISSELFSERVICE, true);
    }

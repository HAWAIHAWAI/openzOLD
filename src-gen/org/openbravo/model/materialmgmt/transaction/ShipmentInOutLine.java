...
import org.zsoft.serial.Snr_minoutline;
 ...
 */
public class ShipmentInOutLine extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_BOXNUMBER = "boxnumber";
    ...
    public static final String PROPERTY_SNRMINOUTLINELIST = "snrMinoutlineList";
    ...
    public ShipmentInOutLine() {
        ...
        setDefaultValue(PROPERTY_SNRMINOUTLINELIST, new ArrayList<Object>());
    }
    ...
    public String getBoxnumber() {
        return (String) get(PROPERTY_BOXNUMBER);
    }

    public void setBoxnumber(String boxnumber) {
        set(PROPERTY_BOXNUMBER, boxnumber);
    }
    ...
    public List<Snr_minoutline> getSnrMinoutlineList() {
        return (List<Snr_minoutline>) get(PROPERTY_SNRMINOUTLINELIST);
    }

    public void setSnrMinoutlineList(List<Snr_minoutline> snrMinoutlineList) {
        set(PROPERTY_SNRMINOUTLINELIST, snrMinoutlineList);
    }
}

...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strMA_Maintenance_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|MA_Maintenance_ID", data[0].getField("maMaintenanceId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPMA_Machine_Type_ID, String strMA_Maintenance_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/openbravo/zsoft/cmms/MachineCategory/Maintenance800183_Relation", discard).createXmlDocument();

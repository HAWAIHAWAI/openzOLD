...
public class PrintWorkstepActvities extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintWorkstepActvities.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = new DocumentType("WORKSTEPACTIVITY","ZSSM_WORKSTEPACTIVITIES_V","workstepactivity/","Workstepactivity",false,null,"c_getDefaultDocInfo");
    // The prefix PRINTORDERS is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTWORKSTEPACTIVITY";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpzssmWorkstepactivitiesVId_R");
    if (strDocumentId.equals(""))
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpzssmWorkstepactivitiesVId");

 ...
 */
public class Resource extends BaseOBObject implements ClientEnabled {
    ...
    public Resource() {
        ...
        setDefaultValue(PROPERTY_ISAVAILABLE, true);
    }
    ...
    public Boolean isAvailable() {
        return (Boolean) get(PROPERTY_ISAVAILABLE);
    }

    public void setAvailable(Boolean isAvailable) {
        set(PROPERTY_ISAVAILABLE, isAvailable);
    }

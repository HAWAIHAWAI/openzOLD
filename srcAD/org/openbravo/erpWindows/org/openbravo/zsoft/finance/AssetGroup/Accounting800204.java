...
public class Accounting800204 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Accounting800204.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Accounting800204.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Accounting800204.view", "EDIT");

        printPageEdit(response, request, vars, false, strA_Asset_Group_Acct_ID, strPA_Asset_Group_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Accounting800204.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamC_AcctSchema_ID", tabId + "|paramC_AcctSchema_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strA_Asset_Group_Acct_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Accounting800204.view", strView);
        }
      }
...
vars.getGlobalVariable("inpaAssetGroupId", windowId + "|A_Asset_Group_ID");
      ...
      vars.setSessionValue(tabId + "|Accounting800204.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPA_Asset_Group_ID = vars.getGlobalVariable("inpaAssetGroupId", windowId + "|A_Asset_Group_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Accounting800204.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Accounting800204.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|A_Asset_Group_Acct_ID");
      vars.setSessionValue(windowId + "|A_Asset_Group_ID", strPA_Asset_Group_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strA_Asset_Group_Acct_ID = vars.getRequiredInStringParameter("inpaAssetGroupAcctId");
      String message = deleteRelation(vars, strA_Asset_Group_Acct_ID, strPA_Asset_Group_ID);
      if (!message.equals("")) {
      ...
      String strA_Asset_Group_Acct_ID = vars.getRequiredStringParameter("inpaAssetGroupAcctId");
      //Accounting800204Data data = getEditVariables(vars, strPA_Asset_Group_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Accounting800204Data.delete(this, strA_Asset_Group_Acct_ID, strPA_Asset_Group_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
/*
  String deleteRelation(VariablesSecureApp vars, String strA_Asset_Group_Acct_ID, String strPA_Asset_Group_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strA_Asset_Group_Acct_ID.startsWith("(")) strA_Asset_Group_Acct_ID = strA_Asset_Group_Acct_ID.substring(1, strA_Asset_Group_Acct_ID.length()-1);
      if (!strA_Asset_Group_Acct_ID.equals("")) {
        strA_Asset_Group_Acct_ID = Replace.replace(strA_Asset_Group_Acct_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strA_Asset_Group_Acct_ID, ",", false);
        while (st.hasMoreTokens()) {
          String strKey = st.nextToken();
          if (Accounting800204Data.deleteTransactional(conn, this, strKey, strPA_Asset_Group_ID)==0) {
...
*/
  private Accounting800204Data getEditVariables(Connection con, VariablesSecureApp vars, String strPA_Asset_Group_ID) throws IOException,ServletException {
    Accounting800204Data data = new Accounting800204Data();
    ServletException ex = null;
    try {
    data.aAssetGroupAcctId = vars.getRequestGlobalVariable("inpaAssetGroupAcctId", windowId + "|A_Asset_Group_Acct_ID");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adClientIdr = vars.getStringParameter("inpadClientId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.aAssetGroupId = vars.getStringParameter("inpaAssetGroupId");     data.aAssetGroupIdr = vars.getStringParameter("inpaAssetGroupId_R");     data.cAcctschemaId = vars.getStringParameter("inpcAcctschemaId");     data.cAcctschemaIdr = vars.getStringParameter("inpcAcctschemaId_R");     data.aAccumdepreciationAcct = vars.getStringParameter("inpaAccumdepreciationAcct");     data.aAccumdepreciationAcctr = vars.getStringParameter("inpaAccumdepreciationAcct_R");     data.aDepreciationAcct = vars.getStringParameter("inpaDepreciationAcct");     data.aDepreciationAcctr = vars.getStringParameter("inpaDepreciationAcct_R");     data.aDisposalGain = vars.getStringParameter("inpaDisposalGain");     data.aDisposalLoss = vars.getStringParameter("inpaDisposalLoss");     data.processing = vars.getStringParameter("inpprocessing"); 
   ...
   private Accounting800204Data[] getRelationData(Accounting800204Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].aAssetGroupAcctId = FormatUtilities.truncate(data[i].aAssetGroupAcctId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].aAssetGroupId = FormatUtilities.truncate(data[i].aAssetGroupId, 44);        data[i].cAcctschemaId = FormatUtilities.truncate(data[i].cAcctschemaId, 44);        data[i].aAccumdepreciationAcct = FormatUtilities.truncate(data[i].aAccumdepreciationAcct, 44);        data[i].aDepreciationAcct = FormatUtilities.truncate(data[i].aDepreciationAcct, 44);        data[i].aDisposalGain = FormatUtilities.truncate(data[i].aDisposalGain, 44);        data[i].aDisposalLoss = FormatUtilities.truncate(data[i].aDisposalLoss, 44);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPA_Asset_Group_ID) throws IOException,ServletException {
      AssetCategory452Data[] data = AssetCategory452Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPA_Asset_Group_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|A_Asset_Group_ID", data[0].aAssetGroupId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);
  ...
  private String getParentID(VariablesSecureApp vars, String strA_Asset_Group_Acct_ID) throws ServletException {
    String strPA_Asset_Group_ID = Accounting800204Data.selectParentID(this, strA_Asset_Group_Acct_ID);
    if (strPA_Asset_Group_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPA_Asset_Group_ID) throws IOException,ServletException {
      Accounting800204Data[] data = Accounting800204Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPA_Asset_Group_ID, vars.getStringParameter("inpaAssetGroupAcctId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamC_AcctSchema_ID = vars.getSessionValue(tabId + "|paramC_AcctSchema_ID");
    ...
    if (!(strParamA_Asset_Group_ID.equals("") && strParamC_AcctSchema_ID.equals(""))) hasSearchCondition=true;
    String strOffset = "0";
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/openbravo/zsoft/finance/AssetGroup/Accounting800204_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Accounting800204", false, "document.frmMain.inpaAssetGroupAcctId", "grid", "..", "".equals("Y"), "AssetGroup", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Accounting800204_Relation.html", "AssetGroup", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Accounting800204_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", Accounting800204Data.selectParent(this, strPA_Asset_Group_ID));
    else xmlDocument.setParameter("parent", Accounting800204Data.selectParentTrl(this, strPA_Asset_Group_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strA_Asset_Group_Acct_ID, String strPA_Asset_Group_ID, TableSQLData tableSQL)
    ...
    Accounting800204Data[] data=null;
...
String strParamC_AcctSchema_ID = vars.getSessionValue(tabId + "|paramC_AcctSchema_ID");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Accounting800204Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPA_Asset_Group_ID, strA_Asset_Group_Acct_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new Accounting800204Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Accounting800204Data.set(strPA_Asset_Group_ID, Utility.getDefault(this, vars, "A_Depreciation_Acct", "", "252", "800204", "", dataField), Accounting800204Data.selectDef802812_0(this, Utility.getDefault(this, vars, "A_Depreciation_Acct", "", "252", "800204", "", dataField)), Utility.getDefault(this, vars, "Processing", "N", "252", "800204", "N", dataField), Utility.getDefault(this, vars, "A_Disposal_Loss", "", "252", "800204", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "252", "800204", "", dataField), Accounting800204Data.selectDef802810_1(this, Utility.getDefault(this, vars, "Updatedby", "", "252", "800204", "", dataField)), Utility.getDefault(this, vars, "A_Accumdepreciation_Acct", "", "252", "800204", "", dataField), Accounting800204Data.selectDef802813_2(this, Utility.getDefault(this, vars, "A_Accumdepreciation_Acct", "", "252", "800204", "", dataField)), Utility.getDefault(this, vars, "A_Disposal_Gain", "", "252", "800204", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "252", "800204", "", dataField), "", Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "252", "800204", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "252", "800204", "", dataField), Accounting800204Data.selectDef802808_3(this, Utility.getDefault(this, vars, "Createdby", "", "252", "800204", "", dataField)), "Y", Utility.getDefault(this, vars, "C_AcctSchema_ID", "", "252", "800204", "", dataField));
        
      }
    } else {
      data = new Accounting800204Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(Accounting800204Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
      
    String currentPOrg=AssetCategory452Data.selectOrg(this, strPA_Asset_Group_ID);
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Accounting800204", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpaAssetGroupAcctId", "", "..", "".equals("Y"), "AssetGroup", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strA_Asset_Group_Acct_ID));
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonProcessing800136(HttpServletResponse response, VariablesSecureApp vars, String strA_Asset_Group_Acct_ID, String strprocessing, String strProcessing)
    throws IOException, ServletException {
    ...
    Scripthelper script = new Scripthelper();
      ...
      try {
        String name= LocalizationUtils.getProcessTitle(this, "800136",vars.getLanguage());
        String info = LocalizationUtils.getProcessInfo(this, "800136" ,vars.getLanguage());
        if (! info.isEmpty())
        ...
        strFG=strFG + fh.prepareProcessParameters(this, vars, script,"800136" );
        String isDocAction=UtilsData.isProcessDocAction(this, "800136");
        if (Integer.parseInt(isDocAction)>0) {
            String strdocstatus=UtilsData.getDocStatus(this, "800171",strA_Asset_Group_Acct_ID);
            FieldProvider[] dataDocAction = DocActionWorkflowOptions.docAction(this, vars, "", "", strdocstatus,"N",
            "800171", strA_Asset_Group_Acct_ID);
        ...
        String isJasper=UtilsData.isProcessJasper(this, "800136");
        if (isJasper.equals("N"))
          strActionButtons= strActionButtons + ConfigureButton.doConfigure(this,vars,script,"buttonok",1,1,false, "ok",  "submitThisPage('SAVE_BUTTONProcessing" + "800136" + "');", "","") + "";
        else
        ...
        strSkeleton=Replace.replace(strSkeleton,"ActionButton_Responser.html","Accounting800204_Edition.html");
        String strOutput=Replace.replace(strSkeleton, "@CONTENT@",info +  strFG +strActionButtons); 
        script.addSubmitPagePageSripts();
        
        script.addHiddenfield("inpadProcessId", "800136");
        script.addHiddenfield("inpKey",strA_Asset_Group_Acct_ID);
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Accounting800204Data.getCurrentDBTimestamp(this, data.aAssetGroupAcctId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.aAssetGroupAcctId, vars, this);
        } catch(Exception ex) {
  ...
  public String getServletInfo() {
    return "Servlet Accounting800204. This Servlet was made by Wad constructor";

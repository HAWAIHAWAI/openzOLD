 ...
 */
public class WorkCenterMachine extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_WORKSTATION = "workstation";
    ...
    public WorkCenter getWorkstation() {
        return (WorkCenter) get(PROPERTY_WORKSTATION);
    }

    public void setWorkstation(WorkCenter workstation) {
        set(PROPERTY_WORKSTATION, workstation);
    }
}

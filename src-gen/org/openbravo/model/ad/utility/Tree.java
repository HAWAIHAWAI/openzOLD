 ...
 */
public class Tree extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISALLNODES = "isAllNodes";
    public static final String PROPERTY_ADTREENODELIST = "aDTreeNodeList";

    public Tree() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_ISALLNODES, false);
    ...
    public Boolean isAllNodes() {
        return (Boolean) get(PROPERTY_ISALLNODES);
    }

    public void setAllNodes(Boolean isAllNodes) {
        set(PROPERTY_ISALLNODES, isAllNodes);
    }

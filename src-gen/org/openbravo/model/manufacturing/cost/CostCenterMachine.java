 ...
 */
public class CostCenterMachine extends BaseOBObject implements ClientEnabled {
    ...
    public CostCenterMachine() {
        setDefaultValue(PROPERTY_USE, new BigDecimal(1));
    ...
    public BigDecimal getUse() {
        return (BigDecimal) get(PROPERTY_USE);
    }

    public void setUse(BigDecimal use) {
        set(PROPERTY_USE, use);
    }

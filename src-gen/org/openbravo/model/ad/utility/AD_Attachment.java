...
/**
 * Entity class for entity Attachment (stored in table AD_Attachment).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class AD_Attachment extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_BINARYDATA = "binaryData";
    ...
    public byte[] getBinaryData() {
        return (byte[]) get(PROPERTY_BINARYDATA);
    }

    public void setBinaryData(byte[] binaryData) {
        set(PROPERTY_BINARYDATA, binaryData);
    }

    public FileType getDatatype() {
        return (FileType) get(PROPERTY_DATATYPE);
    }

 ...
 */
public class Case extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_PERIODICCONTROL = "periodicControl";
    ...
    public static final String PROPERTY_LAUNCHED = "launched";
    public static final String PROPERTY_MANUFACTURINGVALUELIST =
        "manufacturingValueList";

    public Case() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_LAUNCHED, false);
    ...
    public PeriodicControl getPeriodicControl() {
        return (PeriodicControl) get(PROPERTY_PERIODICCONTROL);
    }

    public void setPeriodicControl(PeriodicControl periodicControl) {
        set(PROPERTY_PERIODICCONTROL, periodicControl);
    }
    ...
    public Boolean isLaunched() {
        return (Boolean) get(PROPERTY_LAUNCHED);
    }

    public void setLaunched(Boolean launched) {
        set(PROPERTY_LAUNCHED, launched);
    }

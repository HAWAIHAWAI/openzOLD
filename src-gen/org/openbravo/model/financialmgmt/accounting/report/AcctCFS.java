 ...
 */
public class AcctCFS extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_FACTACCTREF = "factAcctRef";
    ...
    public AccountingFact getFactAcct() {
        return (AccountingFact) get(PROPERTY_FACTACCT);
    }

    public void setFactAcct(AccountingFact factAcct) {
    ...
    public AccountingFact getFactAcctRef() {
        return (AccountingFact) get(PROPERTY_FACTACCTREF);
    }

    public void setFactAcctRef(AccountingFact factAcctRef) {
        set(PROPERTY_FACTACCTREF, factAcctRef);
    }
}

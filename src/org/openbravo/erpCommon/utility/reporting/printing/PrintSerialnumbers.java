...
public class PrintSerialnumbers extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintSerialnumbers.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = new DocumentType("SERIALNUMBER","SNR_MASTERDATA","serialnumber/","Serialnumber",false,null,"c_getDefaultDocInfo");
    // The prefix PRINTORDERS is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTSERIALNUMBERS";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsnrMasterdataId_R");
    if (strDocumentId.equals(""))
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsnrMasterdataId");

 ...
 */
public class TextInterfaceTrl extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_TEXTINTERFACES = "textinterfaces";
    ...
    public TextInterface getTextinterfaces() {
        return (TextInterface) get(PROPERTY_TEXTINTERFACES);
    }

    public void setTextinterfaces(TextInterface textinterfaces) {
        set(PROPERTY_TEXTINTERFACES, textinterfaces);
    }

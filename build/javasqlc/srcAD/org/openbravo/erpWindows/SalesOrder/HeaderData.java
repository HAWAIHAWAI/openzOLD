...
Create a registry
 */
  public static HeaderData[] set(String cBpartnerId, String cBpartnerIdr, String priorityrule, String generateproject, String dropshipLocationId, String adClientId, String billtoId, String cIncotermsId, String isselected, String iscompletelyinvoiced, String freightamt, String mShipperId, String completeordervalue, String istaxincluded, String qty, String cProjecttaskId, String user2Id, String cChargeId, String cProjectphaseId, String mProductId, String totallines, String ispaid, String enddate, String weightUom, String proposalstatus, String posted, String transactiondate, String weight, String user1Id, String name, String chargeamt, String invoicefrequence, String cCampaignId, String cBpartnerLocationId, String totalpaid, String internalnote, String isdiscountprinted, String dropshipBpartnerId, String totallinesonetime, String isrecharge, String freightcostrule, String cBidprojectId, String datepromised, String cPaymenttermId, String contractdate, String docstatus, String cProjectId, String cProjectIdr, String paymentrule, String generatetemplate, String lostproposalfixedreason, String updatedby, String updatedbyr, String deliveryLocationId, String salesrepId, String poreference, String invoicedamt, String mWarehouseId, String cOrderId, String copyfrom, String isdelivered, String deliveryrule, String issotrx, String isselfservice, String createdby, String createdbyr, String dateordered, String schedtransactiondate, String deliverycomplete, String cActivityId, String documentno, String monthlyDay, String dropshipUserId, String copyfrompo, String subscriptionchangedate, String scheddeliverydate, String dateacct, String cCurrencyId, String adOrgId, String bpzipcode, String grandtotalonetime, String cDoctypetargetId, String btncopytemplate, String invoicerule, String closeproject, String transactionreference, String isinvoiceafterfirstcycle, String deliverynotes, String incotermsdescription, String mPricelistId, String processed, String deliveryviarule, String weeklyDay, String estpropability, String description, String docaction, String docactionBtn, String isprinted, String dateprinted, String grandtotal, String isinvoiced, String orderselfjoin, String lostproposalreason, String isactive, String cDoctypeId, String adOrgtrxId, String aAssetId, String adUserId, String quarterlyMonth, String firstschedinvoicedate, String processing, String yearlyMonth)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_Order" +
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , DocumentNo = (?) , POReference = (?) , DateOrdered = TO_DATE(?) , C_DocTypeTarget_ID = (?) , Name = (?) , C_DocType_ID = (?) , DocStatus = (?) , Description = (?) , Deliverynotes = (?) , Internalnote = (?) , C_BPartner_ID = (?) , bpzipcode = (?) , BillTo_ID = (?) , C_BPartner_Location_ID = (?) , AD_User_ID = (?) , SalesRep_ID = (?) , M_PriceList_ID = (?) , IsDiscountPrinted = (?) , InvoiceRule = (?) , Estpropability = (?) , M_Warehouse_ID = (?) , C_Currency_ID = (?) , DeliveryRule = (?) , PriorityRule = (?) , PaymentRule = (?) , C_PaymentTerm_ID = (?) , C_Incoterms_ID = (?) , Delivery_Location_ID = (?) , DeliveryViaRule = (?) , M_Shipper_ID = (?) , Weight = TO_NUMBER(?) , Weight_Uom = (?) , FreightCostRule = (?) , M_Product_ID = (?) , Qty = TO_NUMBER(?) , FreightAmt = TO_NUMBER(?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , Orderselfjoin = (?) , Firstschedinvoicedate = TO_DATE(?) , DatePromised = TO_DATE(?) , Scheddeliverydate = TO_DATE(?) , Schedtransactiondate = TO_DATE(?) , Transactiondate = TO_DATE(?) , Contractdate = TO_DATE(?) , Enddate = TO_DATE(?) , Invoicefrequence = (?) , Isinvoiceafterfirstcycle = (?) , Quarterly_Month = (?) , Yearly_Month = (?) , Weekly_Day = (?) , Monthly_Day = TO_NUMBER(?) , Proposalstatus = (?) , Lostproposalfixedreason = (?) , Lostproposalreason = (?) , Totallinesonetime = TO_NUMBER(?) , Grandtotalonetime = TO_NUMBER(?) , TotalLines = TO_NUMBER(?) , GrandTotal = TO_NUMBER(?) , Invoicedamt = TO_NUMBER(?) , Totalpaid = TO_NUMBER(?) , Completeordervalue = TO_NUMBER(?) , Iscompletelyinvoiced = (?) , Deliverycomplete = (?) , Subscriptionchangedate = TO_DATE(?) , DocAction = (?) , Generatetemplate = (?) , CopyFrom = (?) , CopyFromPO = (?) , Generateproject = (?) , Closeproject = (?) , C_Activity_ID = (?) , C_Charge_ID = (?) , ChargeAmt = TO_NUMBER(?) , A_Asset_ID = (?) , C_Campaign_ID = (?) , Incotermsdescription = (?) , Processing = (?) , C_Bidproject_ID = (?) , DateAcct = TO_DATE(?) , IsPrinted = (?) , IsInvoiced = (?) , IsDelivered = (?) , IsActive = (?) , C_Order_ID = (?) , Isrecharge = (?) , Ispaid = (?) , BtnCopyTemplate = (?) , Transactionreference = (?) , IsSelected = (?) , IsTaxIncluded = (?) , Posted = (?) , DropShip_User_ID = (?) , DropShip_BPartner_ID = (?) , DropShip_Location_ID = (?) , IsSelfService = (?) , IsSOTrx = (?) , DatePrinted = TO_DATE(?) , Processed = (?) , C_Projectphase_ID = (?) , AD_OrgTrx_ID = (?) , User2_ID = (?) , User1_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_Order.C_Order_ID = ? " +
      "        AND C_Order.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO C_Order " +
      "        (AD_Client_ID, AD_Org_ID, DocumentNo, POReference, DateOrdered, C_DocTypeTarget_ID, Name, C_DocType_ID, DocStatus, Description, Deliverynotes, Internalnote, C_BPartner_ID, bpzipcode, BillTo_ID, C_BPartner_Location_ID, AD_User_ID, SalesRep_ID, M_PriceList_ID, IsDiscountPrinted, InvoiceRule, Estpropability, M_Warehouse_ID, C_Currency_ID, DeliveryRule, PriorityRule, PaymentRule, C_PaymentTerm_ID, C_Incoterms_ID, Delivery_Location_ID, DeliveryViaRule, M_Shipper_ID, Weight, Weight_Uom, FreightCostRule, M_Product_ID, Qty, FreightAmt, C_Project_ID, C_Projecttask_ID, Orderselfjoin, Firstschedinvoicedate, DatePromised, Scheddeliverydate, Schedtransactiondate, Transactiondate, Contractdate, Enddate, Invoicefrequence, Isinvoiceafterfirstcycle, Quarterly_Month, Yearly_Month, Weekly_Day, Monthly_Day, Proposalstatus, Lostproposalfixedreason, Lostproposalreason, Totallinesonetime, Grandtotalonetime, TotalLines, GrandTotal, Invoicedamt, Totalpaid, Completeordervalue, Iscompletelyinvoiced, Deliverycomplete, Subscriptionchangedate, DocAction, Generatetemplate, CopyFrom, CopyFromPO, Generateproject, Closeproject, C_Activity_ID, C_Charge_ID, ChargeAmt, A_Asset_ID, C_Campaign_ID, Incotermsdescription, Processing, C_Bidproject_ID, DateAcct, IsPrinted, IsInvoiced, IsDelivered, IsActive, C_Order_ID, Isrecharge, Ispaid, BtnCopyTemplate, Transactionreference, IsSelected, IsTaxIncluded, Posted, DropShip_User_ID, DropShip_BPartner_ID, DropShip_Location_ID, IsSelfService, IsSOTrx, DatePrinted, Processed, C_Projectphase_ID, AD_OrgTrx_ID, User2_ID, User1_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";

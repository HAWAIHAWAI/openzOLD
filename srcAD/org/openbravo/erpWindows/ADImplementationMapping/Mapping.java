...
public class Mapping extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Mapping.class);
  
  private static final String windowId = "08F09D2A7C774585B014C06C0F44F591";
  private static final String tabId = "B3B9080A60E443C58F9476506EEE3D4E";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Mapping.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Mapping.view", "EDIT");

        printPageEdit(response, request, vars, false, strAD_Model_Object_Mapping_ID, strPAD_Model_Object_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Mapping.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamMappingName", tabId + "|paramMappingName");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strAD_Model_Object_Mapping_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Mapping.view", strView);
        }
      }
...
vars.getGlobalVariable("inpadModelObjectId", windowId + "|AD_Model_Object_ID");
      ...
      vars.setSessionValue(tabId + "|Mapping.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPAD_Model_Object_ID = vars.getGlobalVariable("inpadModelObjectId", windowId + "|AD_Model_Object_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Mapping.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Mapping.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|AD_Model_Object_Mapping_ID");
      vars.setSessionValue(windowId + "|AD_Model_Object_ID", strPAD_Model_Object_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strAD_Model_Object_Mapping_ID = vars.getRequiredStringParameter("inpadModelObjectMappingId");
      //MappingData data = getEditVariables(vars, strPAD_Model_Object_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = MappingData.delete(this, strAD_Model_Object_Mapping_ID, strPAD_Model_Object_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strAD_Model_Object_Mapping_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (MappingData.deleteTransactional(conn, this, strKey, strPAD_Model_Object_ID)==0) {
...
*/
  private MappingData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Model_Object_ID) throws IOException,ServletException {
   ...
   private MappingData[] getRelationData(MappingData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adModelObjectMappingId = FormatUtilities.truncate(data[i].adModelObjectMappingId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 12);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 12);        data[i].adModelObjectId = FormatUtilities.truncate(data[i].adModelObjectId, 50);        data[i].mappingname = FormatUtilities.truncate(data[i].mappingname, 50);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Model_Object_Mapping_ID) throws ServletException {
    String strPAD_Model_Object_ID = MappingData.selectParentID(this, strAD_Model_Object_Mapping_ID);
    if (strPAD_Model_Object_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPAD_Model_Object_ID) throws IOException,ServletException {
      MappingData[] data = MappingData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Model_Object_ID, vars.getStringParameter("inpadModelObjectMappingId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamMappingName = vars.getSessionValue(tabId + "|paramMappingName");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ADImplementationMapping/Mapping_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Mapping", false, "document.frmMain.inpadModelObjectMappingId", "grid", "..", "".equals("Y"), "ADImplementationMapping", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Mapping_Relation.html", "ADImplementationMapping", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Mapping_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", MappingData.selectParent(this, strPAD_Model_Object_ID));
    else xmlDocument.setParameter("parent", MappingData.selectParentTrl(this, strPAD_Model_Object_ID));
...
String strParamMappingName = vars.getSessionValue(tabId + "|paramMappingName");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = MappingData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Model_Object_ID, strAD_Model_Object_Mapping_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = MappingData.set(strPAD_Model_Object_ID, "0", "0", Utility.getDefault(this, vars, "MappingName", "", "08F09D2A7C774585B014C06C0F44F591", "B3B9080A60E443C58F9476506EEE3D4E", "", dataField), "", Utility.getDefault(this, vars, "IsDefault", "N", "08F09D2A7C774585B014C06C0F44F591", "B3B9080A60E443C58F9476506EEE3D4E", "N", dataField), Utility.getDefault(this, vars, "Createdby", "", "08F09D2A7C774585B014C06C0F44F591", "B3B9080A60E443C58F9476506EEE3D4E", "", dataField), MappingData.selectDef802462_0(this, Utility.getDefault(this, vars, "Createdby", "", "08F09D2A7C774585B014C06C0F44F591", "B3B9080A60E443C58F9476506EEE3D4E", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "08F09D2A7C774585B014C06C0F44F591", "B3B9080A60E443C58F9476506EEE3D4E", "", dataField), MappingData.selectDef802464_1(this, Utility.getDefault(this, vars, "Updatedby", "", "08F09D2A7C774585B014C06C0F44F591", "B3B9080A60E443C58F9476506EEE3D4E", "", dataField)), "Y");
        
      }
    } else {
      data = new MappingData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(MappingData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Mapping", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpadModelObjectMappingId", "", "..", "".equals("Y"), "ADImplementationMapping", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strAD_Model_Object_Mapping_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (MappingData.getCurrentDBTimestamp(this, data.adModelObjectMappingId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Mapping. This Servlet was made by Wad constructor";

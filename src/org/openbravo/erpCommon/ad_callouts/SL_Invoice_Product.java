...
public class SL_Invoice_Product extends ProductTextHelper {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      try {
        printPage(response, vars, strUOM, strPriceList, strPriceStd, strPriceLimit, strCurrency,
            strMProductID, strADOrgID, strCInvoiceID, strIsSOTrx, strWharehouse, strTabId, strQty, strLang,strCBpartnerID);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strUOM,
      ...
      String strWharehouse, String strTabId, String strQty, String strLang, String strCBpartnerID) throws IOException, ServletException {
    if (log4j.isDebugEnabled())

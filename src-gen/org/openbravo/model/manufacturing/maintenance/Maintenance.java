 ...
 */
public class Maintenance extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_MANUFACTURINGMAINTENANCEPERIODICITYLIST =
        "manufacturingMaintenancePeriodicityList";

    public Maintenance() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_EXPLODE, false);
        setDefaultValue(PROPERTY_MANUFACTURINGMAINTENANCEPERIODICITYLIST,
    ...
    public void setManufacturingMaintenancePeriodicityList(
        List<Periodicity> manufacturingMaintenancePeriodicityList) {
        set(PROPERTY_MANUFACTURINGMAINTENANCEPERIODICITYLIST,
            manufacturingMaintenancePeriodicityList);
    }
}

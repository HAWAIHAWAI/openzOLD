...
/**
 * Entity class for entity zssm_PTaskTechDoc (stored in table zssm_ptasktechdoc).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zssm_ptasktechdoc extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zssm_ptasktechdoc";
    public static final String ENTITY_NAME = "zssm_PTaskTechDoc";

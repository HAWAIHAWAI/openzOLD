...
public class PrintProjecttask extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintProjecttask.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = new DocumentType("PROJECTTASK","C_PROJECTTASK","projecttask/","Projecttask",true,null,"c_getDefaultDocInfo");
    // The prefix PRINTORDERS is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTPROJECTTASK";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpcProjecttaskId_R");
    if (strDocumentId.equals(""))
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpcProjecttaskId");

...
public class Resourceplan  extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
      ...
      try{
        ...
        String strDateFrom = vars.getGlobalVariable("inpdatefrom", this.getClass().getName() + "|DateFrom",strDatenow);
        String strDateTo = vars.getGlobalVariable("inpdateto", this.getClass().getName() + "|DateTo", strDateend);
        String strProject = "";

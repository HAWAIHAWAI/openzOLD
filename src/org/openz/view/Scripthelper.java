...
public class Scripthelper {
  ...
  public void addBuscador(HttpSecureAppServlet servlet,VariablesSecureApp vars,String field, String template){
    ...
    if (template.equals("REFCOMBO")) {
      buscadorAceptar=buscadorAceptar + "paramsData[count++] = new Array(\"inpParam" + field + "\", ((frm.inp" + Sqlc.TransformaNombreColumna(field) + ".selectedIndex!=-1)?frm.inp" + Sqlc.TransformaNombreColumna(field) + ".options[frm.inp" + Sqlc.TransformaNombreColumna(field) + ".selectedIndex].value:\"\"));\n";
      ...
      buscadorAceptar=buscadorAceptar + "paramsData[count++] = new Array(\"inpParam" + field + "\", frm.inp" + Sqlc.TransformaNombreColumna(field) +".value);\n";
      buscadorFields=buscadorFields + ",\"inpParam" +field + "\", escape(frm.inp" + Sqlc.TransformaNombreColumna(field) + ".value)";    
    }
    buscadorReset=buscadorReset + "paramsData[count++] = new Array(\"inpParam" + field + "\", \"\");\n";

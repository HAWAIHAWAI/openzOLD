...
*/
  private LinesData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
   ...
   private LinesData[] getRelationData(LinesData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cOrderId = FormatUtilities.truncate(data[i].cOrderId, 44);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);        data[i].cBpartnerLocationId = FormatUtilities.truncate(data[i].cBpartnerLocationId, 44);        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 44);        data[i].mAttributesetinstanceId = FormatUtilities.truncate(data[i].mAttributesetinstanceId, 14);        data[i].cChargeId = FormatUtilities.truncate(data[i].cChargeId, 44);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].mProductUomId = FormatUtilities.truncate(data[i].mProductUomId, 44);        data[i].cUomId = FormatUtilities.truncate(data[i].cUomId, 44);        data[i].mShipperId = FormatUtilities.truncate(data[i].mShipperId, 44);        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 44);        data[i].cTaxId = FormatUtilities.truncate(data[i].cTaxId, 44);        data[i].aAssetId = FormatUtilities.truncate(data[i].aAssetId, 32);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, 32);        data[i].cProjecttaskId = FormatUtilities.truncate(data[i].cProjecttaskId, 32);        data[i].orderlineselfjoin = FormatUtilities.truncate(data[i].orderlineselfjoin, 32);        data[i].mWarehouseId = FormatUtilities.truncate(data[i].mWarehouseId, 44);        data[i].sResourceassignmentId = FormatUtilities.truncate(data[i].sResourceassignmentId, 14);        data[i].refOrderlineId = FormatUtilities.truncate(data[i].refOrderlineId, 44);        data[i].mOfferId = FormatUtilities.truncate(data[i].mOfferId, 44);        data[i].cProjectphaseId = FormatUtilities.truncate(data[i].cProjectphaseId, 32);        data[i].cOrderlineId = FormatUtilities.truncate(data[i].cOrderlineId, 10);}
    }
    return data;
  }
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Lines", false, "document.frmMain.inpcOrderlineId", "grid", "..", "".equals("Y"), "PurchaseOrder", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines_Relation.html", "PurchaseOrder", "W", strReplaceWith, tabs.breadcrumb());
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPC_Order_ID, Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "@M_Warehouse_ID@", "181", "293", "", dataField), Utility.getDefault(this, vars, "DatePromised", "@DatePromised@", "181", "293", "", dataField), LinesData.selectDef01D5706503CE49D6ABDE8345B5DB4642(this, strPC_Order_ID), Utility.getDefault(this, vars, "Isgrossprice", "N", "181", "293", "N", dataField), Utility.getDefault(this, vars, "QtyInvoiced", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "181", "293", "", dataField), Utility.getDefault(this, vars, "Securityqty", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "Calcfastestdeliverydate", "N", "181", "293", "N", dataField), Utility.getDefault(this, vars, "Invoicedamt", "0", "181", "293", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "181", "293", "", dataField), LinesData.selectDef2210_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "181", "293", "", dataField)), Utility.getDefault(this, vars, "QuantityOrder", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "Discount", "0", "181", "293", "", dataField), Utility.getDefault(this, vars, "LineNetAmt", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "M_Offer_ID", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "PriceLimit", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "Linegrossamt", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "181", "293", "", dataField), LinesData.selectDef2212_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "181", "293", "", dataField)), Utility.getDefault(this, vars, "QtyDelivered", "", "181", "293", "", dataField), LinesData.selectDef2213_2(this, strPC_Order_ID), Utility.getDefault(this, vars, "DirectShip", "", "181", "293", "N", dataField), Utility.getDefault(this, vars, "QtyOrdered", "1", "181", "293", "", dataField), LinesData.selectDef6F7344EDD9904E5A94A709DE5BFE09D6(this, strPC_Order_ID), Utility.getDefault(this, vars, "Ref_OrderLine_ID", "", "181", "293", "", dataField), LinesData.selectDefA48DE71600FC4CC7A352989D54135EDD(this, strPC_Order_ID), LinesData.selectDefA48DE71600FC4CC7A352989D54135EDD_3(this, LinesData.selectDefA48DE71600FC4CC7A352989D54135EDD(this, strPC_Order_ID)), Utility.getDefault(this, vars, "Ignoreresiduedate", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "181", "293", "", dataField), LinesData.selectDef8767_4(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "181", "293", "", dataField)), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "@C_BPartner_Location_ID@", "181", "293", "", dataField), "Y", Utility.getDefault(this, vars, "CANCELPRICEAD", "N", "181", "293", "N", dataField), Utility.getDefault(this, vars, "PriceActual", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "IsDescription", "N", "181", "293", "N", dataField), Utility.getDefault(this, vars, "Deliverycomplete", "N", "181", "293", "N", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "@M_Shipper_ID@", "181", "293", "", dataField), "", Utility.getDefault(this, vars, "C_Charge_ID", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "IsOneTimePosition", "N", "181", "293", "N", dataField), Utility.getDefault(this, vars, "DateInvoiced", "", "181", "293", "", dataField), LinesData.selectDef2764(this, strPC_Order_ID), LinesData.selectDef2764_5(this, LinesData.selectDef2764(this, strPC_Order_ID)), LinesData.selectDef94A94EC8613E4F9187409A87297DEB74(this, strPC_Order_ID), Utility.getDefault(this, vars, "C_UOM_ID", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "Scheddeliverydate", "@Scheddeliverydate@", "181", "293", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "181", "293", "", dataField), LinesData.selectDef2221_6(this, Utility.getDefault(this, vars, "M_Product_ID", "", "181", "293", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "181", "293", "", dataField), Utility.getDefault(this, vars, "FreightAmt", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "181", "293", "", dataField), Utility.getDefault(this, vars, "Orderlineselfjoin", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "Linetaxamt", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "QtyReserved", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "DateOrdered", "@DateOrdered@", "181", "293", "", dataField), Utility.getDefault(this, vars, "S_ResourceAssignment_ID", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "PriceStd", "0", "181", "293", "", dataField), Utility.getDefault(this, vars, "Calloffqty", "", "181", "293", "", dataField), LinesData.selectDef2214(this, strPC_Order_ID), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "181", "293", "", dataField), Utility.getDefault(this, vars, "DateDelivered", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "PriceList", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "Issummaryitem", "N", "181", "293", "N", dataField), Utility.getDefault(this, vars, "C_Tax_ID", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "Description", "", "181", "293", "", dataField), Utility.getDefault(this, vars, "Ignoreresidue", "N", "181", "293", "N", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Lines", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcOrderlineId", "", "..", "".equals("Y"), "PurchaseOrder", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_OrderLine_ID));

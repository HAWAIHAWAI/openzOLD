 ...
 */
public class Selector extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ADSELECTORCOLUMNLIST =
        "aDSelectorColumnList";
    ...
    public void setADSelectorColumnList(
        List<SelectorColumn> aDSelectorColumnList) {

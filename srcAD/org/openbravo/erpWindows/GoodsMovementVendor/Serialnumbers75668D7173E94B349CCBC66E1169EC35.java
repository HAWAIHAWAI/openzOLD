...
public class Serialnumbers75668D7173E94B349CCBC66E1169EC35 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Serialnumbers75668D7173E94B349CCBC66E1169EC35.class);
  
  private static final String windowId = "184";
  private static final String tabId = "75668D7173E94B349CCBC66E1169EC35";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Serialnumbers75668D7173E94B349CCBC66E1169EC35.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(windowId + "|M_Inoutline_ID", strPM_Inoutline_ID);
      vars.setSessionValue("297|Lines.view", "EDIT");
      vars.removeSessionValue(windowId + "|M_InOut_ID");
      refreshParentSession(vars, strPM_Inoutline_ID);

      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Serialnumbers75668D7173E94B349CCBC66E1169EC35.view", "EDIT");

        printPageEdit(response, request, vars, false, strSNR_Minoutline_ID, strPM_Inoutline_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Serialnumbers75668D7173E94B349CCBC66E1169EC35.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamRfidnumber", tabId + "|paramRfidnumber");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strSNR_Minoutline_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Serialnumbers75668D7173E94B349CCBC66E1169EC35.view", strView);
        }
      }
...
vars.getGlobalVariable("inpmInoutlineId", windowId + "|M_Inoutline_ID");
      ...
      vars.setSessionValue(tabId + "|Serialnumbers75668D7173E94B349CCBC66E1169EC35.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPM_Inoutline_ID = vars.getGlobalVariable("inpmInoutlineId", windowId + "|M_Inoutline_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Serialnumbers75668D7173E94B349CCBC66E1169EC35.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Serialnumbers75668D7173E94B349CCBC66E1169EC35.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|SNR_Minoutline_ID");
      vars.setSessionValue(windowId + "|M_Inoutline_ID", strPM_Inoutline_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strSNR_Minoutline_ID = vars.getRequiredStringParameter("inpsnrMinoutlineId");
      //Serialnumbers75668D7173E94B349CCBC66E1169EC35Data data = getEditVariables(vars, strPM_Inoutline_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.delete(this, strSNR_Minoutline_ID, strPM_Inoutline_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strSNR_Minoutline_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.deleteTransactional(conn, this, strKey, strPM_Inoutline_ID)==0) {
...
*/
  private Serialnumbers75668D7173E94B349CCBC66E1169EC35Data getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Inoutline_ID) throws IOException,ServletException {
   ...
   private Serialnumbers75668D7173E94B349CCBC66E1169EC35Data[] getRelationData(Serialnumbers75668D7173E94B349CCBC66E1169EC35Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].mInoutlineId = FormatUtilities.truncate(data[i].mInoutlineId, 32);        data[i].snrMinoutlineId = FormatUtilities.truncate(data[i].snrMinoutlineId, 32);        data[i].serialnumber = FormatUtilities.truncate(data[i].serialnumber, 40);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].lotnumber = FormatUtilities.truncate(data[i].lotnumber, 40);        data[i].rfidnumber = FormatUtilities.truncate(data[i].rfidnumber, 40);        data[i].description = FormatUtilities.truncate(data[i].description, 50);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPM_Inoutline_ID) throws IOException,ServletException {
      ...
      vars.setSessionValue(windowId + "|Processed", LinesData.selectAux56653DE396CD4C2DBF54D7FA526656D3(this, Utility.getContext(this, vars, "M_INOUT_ID", "184")));
      
      vars.setSessionValue(windowId + "|HASSECONDUOM", LinesData.selectAux800005(this, Utility.getContext(this, vars, "M_Product_ID", "184")));
      
      vars.setSessionValue(windowId + "|C_BPARTNER_ID", Utility.getContext(this, vars, "C_BPARTNER_ID", "184"));
      
  }
    
  private String getParentID(VariablesSecureApp vars, String strSNR_Minoutline_ID) throws ServletException {
    String strPM_Inoutline_ID = Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.selectParentID(this, strSNR_Minoutline_ID);
    if (strPM_Inoutline_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPM_Inoutline_ID) throws IOException,ServletException {
      Serialnumbers75668D7173E94B349CCBC66E1169EC35Data[] data = Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Inoutline_ID, vars.getStringParameter("inpsnrMinoutlineId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamRfidnumber = vars.getSessionValue(tabId + "|paramRfidnumber");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/GoodsMovementVendor/Serialnumbers75668D7173E94B349CCBC66E1169EC35_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Serialnumbers75668D7173E94B349CCBC66E1169EC35", false, "document.frmMain.inpsnrMinoutlineId", "grid", "..", "".equals("Y"), "GoodsMovementVendor", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Serialnumbers75668D7173E94B349CCBC66E1169EC35_Relation.html", "GoodsMovementVendor", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Serialnumbers75668D7173E94B349CCBC66E1169EC35_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.selectParent(this, vars.getLanguage(), strPM_Inoutline_ID));
    else xmlDocument.setParameter("parent", Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.selectParentTrl(this, vars.getLanguage(), strPM_Inoutline_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strSNR_Minoutline_ID, String strPM_Inoutline_ID, TableSQLData tableSQL)
    ...
    Serialnumbers75668D7173E94B349CCBC66E1169EC35Data[] data=null;
...
String strParamRfidnumber = vars.getSessionValue(tabId + "|paramRfidnumber");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Inoutline_ID, strSNR_Minoutline_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new Serialnumbers75668D7173E94B349CCBC66E1169EC35Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.set(strPM_Inoutline_ID, Utility.getDefault(this, vars, "Guaranteedate", "", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField), Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.selectDefAF17F3E502804AB7AE13406ABF2B2890(this, strPM_Inoutline_ID), Utility.getDefault(this, vars, "Isunavailable", "N", "184", "75668D7173E94B349CCBC66E1169EC35", "N", dataField), Utility.getDefault(this, vars, "Serialnumber", "", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField), Utility.getDefault(this, vars, "Rfidnumber", "", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField), Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.selectDefB15BCF19B3D74BA9AA72A278C34A9B08_0(this, Utility.getDefault(this, vars, "Updatedby", "", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField)), Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.selectDef9A006BE6F4604724BECAF2DA089118EC(this, Utility.getContext(this, vars, "ad_org_id", "184"), "N", strPM_Inoutline_ID), Utility.getDefault(this, vars, "Createdby", "", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField), Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.selectDefD8F5A42696D449F0B636CA85AB6D830A_1(this, Utility.getDefault(this, vars, "Createdby", "", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField), Utility.getDefault(this, vars, "Description", "", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField), "", "Y", Utility.getDefault(this, vars, "Guaranteedays", "", "184", "75668D7173E94B349CCBC66E1169EC35", "", dataField));
        
      }
    } else {
      data = new Serialnumbers75668D7173E94B349CCBC66E1169EC35Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(Serialnumbers75668D7173E94B349CCBC66E1169EC35Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Serialnumbers75668D7173E94B349CCBC66E1169EC35", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpsnrMinoutlineId", "", "..", "".equals("Y"), "GoodsMovementVendor", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strSNR_Minoutline_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Serialnumbers75668D7173E94B349CCBC66E1169EC35Data.getCurrentDBTimestamp(this, data.snrMinoutlineId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Serialnumbers75668D7173E94B349CCBC66E1169EC35. This Servlet was made by Wad constructor";

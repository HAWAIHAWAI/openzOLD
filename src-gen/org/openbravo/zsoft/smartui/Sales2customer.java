...
/**
 * Entity class for entity zssi_sales2customer (stored in table zssi_sales2customer).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Sales2customer extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zssi_sales2customer";
    public static final String ENTITY_NAME = "zssi_sales2customer";

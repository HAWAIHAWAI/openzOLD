    ...
    HashMap<String, Object> parameters = new HashMap<String, Object>();
        try {
          if (strReportType.equals("OrdersContracted")||strReportType.equals("EstInvoice")){
            ...
            parameters.put("ROW1_LEVEL", new Integer(intOrderLevel));
            parameters.put("ROW2_LEVEL", new Integer(intOrderLevel));
            parameters.put("ROW3_LEVEL", new Integer(intOrderLevel));
            parameters.put("ROW4_LEVEL", new Integer(intProductLevel));
          ...
          if (strReportType.equals("ProjectMargins")) {
            ...
            parameters.put("ROW1_LEVEL", new Integer(intOrderLevel));
            parameters.put("ROW2_LEVEL", new Integer(intProjectLevel));
            parameters.put("ROW3_LEVEL", new Integer(intProjectLevel));
            parameters.put("ROW4_LEVEL", new Integer(intProjectLevel));

...
*/
  private LinesData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Invoice_ID) throws IOException,ServletException {
   ...
   private LinesData[] getRelationData(LinesData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cInvoiceId = FormatUtilities.truncate(data[i].cInvoiceId, 44);        data[i].cOrderlineId = FormatUtilities.truncate(data[i].cOrderlineId, 44);        data[i].mInoutlineId = FormatUtilities.truncate(data[i].mInoutlineId, 44);        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 44);        data[i].mAttributesetinstanceId = FormatUtilities.truncate(data[i].mAttributesetinstanceId, 14);        data[i].sResourceassignmentId = FormatUtilities.truncate(data[i].sResourceassignmentId, 14);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].mProductUomId = FormatUtilities.truncate(data[i].mProductUomId, 44);        data[i].cUomId = FormatUtilities.truncate(data[i].cUomId, 44);        data[i].cTaxId = FormatUtilities.truncate(data[i].cTaxId, 44);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, 32);        data[i].cProjecttaskId = FormatUtilities.truncate(data[i].cProjecttaskId, 32);        data[i].aAssetId = FormatUtilities.truncate(data[i].aAssetId, 32);        data[i].cChargeId = FormatUtilities.truncate(data[i].cChargeId, 44);        data[i].cInvoicelineId = FormatUtilities.truncate(data[i].cInvoicelineId, 10);        data[i].cProjectphaseId = FormatUtilities.truncate(data[i].cProjectphaseId, 32);        data[i].mOfferId = FormatUtilities.truncate(data[i].mOfferId, 44);        data[i].reinvoicedbyId = FormatUtilities.truncate(data[i].reinvoicedbyId, 32);}
    }
    return data;
  }
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Lines", false, "document.frmMain.inpcInvoicelineId", "grid", "..", "".equals("Y"), "SalesInvoice", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines_Relation.html", "SalesInvoice", "W", strReplaceWith, tabs.breadcrumb());
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_InvoiceLine_ID, String strPC_Invoice_ID, TableSQLData tableSQL)
    ...
    String orderClause = " C_InvoiceLine.QuantityOrder,  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL12.Name IS NULL THEN TO_CHAR(table12.Name) ELSE TO_CHAR(tableTRL12.Name) END)), ''))),'') ), C_InvoiceLine.Line";
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    vars.setSessionValue(windowId + "|HASSECONDUOM", strHASSECONDUOM);
        String strC_BPARTNER_ID = Utility.getContext(this, vars, "C_BPARTNER_ID", "167");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPC_Invoice_ID, Utility.getDefault(this, vars, "C_UOM_ID", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "167", "270", "", dataField), Utility.getDefault(this, vars, "PriceLimit", "", "167", "270", "", dataField), LinesData.selectDef3836_0(this, strPC_Invoice_ID), Utility.getDefault(this, vars, "QuantityOrder", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "M_Offer_ID", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "Description", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "PriceStd", "0", "167", "270", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "167", "270", "", dataField), LinesData.selectDef3838(this, strPC_Invoice_ID), Utility.getDefault(this, vars, "PriceList", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "Created", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "Linegrossamt", "0", "167", "270", "", dataField), Utility.getDefault(this, vars, "LineNetAmt", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "167", "270", "", dataField), LinesData.selectDef8553_1(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "167", "270", "", dataField)), Utility.getDefault(this, vars, "Reinvoicedby_ID", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "C_OrderLine_ID", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "", "167", "270", "", dataField), LinesData.selectDef4611D8B935474793AA95D7C78B750147(this, strPC_Invoice_ID), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "167", "270", "", dataField), LinesData.selectDef3835_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "167", "270", "", dataField)), Utility.getDefault(this, vars, "Excludeforwithholding", "", "167", "270", "N", dataField), Utility.getDefault(this, vars, "S_ResourceAssignment_ID", "", "167", "270", "", dataField), "Y", Utility.getDefault(this, vars, "Linetaxamt", "0", "167", "270", "", dataField), LinesData.selectDefE613BADFF69444FE8BFD5D28D22CC1B2(this, strPC_Invoice_ID), "", LinesData.selectDefD368B486C6AC439D983B03CF4755EF72(this, strPC_Invoice_ID), Utility.getDefault(this, vars, "M_InOutLine_ID", "", "167", "270", "", dataField), LinesData.selectDef4251_3(this, Utility.getDefault(this, vars, "M_InOutLine_ID", "", "167", "270", "", dataField)), LinesData.selectDefC5F1E0FC079F4FCBAE27B1990366A8E5(this, strPC_Invoice_ID), LinesData.selectDefC5F1E0FC079F4FCBAE27B1990366A8E5_4(this, LinesData.selectDefC5F1E0FC079F4FCBAE27B1990366A8E5(this, strPC_Invoice_ID)), LinesData.selectDefD794AA02F9E34A3E858EA7EDBC5F98E4(this, strPC_Invoice_ID), Utility.getDefault(this, vars, "IsDescription", "N", "167", "270", "N", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "167", "270", "", dataField), LinesData.selectDef3840_5(this, Utility.getDefault(this, vars, "M_Product_ID", "", "167", "270", "", dataField)), Utility.getDefault(this, vars, "TaxAmt", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "C_Tax_ID", "", "167", "270", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "167", "270", "", dataField), LinesData.selectDef3833_6(this, Utility.getDefault(this, vars, "CreatedBy", "", "167", "270", "", dataField)), Utility.getDefault(this, vars, "QtyInvoiced", "1", "167", "270", "", dataField), Utility.getDefault(this, vars, "PriceActual", "", "167", "270", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Lines", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcInvoicelineId", "", "..", "".equals("Y"), "SalesInvoice", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_InvoiceLine_ID));

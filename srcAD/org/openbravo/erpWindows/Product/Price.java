...
*/
  private PriceData getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Product_ID) throws IOException,ServletException {
   ...
   private PriceData[] getRelationData(PriceData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].mProductpriceId = FormatUtilities.truncate(data[i].mProductpriceId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 44);        data[i].mPricelistVersionId = FormatUtilities.truncate(data[i].mPricelistVersionId, 44);}
    }
    return data;
  }
...
String strParamM_PriceList_Version_ID = vars.getSessionValue(tabId + "|paramM_PriceList_Version_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PriceData.set(strPM_Product_ID, PriceData.selectDef2064_0(this, strPM_Product_ID), Utility.getDefault(this, vars, "PriceList", "", "140", "183", "", dataField), Utility.getDefault(this, vars, "PriceStd", "", "140", "183", "", dataField), "Y", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "140", "183", "", dataField), Utility.getDefault(this, vars, "PriceLimit", "", "140", "183", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "140", "183", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "140", "183", "", dataField), PriceData.selectDef2060_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "140", "183", "", dataField)), Utility.getDefault(this, vars, "M_PriceList_Version_ID", "", "140", "183", "", dataField), "", Utility.getDefault(this, vars, "UpdatedBy", "", "140", "183", "", dataField), PriceData.selectDef2062_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "140", "183", "", dataField)));

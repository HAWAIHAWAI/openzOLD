...
/**
 * Entity class for entity zssm_workstepdependencies_v (stored in table zssm_workstepdependencies_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zssm_workstepdependencies_v extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zssm_workstepdependencies_v";
    public static final String ENTITY_NAME = "zssm_workstepdependencies_v";
    ...
    public zssm_workstepdependencies_v() {
    ...
    public String getZspmProjecttaskdep() {
        return (String) get(PROPERTY_ZSPMPROJECTTASKDEP);
    }

    public void setZspmProjecttaskdep(String zspmProjecttaskdep) {

...
/**
 * Entity class for entity BusinessPartnerLineOfBusiness (stored in table c_lineofbusiness).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class c_lineofbusiness extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "c_lineofbusiness";
    public static final String ENTITY_NAME = "BusinessPartnerLineOfBusiness";

...
public class SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432.class);
  
  private static final String windowId = "3EDBDA862FB34742B06F0FA5633A172F";
  private static final String tabId = "8607F359EB8641AF8737E2F1473EC432";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432.view", "EDIT");

        printPageEdit(response, request, vars, false, strSNR_Serialnumbertracking_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamGuaranteedate_f", tabId + "|paramGuaranteedate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strSNR_Serialnumbertracking_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|SNR_Serialnumbertracking_ID");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strSNR_Serialnumbertracking_ID = vars.getRequiredStringParameter("inpsnrSerialnumbertrackingId");
      //SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.delete(this, strSNR_Serialnumbertracking_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strSNR_Serialnumbertracking_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.deleteTransactional(conn, this, strKey)==0) {
...
*/
  private SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data data = new SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data();
   ...
   private SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[] getRelationData(SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[] data) {
    if (data!=null) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[] data = SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inpsnrSerialnumbertrackingId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamGuaranteedate_f = vars.getSessionValue(tabId + "|paramGuaranteedate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/zsoft/serial/SerialNumberTransactions/SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432", false, "document.frmMain.inpsnrSerialnumbertrackingId", "grid", "..", "".equals("Y"), "SerialNumberTransactions", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432_Relation.html", "SerialNumberTransactions", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strSNR_Serialnumbertracking_ID, TableSQLData tableSQL)
    ...
    String orderClause = " snr_serialnumbertracking.movementdate desc";
    ...
    SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[] data=null;
...
String strParamGuaranteedate_f = vars.getSessionValue(tabId + "|paramGuaranteedate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strSNR_Serialnumbertracking_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.set(Utility.getDefault(this, vars, "M_Inoutline_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDef90CAE05DF99641938BECABEA651659F3_0(this, Utility.getDefault(this, vars, "M_Inoutline_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "Assembly_Productid", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDefA71F774962944D41B980C9C2D5B34669_1(this, Utility.getDefault(this, vars, "Assembly_Productid", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "M_Movement_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), "", "Y", Utility.getDefault(this, vars, "Description", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Quantity", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "M_Inventoryline_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Movementdate", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "M_Internal_Consumptionline_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Guaranteedate", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Lotnumber", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "M_Movementline_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDef775B3326D4104402A931CEDBFEA06933_2(this, Utility.getDefault(this, vars, "Createdby", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "Movementtype", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "M_Internal_Consumption_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Assembly_Snr", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDefABA0AE095068430AAF34BB38C525657A_3(this, Utility.getDefault(this, vars, "Updatedby", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "M_Inventory_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Guaranteedays", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "M_Attributesetinstance_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDefD6E8C36F2B8F4CC7AB52999AB9D274DA_4(this, Utility.getDefault(this, vars, "M_Attributesetinstance_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "M_Inout_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDefB78C46BB7000448EA0E2B35DF351ADC6_5(this, Utility.getDefault(this, vars, "M_Inout_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDefFE03AA8BA4B7448088819DDAB664189F_6(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Rfidnumber", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Docstatus", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "Serialnumber", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), Utility.getDefault(this, vars, "M_Locator_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDefC25C3D6A592D47C8B084245749AD006C_7(this, Utility.getDefault(this, vars, "M_Locator_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "C_Project_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDef4F68001A1827490B8E25617CCFE9A835_8(this, Utility.getDefault(this, vars, "C_Project_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "C_Orderline_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDef8E2C92CCC5F547E998DC56323ADBAB8F_9(this, Utility.getDefault(this, vars, "C_Orderline_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "M_Product_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField), SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.selectDefED4444A033624267A14E465923306FF7_10(this, Utility.getDefault(this, vars, "M_Product_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField)), Utility.getDefault(this, vars, "A_Asset_ID", "", "3EDBDA862FB34742B06F0FA5633A172F", "8607F359EB8641AF8737E2F1473EC432", "", dataField));
        
      }
    } else {
      data = new SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpsnrSerialnumbertrackingId", "", "..", "".equals("Y"), "SerialNumberTransactions", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strSNR_Serialnumbertracking_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.getCurrentDBTimestamp(this, data.snrSerialnumbertrackingId).equals(
  ...
  public String getServletInfo() {
    return "Servlet SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432. This Servlet was made by Wad constructor";

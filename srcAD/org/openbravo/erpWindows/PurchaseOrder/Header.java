...
*/
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private HeaderData[] getRelationData(HeaderData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 48);        data[i].documentno = FormatUtilities.truncate(data[i].documentno, 8);        data[i].poreference = FormatUtilities.truncate(data[i].poreference, 11);        data[i].cDoctypetargetId = FormatUtilities.truncate(data[i].cDoctypetargetId, 44);        data[i].name = FormatUtilities.truncate(data[i].name, 50);        data[i].cDoctypeId = FormatUtilities.truncate(data[i].cDoctypeId, 44);        data[i].docstatus = FormatUtilities.truncate(data[i].docstatus, 21);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].deliverynotes = FormatUtilities.truncate(data[i].deliverynotes, 50);        data[i].internalnote = FormatUtilities.truncate(data[i].internalnote, 50);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);        data[i].bpzipcode = FormatUtilities.truncate(data[i].bpzipcode, 10);        data[i].billtoId = FormatUtilities.truncate(data[i].billtoId, 45);        data[i].cBpartnerLocationId = FormatUtilities.truncate(data[i].cBpartnerLocationId, 45);        data[i].adUserId = FormatUtilities.truncate(data[i].adUserId, 44);        data[i].salesrepId = FormatUtilities.truncate(data[i].salesrepId, 30);        data[i].mPricelistId = FormatUtilities.truncate(data[i].mPricelistId, 44);        data[i].mWarehouseId = FormatUtilities.truncate(data[i].mWarehouseId, 44);        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 20);        data[i].priorityrule = FormatUtilities.truncate(data[i].priorityrule, 21);        data[i].paymentrule = FormatUtilities.truncate(data[i].paymentrule, 21);        data[i].cPaymenttermId = FormatUtilities.truncate(data[i].cPaymenttermId, 44);        data[i].deliveryviarule = FormatUtilities.truncate(data[i].deliveryviarule, 23);        data[i].cIncotermsId = FormatUtilities.truncate(data[i].cIncotermsId, 44);        data[i].incotermsdescription = FormatUtilities.truncate(data[i].incotermsdescription, 50);        data[i].aAssetId = FormatUtilities.truncate(data[i].aAssetId, 32);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, 32);        data[i].cProjecttaskId = FormatUtilities.truncate(data[i].cProjecttaskId, 32);        data[i].cBidprojectId = FormatUtilities.truncate(data[i].cBidprojectId, 32);        data[i].freightcostrule = FormatUtilities.truncate(data[i].freightcostrule, 21);        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 32);        data[i].transactionreference = FormatUtilities.truncate(data[i].transactionreference, 32);        data[i].quarterlyMonth = FormatUtilities.truncate(data[i].quarterlyMonth, 50);        data[i].dropshipUserId = FormatUtilities.truncate(data[i].dropshipUserId, 44);        data[i].dropshipBpartnerId = FormatUtilities.truncate(data[i].dropshipBpartnerId, 44);        data[i].dropshipLocationId = FormatUtilities.truncate(data[i].dropshipLocationId, 44);        data[i].proposalstatus = FormatUtilities.truncate(data[i].proposalstatus, 50);        data[i].adOrgtrxId = FormatUtilities.truncate(data[i].adOrgtrxId, 44);        data[i].cOrderId = FormatUtilities.truncate(data[i].cOrderId, 10);        data[i].weeklyDay = FormatUtilities.truncate(data[i].weeklyDay, 50);        data[i].user1Id = FormatUtilities.truncate(data[i].user1Id, 44);        data[i].user2Id = FormatUtilities.truncate(data[i].user2Id, 44);        data[i].estpropability = FormatUtilities.truncate(data[i].estpropability, 50);        data[i].deliveryLocationId = FormatUtilities.truncate(data[i].deliveryLocationId, 44);        data[i].lostproposalfixedreason = FormatUtilities.truncate(data[i].lostproposalfixedreason, 30);        data[i].weightUom = FormatUtilities.truncate(data[i].weightUom, 32);        data[i].orderselfjoin = FormatUtilities.truncate(data[i].orderselfjoin, 32);        data[i].invoicefrequence = FormatUtilities.truncate(data[i].invoicefrequence, 50);        data[i].yearlyMonth = FormatUtilities.truncate(data[i].yearlyMonth, 50);        data[i].cProjectphaseId = FormatUtilities.truncate(data[i].cProjectphaseId, 32);        data[i].mShipperId = FormatUtilities.truncate(data[i].mShipperId, 44);        data[i].lostproposalreason = FormatUtilities.truncate(data[i].lostproposalreason, 50);        data[i].cCampaignId = FormatUtilities.truncate(data[i].cCampaignId, 44);        data[i].invoicerule = FormatUtilities.truncate(data[i].invoicerule, 21);        data[i].cChargeId = FormatUtilities.truncate(data[i].cChargeId, 44);        data[i].cActivityId = FormatUtilities.truncate(data[i].cActivityId, 44);        data[i].deliveryrule = FormatUtilities.truncate(data[i].deliveryrule, 21);}
    }
    return data;
  }
...
String strParamInvoicedamt_f = vars.getSessionValue(tabId + "|paramInvoicedamt_f");
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Header", false, "document.frmMain.inpcOrderId", "grid", "../orders/print.html", "N".equals("Y"), "PurchaseOrder", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "PurchaseOrder", "W", strReplaceWith, tabs.breadcrumb());
...
String strParamInvoicedamt_f = vars.getSessionValue(tabId + "|paramInvoicedamt_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cOrderId") == null || dataField.getField("cOrderId").equals("")) {
        ...
        String strORDERTYPE = HeaderData.selectAux8(this, ((dataField!=null)?dataField.getField("cDoctypetargetId"):((data==null || data.length==0)?"":data[0].cDoctypetargetId)));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "Quarterly_Month", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "181", "294", "", dataField), HeaderData.selectDef2762_0(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "181", "294", "", dataField)), Utility.getDefault(this, vars, "Firstschedinvoicedate", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "PriorityRule", "5", "181", "294", "", dataField), Utility.getDefault(this, vars, "Deliver2projectadress", "'N'", "181", "294", "N", dataField), Utility.getDefault(this, vars, "DropShip_Location_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "BillTo_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_Incoterms_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "IsSelected", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Iscompletelyinvoiced", "N", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Yearly_Month", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "IsTaxIncluded", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Orderselfjoin", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_Projectphase_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "TotalLines", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Enddate", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Lostproposalreason", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Posted", "N", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Transactiondate", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Name", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "181", "294", "", dataField), Utility.getDefault(this, vars, "Closeproject", "N", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Incotermsdescription", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Isinvoiceafterfirstcycle", "Y", "181", "294", "N", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Totalpaid", "0", "181", "294", "", dataField), Utility.getDefault(this, vars, "Internalnote", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Grandtotalonetime", "0", "181", "294", "", dataField), Utility.getDefault(this, vars, "InvoiceRule", "D", "181", "294", "", dataField), Utility.getDefault(this, vars, "IsDiscountPrinted", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "DropShip_BPartner_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Weekly_Day", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Estpropability", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "DatePromised", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Contractdate", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "181", "294", "", dataField), HeaderData.selectDef3402_1(this, Utility.getDefault(this, vars, "C_Project_ID", "", "181", "294", "", dataField)), Utility.getDefault(this, vars, "PaymentRule", "B", "181", "294", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "181", "294", "", dataField), HeaderData.selectDef2168_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "181", "294", "", dataField)), Utility.getDefault(this, vars, "DeliveryRule", "A", "181", "294", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "POReference", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Monthly_Day", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Invoicedamt", "0", "181", "294", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Subscriptionchangedate", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Lostproposalfixedreason", "", "181", "294", "", dataField), "", Utility.getDefault(this, vars, "CopyFrom", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "IsDelivered", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "181", "294", "N", dataField), Utility.getDefault(this, vars, "IsSelfService", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "181", "294", "", dataField), HeaderData.selectDef2166_3(this, Utility.getDefault(this, vars, "CreatedBy", "", "181", "294", "", dataField)), Utility.getDefault(this, vars, "Deliverycomplete", "N", "181", "294", "N", dataField), Utility.getDefault(this, vars, "DateOrdered", "@#Date@", "181", "294", "", dataField), Utility.getDefault(this, vars, "Schedtransactiondate", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Generatetemplate", "N", "181", "294", "N", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "DropShip_User_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "CopyFromPO", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Scheddeliverydate", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Delivery_Location_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "181", "294", "", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "181", "294", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "181", "294", "", dataField), Utility.getDefault(this, vars, "bpzipcode", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_DocTypeTarget_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "BtnCopyTemplate", "N", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Transactionreference", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Invoicefrequence", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Deliverynotes", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "C_Bidproject_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Processed", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Totallinesonetime", "0", "181", "294", "", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "P", "181", "294", "", dataField), Utility.getDefault(this, vars, "Isrecharge", "Y", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Description", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "FreightCostRule", "I", "181", "294", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "181", "294", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "181", "294", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "181", "294", "N", dataField))), Utility.getDefault(this, vars, "IsPrinted", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "GrandTotal", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Weight_Uom", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Ispaid", "N", "181", "294", "N", dataField), Utility.getDefault(this, vars, "IsInvoiced", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Weight", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Proposalstatus", "OP", "181", "294", "", dataField), "Y", Utility.getDefault(this, vars, "C_DocType_ID", "0", "181", "294", "", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Generateproject", "N", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Processing", "", "181", "294", "N", dataField), Utility.getDefault(this, vars, "Qty", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "FreightAmt", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "", "181", "294", "", dataField), Utility.getDefault(this, vars, "Completeordervalue", "0", "181", "294", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcOrderId", "", "../orders/print.html", "N".equals("Y"), "PurchaseOrder", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Order_ID));
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private String getDisplayLogicContext(VariablesSecureApp vars, boolean isNew) throws IOException, ServletException {
      ...
      String result = "var strREINVOICEPROJECTEXPENSES=\"" +Utility.getContext(this, vars, "REINVOICEPROJECTEXPENSES", windowId) + "\";\nvar strShowAudit=\"" +(isNew?"N":Utility.getContext(this, vars, "ShowAudit", windowId)) + "\";\nvar strDOCNOREADONLY=\"" + Utility.getContext(this, vars, "DOCNOREADONLY", windowId) + "\";\n";
      return result;
    }

...
vars.getRequestGlobalVariable("inpParamName", tabId + "|paramName");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strAD_Client_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Client.view", strView);
        }
      }
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = ClientData.delete(this, strAD_Client_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
      ...
      response.sendRedirect(strDireccion + request.getServletPath());
    ...
    } else if (vars.commandIn("BUTTONrequestuserpw")) {
        String strAD_Client_ID = vars.getGlobalVariable("inpadClientId", windowId + "|AD_Client_ID", "");
        
        printPageButtonrequestuserpw(request, response, vars, strAD_Client_ID);

    } else if (vars.commandIn("SAVE_BUTTONrequestuserpw")) {
        String strAD_Client_ID = vars.getGlobalVariable("inpKey", windowId + "|AD_Client_ID", "");
        String strrequestuserpw = FormatUtilities.encryptDecrypt(vars.getStringParameter("inpValue"), true);
        ...
        int count = 0;
        try {
          count = ClientData.updaterequestuserpw(this, strrequestuserpw, strAD_Client_ID);
        } catch(ServletException ex) {
          myError = Utility.translateError(this, vars, vars.getLanguage(), ex.getMessage());
          if (!myError.isConnectionAvailable()) {
            bdErrorConnection(response);
    ...
    try {
      ...
      if (!strAD_Client_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (ClientData.deleteTransactional(conn, this, strKey)==0) {
...
*/
  private ClientData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private ClientData[] getRelationData(ClientData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].value = FormatUtilities.truncate(data[i].value, 20);        data[i].name = FormatUtilities.truncate(data[i].name, 20);        data[i].description = FormatUtilities.truncate(data[i].description, 30);        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 8);        data[i].adLanguage = FormatUtilities.truncate(data[i].adLanguage, 20);        data[i].smtphost = FormatUtilities.truncate(data[i].smtphost, 30);        data[i].requestemail = FormatUtilities.truncate(data[i].requestemail, 30);        data[i].requestfolder = FormatUtilities.truncate(data[i].requestfolder, 20);        data[i].requestuser = FormatUtilities.truncate(data[i].requestuser, 20);        data[i].requestuserpw = FormatUtilities.truncate(data[i].requestuserpw, 30);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);}
    }
    return data;
  }
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      ClientData[] data = ClientData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inpadClientId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamName = vars.getSessionValue(tabId + "|paramName");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Client/Client_Relation", discard).createXmlDocument();
...
String strParamName = vars.getSessionValue(tabId + "|paramName");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = ClientData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strAD_Client_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ClientData.set(Utility.getDefault(this, vars, "Name", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "RequestEMail", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "RequestFolder", "", "109", "145", "", dataField), "0", Utility.getDefault(this, vars, "Description", "", "109", "145", "", dataField), "Y", Utility.getDefault(this, vars, "UpdatedBy", "", "109", "145", "", dataField), ClientData.selectDef621_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "109", "145", "", dataField)), "", Utility.getDefault(this, vars, "requestuserpw", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "AD_Language", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "IsMultiLingualDocument", "", "109", "145", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "0", "109", "145", "", dataField), ClientData.selectDef619_1(this, Utility.getDefault(this, vars, "CreatedBy", "0", "109", "145", "", dataField)), Utility.getDefault(this, vars, "Value", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "IsSmtpAuthorization", "N", "109", "145", "N", dataField), Utility.getDefault(this, vars, "SMTPHost", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "RequestUser", "", "109", "145", "", dataField));
        
      }
    } else {
      data = new ClientData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(ClientData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Client", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpadClientId", "", "..", "".equals("Y"), "Client", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strAD_Client_ID));
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonrequestuserpw(HttpServletRequest request, HttpServletResponse response, VariablesSecureApp vars, String strAD_Client_ID)
    throws IOException, ServletException {
      log4j.debug("Output: Button Encrypted requestuserpw");
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      ...
      if (ClientData.checkrequestuserpw(this, strAD_Client_ID).equals("0")) {
        ...
        xmlDocument.setParameter("theme", vars.getTheme());
        xmlDocument.setParameter("realName", "requestuserpw");
        xmlDocument.setParameter("key", strAD_Client_ID);
        xmlDocument.setParameter("keyName", "adClientId");
        xmlDocument.setParameter("form", "Client_Edition.html");
        xmlDocument.setParameter("fieldId", "5164");
        xmlDocument.setParameter("fieldLabel", Utility.messageBD(this, "requestuserpw", vars.getLanguage()));
        xmlDocument.setParameter("fieldColumnName", "requestuserpw");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (ClientData.getCurrentDBTimestamp(this, data.adClientId).equals(

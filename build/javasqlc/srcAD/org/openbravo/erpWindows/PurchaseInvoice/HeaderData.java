...
Create a registry
 */
  public static HeaderData[] set(String cDoctypetargetId, String copyfrom, String isgrossinvoice, String cProjectphaseId, String salesrepId, String totallines, String dueamt, String adOrgtrxId, String cInvoiceId, String daystilldue, String dateinvoiced, String cBpartnerId, String cBpartnerIdr, String processing, String posted, String postedBtn, String lastcalculatedondate, String isprinted, String dateordered, String ispaymentshedulesummary, String dateacct, String deliveryrule, String performanceperiodstart, String cCurrencyId, String internalnote, String cBpartnerLocationId, String adUserId, String performanceperiodend, String totalpaid, String cActivityId, String updatepaymentmonitor, String issotrx, String created, String cDoctypeId, String processed, String cChargeId, String isactive, String user1Id, String cPaymenttermId, String cCampaignId, String createdby, String createdbyr, String adOrgId, String discountamt, String taxdate, String istaxincluded, String schedtransactiondate, String isdiscountprinted, String description, String cProjectId, String cProjectIdr, String chargeamt, String transactiondate, String mPricelistId, String isselfservice, String outstandingamt, String docstatus, String aAssetId, String cProjecttaskId, String docaction, String docactionBtn, String ispaid, String cWithholdingId, String user2Id, String grandtotal, String poreference, String createfrom, String paymentrule, String generateto, String updatedby, String updatedbyr, String withholdingamount, String dateprinted, String adClientId, String btnreinvoiceprojectexpenses, String documentno, String writeoffamt, String cOrderId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_Invoice" +
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , C_Order_ID = (?) , DateOrdered = TO_DATE(?) , DocumentNo = (?) , POReference = (?) , Description = (?) , Internalnote = (?) , C_DocTypeTarget_ID = (?) , DateInvoiced = TO_DATE(?) , DateAcct = TO_DATE(?) , TransactionDate = TO_DATE(?) , SchedTransactionDate = TO_DATE(?) , C_BPartner_ID = (?) , C_BPartner_Location_ID = (?) , AD_User_ID = (?) , M_PriceList_ID = (?) , C_Currency_ID = (?) , SalesRep_ID = (?) , IsDiscountPrinted = (?) , C_Charge_ID = (?) , ChargeAmt = TO_NUMBER(?) , PaymentRule = (?) , C_PaymentTerm_ID = (?) , IsGrossInvoice = (?) , A_Asset_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , TotalPaid = TO_NUMBER(?) , OutstandingAmt = TO_NUMBER(?) , Discountamt = TO_NUMBER(?) , Writeoffamt = TO_NUMBER(?) , IsPaid = (?) , TotalLines = TO_NUMBER(?) , GrandTotal = TO_NUMBER(?) , DocStatus = (?) , C_DocType_ID = (?) , CopyFrom = (?) , CreateFrom = (?) , DocAction = (?) , Posted = (?) , UpdatePaymentMonitor = (?) , IsSelfService = (?) , DueAmt = TO_NUMBER(?) , AD_OrgTrx_ID = (?) , C_Campaign_ID = (?) , User1_ID = (?) , User2_ID = (?) , Withholdingamount = TO_NUMBER(?) , DaysTillDue = TO_NUMBER(?) , C_Activity_ID = (?) , LastCalculatedOnDate = TO_DATE(?) , PerformancePeriodEnd = TO_DATE(?) , PerformancePeriodStart = TO_DATE(?) , Btnreinvoiceprojectexpenses = (?) , Deliveryrule = (?) , C_Projectphase_ID = (?) , IsPaymentshedulesummary = (?) , Taxdate = TO_DATE(?) , DatePrinted = TO_DATE(?) , C_Withholding_ID = (?) , IsSOTrx = (?) , Processing = (?) , Processed = (?) , IsActive = (?) , IsPrinted = (?) , IsTaxIncluded = (?) , C_Invoice_ID = (?) , GenerateTo = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_Invoice.C_Invoice_ID = ? " +
      "        AND C_Invoice.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, C_Order_ID, DateOrdered, DocumentNo, POReference, Description, Internalnote, C_DocTypeTarget_ID, DateInvoiced, DateAcct, TransactionDate, SchedTransactionDate, C_BPartner_ID, C_BPartner_Location_ID, AD_User_ID, M_PriceList_ID, C_Currency_ID, SalesRep_ID, IsDiscountPrinted, C_Charge_ID, ChargeAmt, PaymentRule, C_PaymentTerm_ID, IsGrossInvoice, A_Asset_ID, C_Project_ID, C_Projecttask_ID, TotalPaid, OutstandingAmt, Discountamt, Writeoffamt, IsPaid, TotalLines, GrandTotal, DocStatus, C_DocType_ID, CopyFrom, CreateFrom, DocAction, Posted, IsTaxIncluded, C_Withholding_ID, Taxdate, C_Activity_ID, C_Campaign_ID, C_Invoice_ID, IsActive, Processed, Processing, DatePrinted, IsSOTrx, IsPrinted, DueAmt, GenerateTo, UpdatePaymentMonitor, IsSelfService, AD_OrgTrx_ID, User1_ID, User2_ID, Withholdingamount, DaysTillDue, LastCalculatedOnDate, PerformancePeriodEnd, PerformancePeriodStart, Btnreinvoiceprojectexpenses, Deliveryrule, C_Projectphase_ID, IsPaymentshedulesummary, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), now(), ?, now(), ?)";

...
*/
  private LocationAddressData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_BPartner_ID) throws IOException,ServletException {
   ...
   private LocationAddressData[] getRelationData(LocationAddressData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);        data[i].name = FormatUtilities.truncate(data[i].name, 50);        data[i].deviantBpName = FormatUtilities.truncate(data[i].deviantBpName, 50);        data[i].cLocationId = FormatUtilities.truncate(data[i].cLocationId, 50);        data[i].phone = FormatUtilities.truncate(data[i].phone, 13);        data[i].phone2 = FormatUtilities.truncate(data[i].phone2, 20);        data[i].fax = FormatUtilities.truncate(data[i].fax, 20);        data[i].uidnumber = FormatUtilities.truncate(data[i].uidnumber, 20);        data[i].eoriidentification = FormatUtilities.truncate(data[i].eoriidentification, 20);        data[i].cTaxId = FormatUtilities.truncate(data[i].cTaxId, 32);        data[i].cSalesregionId = FormatUtilities.truncate(data[i].cSalesregionId, 44);        data[i].upc = FormatUtilities.truncate(data[i].upc, 30);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cBpartnerLocationId = FormatUtilities.truncate(data[i].cBpartnerLocationId, 10);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strC_BPartner_Location_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|C_BPartner_Location_ID", data[0].getField("cBpartnerLocationId"));
    }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_BPartner_Location_ID, String strPC_BPartner_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LocationAddressData.set(strPC_BPartner_ID, LocationAddressData.selectDef2958_0(this, strPC_BPartner_ID), "Y", Utility.getDefault(this, vars, "IsTaxLocation", "N", "123", "222", "N", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "123", "222", "", dataField), Utility.getDefault(this, vars, "Phone2", "", "123", "222", "", dataField), Utility.getDefault(this, vars, "UPC", "", "123", "222", "", dataField), Utility.getDefault(this, vars, "IsBillTo", "Y", "123", "222", "N", dataField), Utility.getDefault(this, vars, "IsPayFrom", "Y", "123", "222", "N", dataField), Utility.getDefault(this, vars, "Deviant_Bp_Name", "", "123", "222", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "123", "222", "", dataField), Utility.getDefault(this, vars, "Fax", "", "123", "222", "", dataField), Utility.getDefault(this, vars, "IsRemitTo", "Y", "123", "222", "N", dataField), Utility.getDefault(this, vars, "Name", ".", "123", "222", "", dataField), Utility.getDefault(this, vars, "Uidnumber", "", "123", "222", "", dataField), Utility.getDefault(this, vars, "C_Location_ID", "", "123", "222", "", dataField), LocationAddressData.selectDef2959_1(this, Utility.getDefault(this, vars, "C_Location_ID", "", "123", "222", "", dataField)), Utility.getDefault(this, vars, "Phone", "", "123", "222", "", dataField), Utility.getDefault(this, vars, "Eoriidentification", "", "123", "222", "", dataField), Utility.getDefault(this, vars, "C_Tax_ID", "''", "123", "222", "", dataField), Utility.getDefault(this, vars, "Isheadquarter", "N", "123", "222", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "123", "222", "", dataField), LocationAddressData.selectDef2955_2(this, Utility.getDefault(this, vars, "CreatedBy", "", "123", "222", "", dataField)), Utility.getDefault(this, vars, "C_SalesRegion_ID", "", "123", "222", "", dataField), Utility.getDefault(this, vars, "IsShipTo", "Y", "123", "222", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "123", "222", "", dataField), LocationAddressData.selectDef2957_3(this, Utility.getDefault(this, vars, "UpdatedBy", "", "123", "222", "", dataField)), "");

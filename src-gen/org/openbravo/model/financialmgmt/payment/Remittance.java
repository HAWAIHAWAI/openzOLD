 ...
 */
public class Remittance extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_FINANCIALMGMTREMITTANCELINELIST =
        "financialMgmtRemittanceLineList";
    ...
    public Remittance() {
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTREMITTANCELINELIST,
    ...
    public void setFinancialMgmtRemittanceLineList(
        List<RemittanceLine> financialMgmtRemittanceLineList) {
        set(PROPERTY_FINANCIALMGMTREMITTANCELINELIST,
            financialMgmtRemittanceLineList);
    }
}

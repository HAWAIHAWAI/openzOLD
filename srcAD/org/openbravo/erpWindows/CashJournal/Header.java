...
public class Header extends HttpSecureAppServlet {
  ...
  private static final String tabId = "338";
...
/*
  String deleteRelation(VariablesSecureApp vars, String strC_Cash_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strC_Cash_ID.startsWith("(")) strC_Cash_ID = strC_Cash_ID.substring(1, strC_Cash_ID.length()-1);
      if (!strC_Cash_ID.equals("")) {
        strC_Cash_ID = Replace.replace(strC_Cash_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strC_Cash_ID, ",", false);
...
*/
   ...
   private HeaderData[] getRelationData(HeaderData[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|C_CashBook_ID", data[0].getField("cCashbookId"));    vars.setSessionValue(windowId + "|User2_ID", data[0].getField("user2Id"));    vars.setSessionValue(windowId + "|C_Cash_ID", data[0].getField("cCashId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      HeaderData[] data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inpcCashId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strC_Cash_ID, TableSQLData tableSQL)
...
String strParamStatementDate_f = vars.getSessionValue(tabId + "|paramStatementDate_f");
    ...
    if (!(strParamAD_Org_ID.equals("") && strParamC_CashBook_ID.equals("") && strParamStatementDate.equals("") && strParamName.equals("") && strParamStatementDate_f.equals(""))) hasSearchCondition=true;
    String strOffset = "0";
    //vars.getSessionValue(tabId + "|offset");
    String selectedRow = "0";
    if (!strC_Cash_ID.equals("")) {
      selectedRow = Integer.toString(getKeyPosition(vars, strC_Cash_ID, tableSQL));
    }

    String[] discard={"isNotFiltered","isNotTest"};
    if (hasSearchCondition) discard[0] = new String("isFiltered");
    if (vars.getSessionValue("#ShowTest", "N").equals("Y")) discard[1] = new String("isTest");
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/CashJournal/Header_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Header", false, "document.frmMain.inpcCashId", "grid", "..", "".equals("Y"), "CashJournal", strReplaceWith, false);
...
//    }
    ...
    xmlDocument.setParameter("KeyName", "cCashId");
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "CashJournal", "W", strReplaceWith, tabs.breadcrumb());
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Cash_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    ...
    String orderClause = " C_Cash.Name";
...
String strParamStatementDate_f = vars.getSessionValue(tabId + "|paramStatementDate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strC_Cash_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
  
        if (!strC_Cash_ID.equals("") && (data == null || data.length==0)) {
          response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
          return;
        }
        refreshSessionEdit(vars, data);
      ...
      if (dataField.getField("cCashId") == null || dataField.getField("cCashId").equals("")) {
        discard[0] = new String ("editDiscard");
        strCommand = "NEW";
        boolNew = true;
      } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "EndingBalance", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "BeginningBalance", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "198", "338", "", dataField), "", Utility.getDefault(this, vars, "Name", "@#Date@", "198", "338", "", dataField), Utility.getDefault(this, vars, "StatementDifference", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "Processing", "", "198", "338", "N", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "198", "338", "", dataField), Utility.getDefault(this, vars, "Posted", "N", "198", "338", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "N", "198", "338", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "N", "198", "338", "N", dataField))), Utility.getDefault(this, vars, "Processed", "", "198", "338", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "800024", Utility.getDefault(this, vars, "Processed", "", "198", "338", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "800024", Utility.getDefault(this, vars, "Processed", "", "198", "338", "N", dataField))), Utility.getDefault(this, vars, "StatementDate", "@#Date@", "198", "338", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "198", "338", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "198", "338", "", dataField), Utility.getDefault(this, vars, "C_CashBook_ID", "", "198", "338", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "198", "338", "", dataField), HeaderData.selectDef5246_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "198", "338", "", dataField)), Utility.getDefault(this, vars, "Description", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "198", "338", "", dataField), HeaderData.selectDef5248_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "198", "338", "", dataField)), Utility.getDefault(this, vars, "User1_ID", "", "198", "338", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcCashId", "", "..", "".equals("Y"), "CashJournal", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Cash_ID));
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonProcessed144(HttpServletResponse response, VariablesSecureApp vars, String strC_Cash_ID, String strprocessed, String strProcessing)
    throws IOException, ServletException {
    ...
    Scripthelper script = new Scripthelper();
      ...
      try {
        String name= LocalizationUtils.getProcessTitle(this, "144",vars.getLanguage());
        String info = LocalizationUtils.getProcessInfo(this, "144" ,vars.getLanguage());
        if (! info.isEmpty())
        ...
        strFG=strFG + fh.prepareProcessParameters(this, vars, script,"144" );
        String isDocAction=UtilsData.isProcessDocAction(this, "144");
        if (Integer.parseInt(isDocAction)>0) {
            String strdocstatus=UtilsData.getDocStatus(this, "407",strC_Cash_ID);
        ...
        String isJasper=UtilsData.isProcessJasper(this, "144");
        if (isJasper.equals("N"))
          strActionButtons= strActionButtons + ConfigureButton.doConfigure(this,vars,script,"buttonok",1,1,false, "ok",  "submitThisPage('SAVE_BUTTONProcessed" + "144" + "');", "","") + "";
        else
        ...
        script.addHiddenfield("inpadProcessId", "144");
        script.addHiddenfield("inpKey",strC_Cash_ID);
        script.addHiddenfield("inpprocessing",strProcessing);
        OBError myMessage = vars.getMessage("144");
        vars.removeMessage("144");
        if (myMessage!=null) {
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (HeaderData.getCurrentDBTimestamp(this, data.cCashId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cCashId, vars, this);
        } catch(Exception ex) {
        ...
        if(!myError.isEmpty()){
            ...
            vars.setSessionValue(windowId + "|C_Cash_ID", data.cCashId);
        }
    }
    return total;
  }

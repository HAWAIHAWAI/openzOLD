...
static Logger log4j = Logger.getLogger(SLOrderAmtData.class);
  ...
  public static String mrp_getpo_qty(ConnectionProvider connectionProvider, String mProductId, String cBpartnerId, String qty)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String mrp_getpo_qtystd(ConnectionProvider connectionProvider, String mProductId, String cBpartnerId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String mrp_getpo_qtymin(ConnectionProvider connectionProvider, String mProductId, String cBpartnerId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String mrp_getpo_ismultipleofminimumqty(ConnectionProvider connectionProvider, String mProductId, String cBpartnerId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 

 ...
 */
public class MeasureValues extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_MEASURETIME = "measureTime";
    ...
    public MeasureValues() {
        ...
        setDefaultValue(PROPERTY_CHAR, false);
    }
    ...
    public MeasureTime getMeasureTime() {
        return (MeasureTime) get(PROPERTY_MEASURETIME);
    }

    public void setMeasureTime(MeasureTime measureTime) {
        set(PROPERTY_MEASURETIME, measureTime);
    }

    public CheckPoint getCcp() {
        return (CheckPoint) get(PROPERTY_CCP);
    }

    public void setCcp(CheckPoint ccp) {
        set(PROPERTY_CCP, ccp);
    }
    ...
    public Boolean isChar() {
        return (Boolean) get(PROPERTY_CHAR);
    }

    public void setChar(Boolean chr) {
        set(PROPERTY_CHAR, chr);
    }

...
Create a registry
 */
  public static WarehouseQuantitiesCompleteFDEE77DBDE904FE7860F134045324078Data[] set(String mLocatorId, String mLocatorIdr, String mProductId, String mProductIdr, String cUomId, String zssiOnhanqtyOverviewId, String createdby, String createdbyr, String qtyoutflow, String updatedby, String updatedbyr, String mProductCategoryId, String qtyinsale, String qtyinflow, String qtyordered, String zssiOnhanqtyId, String qtyreserved, String mWarehouseId, String adOrgId, String qtyincomming, String isactive, String adClientId, String qtyonhand, String mAttributesetinstanceId, String mAttributesetinstanceIdr)    throws ServletException {

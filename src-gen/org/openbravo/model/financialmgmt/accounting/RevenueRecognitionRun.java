...
/**
 * Entity class for entity RevenueRecognitionRun (stored in table C_RevenueRecognition_Run).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RevenueRecognitionRun extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "C_RevenueRecognition_Run";
    public static final String ENTITY_NAME = "RevenueRecognitionRun";

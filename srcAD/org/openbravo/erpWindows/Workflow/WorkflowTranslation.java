...
public class WorkflowTranslation extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(WorkflowTranslation.class);
  
  private static final String windowId = "113";
  private static final String tabId = "149";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strAD_Workflow_Trl_ID = vars.getGlobalVariable("inpadWorkflowTrlId", windowId + "|AD_Workflow_Trl_ID", "");
        ...
        strPAD_Workflow_ID = getParentID(vars, strAD_Workflow_Trl_ID);
      ...
      String strView = vars.getSessionValue(tabId + "|WorkflowTranslation.view");
      if (strView.equals("")) {
      ...
      if (strView.equals("EDIT")) 
        ...
        printPageEdit(response, request, vars, false, strAD_Workflow_Trl_ID, strPAD_Workflow_ID, tableSQL);

      else printPageDataSheet(response, vars, strPAD_Workflow_ID, strAD_Workflow_Trl_ID, tableSQL);
      ...
      String strPAD_Workflow_ID = getParentID(vars, strAD_Workflow_Trl_ID);
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|WorkflowTranslation.view", "EDIT");

        printPageEdit(response, request, vars, false, strAD_Workflow_Trl_ID, strPAD_Workflow_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|WorkflowTranslation.view", "RELATION");
        printPageDataSheet(response, vars, strPAD_Workflow_ID, strAD_Workflow_Trl_ID, tableSQL);
      }
...
vars.getRequestGlobalVariable("inpParamName", tabId + "|paramName");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strAD_Workflow_Trl_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|WorkflowTranslation.view", strView);
        }
      }
...
vars.getGlobalVariable("inpadWorkflowId", windowId + "|AD_Workflow_ID");
      ...
      vars.setSessionValue(tabId + "|WorkflowTranslation.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPAD_Workflow_ID = vars.getGlobalVariable("inpadWorkflowId", windowId + "|AD_Workflow_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|WorkflowTranslation.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|WorkflowTranslation.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|AD_Workflow_Trl_ID");
      vars.setSessionValue(windowId + "|AD_Workflow_ID", strPAD_Workflow_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String message = deleteRelation(vars, strAD_Workflow_Trl_ID, strPAD_Workflow_ID);
      if (!message.equals("")) {
      ...
      String strAD_Workflow_Trl_ID = vars.getRequiredStringParameter("inpadWorkflowTrlId");
      //WorkflowTranslationData data = getEditVariables(vars, strPAD_Workflow_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = WorkflowTranslationData.delete(this, strAD_Workflow_Trl_ID, strPAD_Workflow_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
/*
  String deleteRelation(VariablesSecureApp vars, String strAD_Workflow_Trl_ID, String strPAD_Workflow_ID) throws IOException, ServletException {
    ...
    try {
      ...
      if (!strAD_Workflow_Trl_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (WorkflowTranslationData.deleteTransactional(conn, this, strKey, strPAD_Workflow_ID)==0) {
...
*/
  private WorkflowTranslationData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Workflow_ID) throws IOException,ServletException {
    WorkflowTranslationData data = new WorkflowTranslationData();
   ...
   private WorkflowTranslationData[] getRelationData(WorkflowTranslationData[] data) {
    if (data!=null) {
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Workflow_Trl_ID) throws ServletException {
    String strPAD_Workflow_ID = WorkflowTranslationData.selectParentID(this, strAD_Workflow_Trl_ID);
    if (strPAD_Workflow_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPAD_Workflow_ID) throws IOException,ServletException {
      WorkflowTranslationData[] data = WorkflowTranslationData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Workflow_ID, vars.getStringParameter("inpadWorkflowTrlId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPAD_Workflow_ID, String strAD_Workflow_Trl_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Workflow/WorkflowTranslation_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "WorkflowTranslation", false, "document.frmMain.inpadWorkflowTrlId", "grid", "..", "".equals("Y"), "Workflow", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "WorkflowTranslation_Relation.html", "Workflow", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "WorkflowTranslation_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", WorkflowTranslationData.selectParent(this, vars.getLanguage(), strPAD_Workflow_ID));
    else xmlDocument.setParameter("parent", WorkflowTranslationData.selectParentTrl(this, vars.getLanguage(), strPAD_Workflow_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Workflow_Trl_ID, String strPAD_Workflow_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    ...
    WorkflowTranslationData[] data=null;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = WorkflowTranslationData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPAD_Workflow_ID, strAD_Workflow_Trl_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new WorkflowTranslationData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = WorkflowTranslationData.set(strPAD_Workflow_ID, Utility.getDefault(this, vars, "Help", "", "113", "149", "", dataField), "Y", Utility.getDefault(this, vars, "IsTranslated", "", "113", "149", "N", dataField), "0", Utility.getDefault(this, vars, "Description", "", "113", "149", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "113", "149", "", dataField), Utility.getDefault(this, vars, "AD_Language", "", "113", "149", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "113", "149", "", dataField), WorkflowTranslationData.selectDef703_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "113", "149", "", dataField)), Utility.getDefault(this, vars, "Name", "", "113", "149", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "113", "149", "", dataField), WorkflowTranslationData.selectDef705_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "113", "149", "", dataField)), "");
        
      }
    } else {
      data = new WorkflowTranslationData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(WorkflowTranslationData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "WorkflowTranslation", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpadWorkflowTrlId", "", "..", "".equals("Y"), "Workflow", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strAD_Workflow_Trl_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (WorkflowTranslationData.getCurrentDBTimestamp(this, data.adWorkflowTrlId).equals(
  ...
  public String getServletInfo() {
    return "Servlet WorkflowTranslation. This Servlet was made by Wad constructor";

...
/**
 * Entity class for entity ADWorkflowTrl (stored in table AD_Workflow_Trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class WorkflowTrl extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "AD_Workflow_Trl";
    public static final String ENTITY_NAME = "ADWorkflowTrl";

...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strM_Internal_Consumptionline_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|M_Internal_Consumptionline_ID", data[0].getField("mInternalConsumptionlineId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
...
String strParamMovementQty_f = vars.getSessionValue(tabId + "|paramMovementQty_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPM_Internal_Consumption_ID, LinesData.selectDefBD0D98D74E5A44EAB5B794DB76785D9F(this, strPM_Internal_Consumption_ID), Utility.getDefault(this, vars, "M_Product_ID", "", "800076", "800203", "", dataField), LinesData.selectDef802772_0(this, Utility.getDefault(this, vars, "M_Product_ID", "", "800076", "800203", "", dataField)), LinesData.selectDef19E6E8A97CDB4AACAD8AAFDF4FA52CD2(this, strPM_Internal_Consumption_ID), LinesData.selectDef19E6E8A97CDB4AACAD8AAFDF4FA52CD2_1(this, LinesData.selectDef19E6E8A97CDB4AACAD8AAFDF4FA52CD2(this, strPM_Internal_Consumption_ID)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800076", "800203", "", dataField), Utility.getDefault(this, vars, "C_UOM_ID", "", "800076", "800203", "", dataField), "Y", Utility.getDefault(this, vars, "Description", "", "800076", "800203", "", dataField), Utility.getDefault(this, vars, "QuantityOrder", "", "800076", "800203", "", dataField), "", Utility.getDefault(this, vars, "M_Locator_ID", "@#m_locator_id@", "800076", "800203", "", dataField), LinesData.selectDef802771_2(this, Utility.getDefault(this, vars, "M_Locator_ID", "@#m_locator_id@", "800076", "800203", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800076", "800203", "", dataField), Utility.getDefault(this, vars, "Reinvoicedby_ID", "", "800076", "800203", "", dataField), Utility.getDefault(this, vars, "Cost2project", "Y", "800076", "800203", "N", dataField), LinesData.selectDef802773(this, strPM_Internal_Consumption_ID), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "800076", "800203", "", dataField), LinesData.selectDef802776_3(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "800076", "800203", "", dataField)), LinesData.selectDef1F897DC686584B32B24637DD8F413044(this, strPM_Internal_Consumption_ID), Utility.getDefault(this, vars, "MovementQty", "0", "800076", "800203", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "800076", "800203", "", dataField), LinesData.selectDef802767_4(this, Utility.getDefault(this, vars, "Createdby", "", "800076", "800203", "", dataField)), LinesData.selectDefBA9F789056C049A3871D9CFADB95A331(this, strPM_Internal_Consumption_ID), Utility.getDefault(this, vars, "Updatedby", "", "800076", "800203", "", dataField), LinesData.selectDef802769_5(this, Utility.getDefault(this, vars, "Updatedby", "", "800076", "800203", "", dataField)), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "800076", "800203", "", dataField));
